...
scoreboard objectives remove aj.louvert.animation.15_4_final_spell_fire.local_anim_time
...
scoreboard objectives remove aj.louvert.animation.15_4_final_spell_fire.loop_mode
