...
execute if score @s aj.louvert.animation.06_1_move_start.local_anim_time matches 30.. run function animated_java:louvert/zzzzzzzz/animations/06_1_move_start/end