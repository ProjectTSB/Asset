...
execute if score @s aj.louvert.animation.14_1_falling_strike.local_anim_time matches 45.. run function animated_java:louvert/zzzzzzzz/animations/14_1_falling_strike/end