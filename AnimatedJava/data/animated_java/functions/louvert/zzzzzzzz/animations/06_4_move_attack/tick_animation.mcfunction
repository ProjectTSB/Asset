...
execute if score @s aj.louvert.animation.06_4_move_attack.local_anim_time matches 65.. run function animated_java:louvert/zzzzzzzz/animations/06_4_move_attack/end