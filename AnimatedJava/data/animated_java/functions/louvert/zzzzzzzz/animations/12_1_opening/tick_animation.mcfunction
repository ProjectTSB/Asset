...
execute if score @s aj.louvert.animation.12_1_opening.local_anim_time matches 85.. run function animated_java:louvert/zzzzzzzz/animations/12_1_opening/end