...
execute if score @s aj.louvert.animation.15_2_final_spell_iai_start.local_anim_time matches 10.. run function animated_java:louvert/zzzzzzzz/animations/15_2_final_spell_iai_start/end