...
execute if score @s aj.louvert.animation.03_2_fire_slash_slash_1.local_anim_time matches 13.. run function animated_java:louvert/zzzzzzzz/animations/03_2_fire_slash_slash_1/end