...
execute if score @s aj.louvert.animation.15_1_final_spell.local_anim_time matches 100.. run function animated_java:louvert/zzzzzzzz/animations/15_1_final_spell/end