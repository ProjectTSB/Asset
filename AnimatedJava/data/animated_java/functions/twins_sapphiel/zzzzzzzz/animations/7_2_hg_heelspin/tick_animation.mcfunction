...
execute if score @s aj.twins_sapphiel.animation.7_2_hg_heelspin.local_anim_time matches 110.. run function animated_java:twins_sapphiel/zzzzzzzz/animations/7_2_hg_heelspin/end