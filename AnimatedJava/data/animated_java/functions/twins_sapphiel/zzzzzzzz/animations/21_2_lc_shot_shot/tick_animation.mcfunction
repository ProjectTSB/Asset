...
execute if score @s aj.twins_sapphiel.animation.21_2_lc_shot_shot.local_anim_time matches 35.. run function animated_java:twins_sapphiel/zzzzzzzz/animations/21_2_lc_shot_shot/end