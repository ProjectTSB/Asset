...
execute if score @s aj.twins_sapphiel.animation.3_1_hg_shot_move_right.local_anim_time matches 45.. run function animated_java:twins_sapphiel/zzzzzzzz/animations/3_1_hg_shot_move_right/end