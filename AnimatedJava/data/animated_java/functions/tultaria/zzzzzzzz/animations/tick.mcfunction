...
execute if entity @s[tag=aj.tultaria.animation.heavy_slash] run function animated_java:tultaria/zzzzzzzz/animations/heavy_slash/tick
...
execute if entity @s[tag=aj.tultaria.animation.blade_destruction] run function animated_java:tultaria/zzzzzzzz/animations/blade_destruction/tick
execute if entity @s[tag=aj.tultaria.animation.blade_destruction_spin] run function animated_java:tultaria/zzzzzzzz/animations/blade_destruction_spin/tick
execute if entity @s[tag=aj.tultaria.animation.blade_destruction_start] run function animated_java:tultaria/zzzzzzzz/animations/blade_destruction_start/tick