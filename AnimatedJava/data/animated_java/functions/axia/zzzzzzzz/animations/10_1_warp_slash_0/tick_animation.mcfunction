...
execute if score @s aj.axia.animation.10_1_warp_slash_0.local_anim_time matches 36.. run function animated_java:axia/zzzzzzzz/animations/10_1_warp_slash_0/end