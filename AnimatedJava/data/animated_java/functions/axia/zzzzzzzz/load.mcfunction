...
scoreboard objectives add aj.axia.animation.5_0_spining_cut.local_anim_time dummy
scoreboard objectives add aj.axia.animation.5_1_spining_cut.local_anim_time dummy
...
scoreboard objectives add aj.axia.animation.5_0_spining_cut.loop_mode dummy
scoreboard objectives add aj.axia.animation.5_1_spining_cut.loop_mode dummy
...
scoreboard players set $aj.axia.animation.5_0_spining_cut aj.id 5
scoreboard players set $aj.axia.animation.5_1_spining_cut aj.id 6
scoreboard players set $aj.axia.animation.6_0_moving_forward aj.id 7
scoreboard players set $aj.axia.animation.6_1_moving_back aj.id 8
scoreboard players set $aj.axia.animation.7_0_moving_iai aj.id 9
scoreboard players set $aj.axia.animation.8_0_moving_spin aj.id 10
scoreboard players set $aj.axia.animation.9_0_zangekihou aj.id 11
scoreboard players set $aj.axia.animation.10_0_warp_start aj.id 12
scoreboard players set $aj.axia.animation.10_1_warp_slash_0 aj.id 13
scoreboard players set $aj.axia.animation.10_2_warp_slash_1 aj.id 14
scoreboard players set $aj.axia.animation.10_3_warp_slash_2 aj.id 15
scoreboard players set $aj.axia.animation.11_0_dimension_slash aj.id 16
scoreboard players set $aj.axia.animation.12_0_kourai aj.id 17
scoreboard players set $aj.axia.animation.13_0_damage_1 aj.id 18
scoreboard players set $aj.axia.animation.13_1_damage_2 aj.id 19
scoreboard players set $aj.axia.animation.14_0_opening_attack aj.id 20
scoreboard players set $aj.axia.animation.15_0_former_ending aj.id 21
...
scoreboard players set aj.axia.export_version aj.i -1317499181
