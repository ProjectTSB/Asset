...
execute if score @s aj.twins_rubiel.animation.3_0_katana_moveslash.local_anim_time matches 35.. run function animated_java:twins_rubiel/zzzzzzzz/animations/3_0_katana_moveslash/end