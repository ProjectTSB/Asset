...
execute if score @s aj.twins_rubiel.animation.13_4_scythe_warp_4_end.local_anim_time matches 44.. run function animated_java:twins_rubiel/zzzzzzzz/animations/13_4_scythe_warp_4_end/end