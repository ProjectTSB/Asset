...
execute if score @s aj.twins_rubiel.animation.13_2_scythe_warp_2_upper.local_anim_time matches 19.. run function animated_java:twins_rubiel/zzzzzzzz/animations/13_2_scythe_warp_2_upper/end