...
execute if score @s aj.twins_rubiel.animation.13_1_scythe_warp_1_slash.local_anim_time matches 13.. run function animated_java:twins_rubiel/zzzzzzzz/animations/13_1_scythe_warp_1_slash/end