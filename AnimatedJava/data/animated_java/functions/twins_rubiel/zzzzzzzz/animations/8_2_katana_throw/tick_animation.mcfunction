...
execute if score @s aj.twins_rubiel.animation.8_2_katana_throw.local_anim_time matches 28.. run function animated_java:twins_rubiel/zzzzzzzz/animations/8_2_katana_throw/end