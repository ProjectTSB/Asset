...
execute if score @s aj.twins_rubiel.animation.13_3_scythe_warp_3_throw.local_anim_time matches 17.. run function animated_java:twins_rubiel/zzzzzzzz/animations/13_3_scythe_warp_3_throw/end