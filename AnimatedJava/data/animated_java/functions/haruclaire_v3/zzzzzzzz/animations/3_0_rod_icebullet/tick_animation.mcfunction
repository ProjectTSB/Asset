...
execute if score @s aj.haruclaire_v3.animation.3_0_rod_icebullet.local_anim_time matches 80.. run function animated_java:haruclaire_v3/zzzzzzzz/animations/3_0_rod_icebullet/end