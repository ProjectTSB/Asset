...
scoreboard players set $aj.haruclaire_v3.animation.5_0_rod_icespear3 aj.id 5
scoreboard players set $aj.haruclaire_v3.animation.5_0_rod_icespear2 aj.id 6
scoreboard players set $aj.haruclaire_v3.animation.2_0_rod_icewall2 aj.id 7
scoreboard players set $aj.haruclaire_v3.animation.99_testpose aj.id 8
scoreboard players set $aj.haruclaire_v3.animation.99_testpose2 aj.id 9
...
scoreboard players set aj.haruclaire_v3.export_version aj.i -272993522
