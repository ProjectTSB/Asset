...
# 竜巻演出
    ...
    # Main
        ...
        execute if entity @s[scores={General.Object.Tick=63}] run data merge entity @s {interpolation_duration:5,start_interpolation:0,transformation:{left_rotation:[0f,0f,0f,1f],right_rotation:[0f,0f,0f,1f],translation:[0f,14f,0f],scale:[12f,13f,12f]}}
        execute if entity @s[scores={General.Object.Tick=75}] run data merge entity @s {interpolation_duration:4,start_interpolation:0,transformation:{left_rotation:[0f,0f,0f,1f],right_rotation:[0f,0f,0f,1f],translation:[0f,21f,0f],scale:[0f,26f,0f]}}
    # Append
