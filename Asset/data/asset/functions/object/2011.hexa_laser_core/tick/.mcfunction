...
# スパイラル処理
    ...
    execute if predicate api:global_vars/difficulty/max/2_hard as @e[tag=2010.Laser,distance=..64] if score @s 2011.Dummy.UUID = $2011.Temp 2011.Dummy.UUID at @s facing entity @e[tag=this,distance=..64] feet rotated ~-100 ~ positioned ^ ^ ^0.75 run function asset:object/2011.hexa_laser_core/tick/tp
