...
# 付近に敵がいたら攻撃モードへと移行
    execute if entity @s[tag=!1058.AttackMode,tag=!1058.StopAttack] if entity @e[type=#lib:living,tag=Enemy,tag=!Uninterferable,tag=1058.TargetedEnemy,distance=..8] run function asset:object/1058.brave_knight/tick/event/dash
    execute if entity @e[type=#lib:living,tag=Enemy,tag=!Uninterferable,tag=1058.TargetedEnemy,distance=..8] run tag @s[tag=!1058.StopAttack] add 1058.AttackMode
...
# リセット
    ...
    tag @e[type=#lib:living,tag=Enemy,tag=!Uninterferable,tag=1058.TargetedEnemy] remove 1058.TargetedEnemy
