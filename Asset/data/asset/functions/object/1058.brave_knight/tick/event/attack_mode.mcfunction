...
# オーナーの最寄りの敵にパーティクル出す
    execute as @e[type=#lib:living,tag=Enemy,tag=1058.TargetedEnemy,distance=..8] at @s anchored eyes run particle dust 1 0 0 0.7 ^ ^0.5 ^ 0 0 0 1 1 normal @p[tag=1058.OwnerPlayer]
