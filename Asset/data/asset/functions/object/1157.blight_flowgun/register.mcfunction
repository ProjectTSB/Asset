#> asset:object/1157.blight_flowgun/register
#
# Objectのデータを指定
#
# @within function asset:object/alias/1157/register
...
# ID (int)
    data modify storage asset:object ID set value 1157
# フィールド(オプション)
    data modify storage asset:object Field.Color set value 11218798
