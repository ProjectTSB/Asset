#> asset:object/1157.blight_flowgun/pre_hit/
#
# 継承先などから実行される処理
#
# @within asset:object/alias/1157/pre_hit
...
# エフェクト付与
    ...
    data modify storage api: Argument.FieldOverride.Interval.Max set from storage asset:context this.Interval.Max
