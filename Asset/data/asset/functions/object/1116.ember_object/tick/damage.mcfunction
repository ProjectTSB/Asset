...
# 演出
    ...
    particle explosion_emitter ~ ~4 ~ 6 4 6 0 20
    particle flash ~ ~4 ~ 3 4 3 0 400
    particle lava ~ ~4 ~ 3 4 3 0 400
...
# ダメージ
    ...
    execute as @e[type=#lib:living,tag=Enemy,tag=!Uninterferable,distance=..13] run function api:damage/
