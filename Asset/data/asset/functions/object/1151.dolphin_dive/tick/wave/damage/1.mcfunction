#> asset:object/1151.dolphin_dive/tick/wave/damage/1
#
#
#
# @within function asset:object/1151.dolphin_dive/tick/wave/1
...
# 円柱Libを用いて判定する
    data modify storage lib: Argument.BoundingCylinder.Radius set value 2d
...
# Motion設定
    data modify storage lib: Argument.VectorMagnitude set value 3.5f
