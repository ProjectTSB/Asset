#> asset:object/1151.dolphin_dive/tick/wave/damage/2
#
#
#
# @within function asset:object/1151.dolphin_dive/tick/wave/2
...
# Motion設定
    data modify storage lib: Argument.VectorMagnitude set value 3.0f
