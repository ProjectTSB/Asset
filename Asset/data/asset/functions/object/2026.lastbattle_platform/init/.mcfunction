...
# 上に自分そっくりのやつを召喚してのっける
    summon item_display ~ ~ ~ {view_range:0.05f,Tags:["2026.Init"],Rotation:[0F,90F],brightness:{sky:15,block:15},transformation:{left_rotation:[0f,0f,0f,1f],right_rotation:[0f,0f,0f,1f],translation:[0f,0f,0f],scale:[5f,5f,0.01f]},item:{id:"minecraft:leather_horse_armor",Count:1b,tag:{display:{color:10790052},CustomModelData:20086}}}
