...
# ダメージ
    ...
    execute as @e[type=#lib:living_without_player,tag=Enemy,tag=1016.Target,tag=!Uninterferable,distance=..7.5] run function asset:object/1016.starry_lake/tick/damage/check_duplicate
