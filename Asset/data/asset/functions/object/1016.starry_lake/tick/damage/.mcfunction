...
# ダメージ
    ...
    execute as @e[type=#lib:living,tag=Enemy,tag=Target,tag=!Uninterferable,distance=..7.5] run function asset:object/1016.starry_lake/tick/damage/check_duplicate
