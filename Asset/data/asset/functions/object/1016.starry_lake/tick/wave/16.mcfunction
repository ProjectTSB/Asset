...
# ドーナツ状の当たり判定にentityがいた場合Tagを付与
    execute as @e[type=#lib:living_without_player,tag=Enemy,tag=!Uninterferable,distance=7.01..7.5] positioned ~-7.5 ~-1 ~-7.5 if entity @s[dx=14,dy=1,dz=14] run tag @s add 1016.Target
