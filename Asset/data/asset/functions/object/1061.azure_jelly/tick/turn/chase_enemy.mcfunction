...
# 最寄りの敵のy座標が近いかを判定
    execute positioned ~-14 ~-1.5 ~-14 if entity @e[type=#lib:living_without_player,tag=Enemy,dx=27,dy=0.0,dz=27,limit=1] run data modify storage asset:temp 1061.Success set value true
