#> asset:object/2023.crystal_turret_bullet/hit_entity/
#
# 継承先などから実行される処理
#
# @within asset:object/alias/2023/hit_entity
...
# 引数の設定
    ...
    # ダメージを与える
        execute positioned ~-0.5 ~-0.5 ~-0.5 as @p[tag=!PlayerShouldInvulnerable,dx=0] run function lib:damage/
# リセット
