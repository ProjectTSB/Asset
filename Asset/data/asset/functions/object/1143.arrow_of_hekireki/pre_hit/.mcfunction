...
# 演出
    execute positioned ~-0.5 ~-0.5 ~-0.5 at @e[type=#lib:living_without_player,tag=1009.Target,dx=0] positioned ~ ~0.2 ~ run function asset:object/1143.arrow_of_hekireki/thunder/
