...
# WaitingTick デクリメント
    execute unless data storage asset:context this{WaitingTick:-1} unless data storage asset:context this{WaitingTick:0} store result storage asset:context this.WaitingTick int 0.9999099999 run data get storage asset:context this.WaitingTick 1
