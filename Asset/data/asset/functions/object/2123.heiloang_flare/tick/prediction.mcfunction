...
# 攻撃位置表示
    ...
    data modify storage api: Argument.FieldOverride.Tick set value 97
...
# 予告線表示
    ...
    tp @e[type=text_display,tag=2123.Text,sort=nearest,limit=1] ~ ~ ~ ~ 0
    ride @e[type=text_display,tag=2123.Text,sort=nearest,limit=1] mount @s
