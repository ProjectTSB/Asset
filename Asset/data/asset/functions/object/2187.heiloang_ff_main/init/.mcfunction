...
# 背景用AJ召喚、初期化
    execute positioned as @e[type=marker,tag=BE.CenterPosition] positioned ~ ~24 ~ run function animated_java:heiloang_flare_aj/summon {args: {animation: 'spin', start_animation: true}}
