...
# Scale
    ...
    execute if entity @s[scores={General.Object.Tick=100}] run data merge entity @s {interpolation_duration:5,start_interpolation:0,transformation:{left_rotation:[0f,0f,0f,1f],right_rotation:[0f,0f,0f,1f],translation:[0f,1f,0f],scale:[0f,0f,1f]}}
