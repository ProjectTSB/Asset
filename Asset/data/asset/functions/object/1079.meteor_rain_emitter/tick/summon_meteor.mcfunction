...
# 付近のランダムな敵一体を対象とし、そいつの周辺に拡散
    ...
    execute store result storage api: Argument.FieldOverride.TargetID int 1 run scoreboard players get @e[type=#lib:living,tag=MeteorTarget,distance=..64,sort=random,limit=1] MobUUID
