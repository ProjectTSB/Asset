...
# ハード以上で追加で2箇所
    execute if predicate api:global_vars/difficulty/min/hard rotated ~90 ~ positioned ^ ^ ^2.4 run function asset:object/2047.prominence_magic/tick/damage
    execute if predicate api:global_vars/difficulty/min/hard rotated ~270 ~ positioned ^ ^ ^2.4 run function asset:object/2047.prominence_magic/tick/damage
