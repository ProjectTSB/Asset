...
# 攻撃
    ...
    execute if entity @s[scores={General.Object.Tick=37}] run playsound entity.generic.explode hostile @a ~ ~ ~ 0.5 0.7 0.5
    ...
    execute if entity @s[scores={General.Object.Tick=70}] run playsound entity.generic.explode hostile @a[distance=..80] ~ ~ ~ 0.5 0.8 0.5
    ...
    execute if entity @s[scores={General.Object.Tick=103}] run playsound entity.generic.explode hostile @a[distance=..80] ~ ~ ~ 0.5 0.8 0.5
