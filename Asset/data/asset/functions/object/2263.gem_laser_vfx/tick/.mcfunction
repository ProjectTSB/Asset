...
# 拡大
    ...
    execute unless entity @s[tag=2263.IsUpperShot] if score @s General.Object.Tick matches 8 run data modify entity @s transformation.scale set value [0.0f,0.0f,100.0f]
    execute if entity @s[tag=2263.IsUpperShot] if score @s General.Object.Tick matches 8 run data modify entity @s transformation.scale set value [0.0f,0.0f,0.0f]
    execute unless entity @s[tag=2263.IsUpperShot] if score @s General.Object.Tick matches 3..12 run particle flash ~ ~ ~ 0 0 0 0 1
...
# 移動
    ...
    execute if entity @s[tag=2263.IsShot,tag=!2263.IsUpperShot] if score @s General.Object.Tick matches 8.. at @s run tp @s ^ ^ ^20
