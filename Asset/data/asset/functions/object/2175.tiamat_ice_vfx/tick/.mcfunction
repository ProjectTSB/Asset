...
# 拡大
    ...
    execute if entity @s[scores={General.Object.Tick=3}] on passengers run data merge entity @s {start_interpolation:0,interpolation_duration:3,transformation:{left_rotation:[0f,0f,0f,1f],right_rotation:[0f,0f,0f,1f],translation:[0f,0.3f,0f],scale:[4f,4f,4f]}}
    execute if entity @s[scores={General.Object.Tick=3}] run data merge entity @s {start_interpolation:0,interpolation_duration:3,transformation:{left_rotation:[0f,0f,0f,1f],right_rotation:[0f,0f,0f,1f],translation:[0f,0.4f,0f],scale:[4f,4f,4f]}}
    ...
    execute if entity @s[scores={General.Object.Tick=8..35}] run function asset:object/2175.tiamat_ice_vfx/tick/particle

# 消滅処理
    execute if entity @s[scores={General.Object.Tick=40..}] run function asset:object/2175.tiamat_ice_vfx/tick/kill
