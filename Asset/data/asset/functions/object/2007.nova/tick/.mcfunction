...
# VFX 処理
    execute at @s run function asset:object/2007.nova/tick/vfx/tick
...
# ノヴァを大きくする
    ...
    execute if score @s General.Object.Tick matches 41 positioned ~ ~15 ~ run data merge entity @e[type=item_display,tag=2001.Nova,distance=..0.001,sort=nearest,limit=1] {transformation:{left_rotation:[0f,0f,0f,1f],right_rotation:[0f,0f,0f,1f],translation:[0f,0f,0f],scale:[10f,10f,10f]}}
...
# 消滅処理
    execute if score @s General.Object.Tick matches 100.. run kill @e[type=item_display,tag=2001.Nova,distance=..0.001,sort=nearest,limit=1]
