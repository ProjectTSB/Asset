...
# Novaの見た目（billbord）を移動
    data merge entity @e[type=item_display,tag=2001.Nova,distance=..0.001,sort=nearest,limit=1] {start_interpolation:0,interpolation_duration:2,transformation:{left_rotation:[0f,0f,0f,1f],right_rotation:[0f,0f,0f,1f],translation:[0f,0f,0f],scale:[0f,0f,0f]}}
