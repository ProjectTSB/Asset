...
# ループ処理
    scoreboard players set $2015.Temp Temporary 32
    execute if block ~ ~ ~ #lib:no_collision unless block ~ ~-0.25 ~ #lib:no_collision run scoreboard players set $2015.Temp Temporary -100
