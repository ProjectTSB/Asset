...
# ダメージ実行
    execute as @e[type=#lib:living,tag=Enemy,distance=..2] run function api:damage/
...
# ノクバ耐性を考慮して吹っ飛ばす
    ...
    execute facing entity @p[tag=1075.Owner] eyes as @e[type=#lib:living,tag=Enemy,distance=..2] run function lib:motion/
