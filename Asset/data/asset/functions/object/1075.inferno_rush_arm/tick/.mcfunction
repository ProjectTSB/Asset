...
# ntickおきに実行
    ...
    execute if score $Interval Temporary matches 0 at @s if entity @e[type=#lib:living,tag=Enemy,distance=..2] run function asset:object/1075.inferno_rush_arm/tick/hit
# リセット
