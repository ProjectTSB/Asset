...
# 落下処理
    execute if score @s General.Object.Tick matches 10.. if score @s 1161.Land matches 0 at @s if block ~ ~-0.1 ~ #lib:no_collision/ run function asset:object/1161.ice_brand_arts/tick/fall
