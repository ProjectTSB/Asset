#> asset:object/2080.aurora_missile/tick/normal
#
#
#
...
# 演出
    execute if entity @s[scores={General.Object.Tick=..19}] run particle dust_color_transition 0 0.408 0.361 1 0 0.114 0.478 ~ ~ ~ 0 0 0 0 3 normal @a
    execute if entity @s[scores={General.Object.Tick=20..}] run particle dust_color_transition 0.000 1.000 0.886 2 0 0.235 1 ~ ~ ~ 0.2 0.2 0.2 0 3 normal @a
...
# それ以降は前進する
    execute if entity @s[scores={General.Object.Tick=21}] run data modify storage asset:context this.MovePerStep set value 0.5
