...
# 1発目ダメージデータ
    execute if score $MS.AttackLevel Temporary matches 0.. run data modify storage api: Argument.Damage set from storage asset:context this.Damage
...
# 2発目ダメージデータ
    execute if score $MS.AttackLevel Temporary matches 1.. run data modify storage api: Argument.Damage set from storage asset:context this.Damage
...
# 3発目ダメージデータ
    execute if score $MS.AttackLevel Temporary matches 2.. run data modify storage api: Argument.Damage set from storage asset:context this.Damage
...
# 4発目ダメージデータ
    execute if score $MS.AttackLevel Temporary matches 3.. run data modify storage api: Argument.Damage set from storage asset:context this.Damage
...
# 5発目ダメージデータ
    execute if score $MS.AttackLevel Temporary matches 4.. run data modify storage api: Argument.Damage set from storage asset:context this.Damage
