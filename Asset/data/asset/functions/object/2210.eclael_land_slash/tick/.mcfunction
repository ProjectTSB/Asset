...
# モデル変更
    ...
    execute if entity @s[scores={General.Object.Tick=4}] run data modify entity @s text set value '{"text":"1","font":"object/2208/0","color":"#B3FFC4"}'
    execute if entity @s[scores={General.Object.Tick=5}] run data modify entity @s text set value '{"text":"2","font":"object/2208/0","color":"#B3FFC4"}'
