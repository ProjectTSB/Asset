...
# モデル変更
    execute if entity @s[scores={General.Object.Tick=23}] run data merge entity @s {interpolation_duration:3,start_interpolation:0,transformation:{left_rotation:{axis:[1,0,0],angle:-1.5708f},right_rotation:[0f,0f,0f,1f],translation:[0f,0.1f,0f],scale:[3f,40f,3f]}}
    ...
    execute if entity @s[scores={General.Object.Tick=33}] run data merge entity @s {interpolation_duration:8,start_interpolation:0,transformation:{left_rotation:{axis:[1,0,0],angle:-1.5708f},right_rotation:[0f,0f,0f,1f],translation:[0f,0.1f,20f],scale:[0f,40f,0f]}}
    execute if entity @s[scores={General.Object.Tick=23}] on passengers run data merge entity @s {interpolation_duration:3,start_interpolation:0,transformation:{left_rotation:{axis:[1,0,0],angle:-1.5708f},right_rotation:[0f,0f,0f,1f],translation:[0f,0f,0f],scale:[12f,300f,12f]}}
    ...
    execute if entity @s[scores={General.Object.Tick=26}] on passengers run data merge entity @s {interpolation_duration:12,start_interpolation:0,transformation:{left_rotation:{axis:[1,0,0],angle:-1.5708f},right_rotation:[0f,0f,0f,1f],translation:[0f,0f,30f],scale:[15f,100f,15f]}}
