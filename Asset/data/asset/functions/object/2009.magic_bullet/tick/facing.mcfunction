...
# 滑らかに回転
    ...
    execute if predicate api:global_vars/difficulty/min/hard as @e[tag=this,distance=..64,sort=nearest,limit=1] at @s positioned ^ ^ ^-4 facing entity @e[tag=2009.Target,distance=..66,limit=1] eyes positioned ^ ^ ^-1 facing entity @s feet positioned as @s run tp @e[type=item_display,distance=..0.001] ^ ^ ^ ~ ~
# 終了
