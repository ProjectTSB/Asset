...
# ダメージ
    ...
    execute as @e[type=#lib:living_without_player,tag=Enemy,tag=!Uninterferable,distance=..3.5] run function asset:object/1144.hekireki_thunder/tick/check_duplicate
