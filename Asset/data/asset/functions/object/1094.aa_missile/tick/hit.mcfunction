...
# 命中していたらダメージを与えてkill
    $execute at @s positioned ~-0.5 ~-0.5 ~-0.5 if entity @e[type=#lib:living,scores={MobUUID=$(TargetID)},dx=0] run function asset:object/1094.aa_missile/tick/damage with storage asset:context this
