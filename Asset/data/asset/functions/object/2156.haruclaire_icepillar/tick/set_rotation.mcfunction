...
# 攻撃位置を向く
    ...
    execute positioned ~ ~ ~ facing entity @p[gamemode=!spectator] eyes positioned as @s run tp @e[type=area_effect_cloud,tag=2156.AttackRotation,sort=nearest,limit=1] ~ ~ ~ ~ ~
