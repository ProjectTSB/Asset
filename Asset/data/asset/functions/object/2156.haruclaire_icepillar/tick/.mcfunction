...
# 拡大
    ...
    particle firework ~ ~4 ~ 0.5 0.5 0.5 0.1 1

# 移動
    execute if entity @s[tag=!2156.StartAttack,scores={General.Object.Tick=20..}] run tp @s ~ ~-1 ~
    execute if entity @s[tag=!2156.StartAttack,scores={General.Object.Tick=20..}] unless block ~ ~-1 ~ #lib:no_collision run function asset:object/2156.haruclaire_icepillar/tick/set_ground
...
# 攻撃
    ...
    execute if entity @s[scores={2156.AttackTimer=161..210}] if predicate api:global_vars/difficulty/min/hard run function asset:object/2156.haruclaire_icepillar/tick/turn_laser
