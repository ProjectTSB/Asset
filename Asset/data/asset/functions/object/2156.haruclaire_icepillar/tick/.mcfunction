...
# 移動
    ...
    execute if entity @s[tag=2156.Right,scores={General.Object.Tick=12..}] on passengers if entity @s[tag=!2156.Prediction] at @s run tp @s ~ ~ ~ ~3 ~
    execute if entity @s[tag=!2156.Right,scores={General.Object.Tick=12..}] on passengers if entity @s[tag=!2156.Prediction] at @s run tp @s ~ ~ ~ ~-3 ~
...
# 攻撃
    ...
    # 予告
        execute if entity @s[scores={2156.AttackTimer=121}] rotated as @e[type=area_effect_cloud,tag=2156.AttackRotation,sort=nearest,limit=1] positioned ~ ~4 ~ positioned ^ ^ ^1.5 run function asset:object/2156.haruclaire_icepillar/tick/prediction
