#> asset:object/1153.flare_butterfly/tick/attack/
#
#
#
...
# 攻撃
    execute if data storage asset:context this.AttackDelay{_:0} run function asset:object/1153.flare_butterfly/tick/attack/attack
