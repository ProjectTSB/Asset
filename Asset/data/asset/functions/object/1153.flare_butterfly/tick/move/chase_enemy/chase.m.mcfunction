...
# Speedの半分を引数とする
    ...
    execute unless data storage asset:temp 1153{Success:true} at @s run function asset:object/1153.flare_butterfly/tick/move/with_collision.m with storage asset:temp 1153
