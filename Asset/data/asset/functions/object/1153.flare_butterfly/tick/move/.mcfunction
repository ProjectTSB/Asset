...
# TargetMobUUIDがない && Ownerの近くに敵がいればTargetMobUUIDを設定
    execute unless data storage asset:context this.TargetMobUUID if function asset:object/1153.flare_butterfly/predicate/near_enemy run function asset:object/1153.flare_butterfly/tick/move/search_target/

# TargetMobUUIDがある && Ownerが周囲にいない ならTargetMobUUIDを削除
    execute if data storage asset:context this.TargetMobUUID unless function asset:object/1153.flare_butterfly/predicate/near_owner run function asset:object/1153.flare_butterfly/tick/move/common/reset

# TargetMobUUIDがある && Ownerの周囲にTargetがいない ならTargetMobUUIDを削除
    execute if data storage asset:context this.TargetMobUUID unless function asset:object/1153.flare_butterfly/predicate/near_target/neutral_near/ run function asset:object/1153.flare_butterfly/tick/move/common/reset
