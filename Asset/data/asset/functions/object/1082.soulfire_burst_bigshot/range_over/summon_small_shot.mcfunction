#> asset:object/1082.soulfire_burst_bigshot/range_over/summon_small_shot
#
#
#
# @within function asset:object/1082.soulfire_burst_bigshot/range_over/
...
# マーカーの方を向いて召喚
    ...
    execute store result storage api: Argument.FieldOverride.TargetID int 1 positioned ^ ^ ^20 run scoreboard players get @e[type=#lib:living_without_player,tag=Enemy,tag=!Uninterferable,distance=..20,sort=nearest,limit=1] MobUUID
