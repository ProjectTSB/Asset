...
# マーカーの方を向いて召喚
    ...
    execute store result storage api: Argument.FieldOverride.TargetID int 1 positioned ^ ^ ^20 run scoreboard players get @e[type=#lib:living,distance=..20,sort=nearest,limit=1] MobUUID
