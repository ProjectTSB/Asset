...
# サウンドと図形での演出
    ...
    execute as @a[distance=..32] at @s facing entity @e[type=marker,tag=this,distance=..30] eyes positioned ^ ^ ^1 run playsound ogg:block.respawn_anchor.deplete2 hostile @s ~ ~ ~ 0.7 1
    execute as @a[distance=..32] at @s facing entity @e[type=marker,tag=this,distance=..30] eyes positioned ^ ^ ^1 run playsound minecraft:entity.breeze.death hostile @s ~ ~ ~ 0.7 0.7
