...
# ダメージ設定
    # 与えるダメージ
        data modify storage lib: Argument.Damage set value 4
    # 属性
...
# 着弾タグを消す
    tag @e[type=#lib:living,tag=Enemy,tag=LandingTarget,distance=..60,sort=nearest,limit=1] remove LandingTarget
