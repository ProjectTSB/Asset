...
# 周囲にプレイヤーがいる場合、かつ敵がいない場合、プレイヤーを追尾
    execute if entity @p[tag=1059.OwnerPlayer,distance=..8] unless entity @e[type=#lib:living,tag=Enemy,distance=..6] facing entity @p[tag=1059.OwnerPlayer] eyes positioned ^ ^ ^-100 rotated as @s positioned ^ ^ ^-800 facing entity @s eyes positioned as @s run tp @s ^ ^ ^0.2 ~ ~

# 周囲にプレイヤーがいて、かつ敵が近くにいる場合、範囲内なら敵を追う
    execute if entity @p[tag=1059.OwnerPlayer,distance=..8] if entity @e[type=#lib:living,tag=Enemy,distance=..6] facing entity @e[type=#lib:living,distance=..6,sort=nearest,limit=1] eyes positioned ^ ^ ^-100 rotated as @s positioned ^ ^ ^-800 facing entity @s eyes positioned as @s run tp @s ^ ^ ^0.2 ~ ~
