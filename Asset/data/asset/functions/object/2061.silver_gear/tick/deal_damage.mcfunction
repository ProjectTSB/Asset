#> asset:object/2061.silver_gear/tick/deal_damage
#
#
#
...
# パラメータ設定
    ...
    data modify storage api: Argument.DeathMessage set value '[{"translate": "%1$sは%2$sの歯車により存在を消し飛ばされた","with":[{"selector":"@s"},{"nbt":"Return.AttackerName","storage":"lib:","interpret":true}]}]'
# 補正
...
# リセット
    ...
    tag @a[tag=Target,distance=..3.5] remove Target
