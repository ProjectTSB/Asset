...
execute if score @s General.Object.Tick matches 125 run summon area_effect_cloud ~ ~5 ~ {Duration:19,Passengers:[{id:"item_display",transformation:{left_rotation:[0f,0f,0f,1f],right_rotation:[0.7075f,0f,0f,0.7075f],translation:[0f,-0.5f,0f],scale:[7f,0f,7f]},Tags:["Object","Uninterferable","2061.GearSubVfx","ProcessCommonTag","AutoKillWhenDieVehicle"]}],Tags:["Object","Uninterferable"]}
execute if score @s General.Object.Tick matches 125 run summon area_effect_cloud ~ ~4 ~ {Duration:19,Passengers:[{id:"item_display",transformation:{left_rotation:[0f,0f,0f,1f],right_rotation:[0.7075f,0f,0f,0.7075f],translation:[0f,0.5f,0f],scale:[4.5f,0f,4.5f]},Tags:["Object","Uninterferable","2061.GearSubVfx","ProcessCommonTag","AutoKillWhenDieVehicle"]}],Tags:["Object","Uninterferable"]}
