...
execute if score @s General.Object.Tick matches 02 run data merge entity @s {interpolation_duration:12,transformation:{translation:[0f, 0f, 0f],scale:[7f,0.05f,7f]},item:{id:"minecraft:stick",Count:1b,tag:{CustomModelData:20390}},start_interpolation:0}
