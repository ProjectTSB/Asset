#> asset:object/1163.ice_brand_arts_sword/summon/
#
# Object召喚処理の呼び出し時に実行されるfunction
#
# @within asset:object/alias/1163/summon
...
# 元となるEntityを召喚する
    ...
    function asset:object/1163.ice_brand_arts_sword/summon/m with storage asset:temp
