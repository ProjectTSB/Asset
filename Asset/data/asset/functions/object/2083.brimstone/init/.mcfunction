...
# スピード設定
    execute if predicate api:global_vars/difficulty/min/3_blessless run data modify storage asset:context this.StepPerTick set value 3
    execute unless predicate api:global_vars/difficulty/min/3_blessless run data modify storage asset:context this.StepPerTick set value 2.5
