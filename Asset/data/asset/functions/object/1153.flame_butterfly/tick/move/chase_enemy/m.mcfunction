...
# 攻撃前のディレイがない && 対象が近くにいないなら追跡
    execute if data storage asset:context this.AttackDelay{_:0} unless function asset:object/1153.flame_butterfly/predicate/near_target/very_near/ run function asset:object/1153.flame_butterfly/tick/move/chase_enemy/chase.m with storage asset:context this

# ターゲットが近くにいれば攻撃モードになる
    execute if data storage asset:context this{IsAttackMode:false} if data storage asset:context this.AttackCD{_:0} if function asset:object/1153.flame_butterfly/predicate/near_target/very_near/ run function asset:object/1153.flame_butterfly/tick/move/chase_enemy/set_attack_mode

# 攻撃モードなら攻撃処理
    execute if data storage asset:context this{IsAttackMode:true} run function asset:object/1153.flame_butterfly/tick/attack/
