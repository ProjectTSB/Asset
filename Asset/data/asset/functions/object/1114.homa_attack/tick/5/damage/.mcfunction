...
#
#
# @within function asset:object/1114.homa_attack/tick/5/
...
# Ownerの視点先に敵がいないかチェック
    execute as @p[tag=Owner] at @s anchored eyes positioned ^ ^ ^ run function asset:object/1114.homa_attack/tick/5/damage/find_target_line
