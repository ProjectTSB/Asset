...
# 数をカウントして、ダメージを割る
    execute store result score $Count Temporary if entity @e[type=#lib:living,tag=Enemy,tag=!Uninterferable,scores={MobID=0..},dx=16,dy=200,dz=16]
...
# ダメージ
    execute as @e[type=#lib:living,tag=Enemy,tag=Enemy.Boss,tag=!Uninterferable,dx=16,dy=200,dz=16] run function api:damage/
# リセット
