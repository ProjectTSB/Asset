...
# Tick加算
    ...
    execute if score @s General.Object.Tick matches 5 run data modify entity @s transformation.scale set value [0.1f,400f,0.1f]
...
# レーザー出る
    ...
    execute if score @s General.Object.Tick matches 65 run data modify entity @s transformation.scale set value [0f,400f,0f]
