...
# ダメージ設定
    # 与えるダメージ
        data modify storage lib: Argument.Damage set value 23
    # 属性
    ...
    # ダメージ
        ...
        execute as @e[type=#lib:living,tag=Enemy,tag=LandingTarget,tag=!Uninterferable,sort=nearest] run function lib:damage/
# リセット
