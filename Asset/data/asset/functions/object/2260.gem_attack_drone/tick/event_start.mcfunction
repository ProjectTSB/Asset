#> asset:object/2260.gem_attack_drone/tick/event_start
#
# Objectのtick時の処理
#
...
# アニメーション再生
    execute if entity @s[scores={General.Object.Tick=1}] as @e[type=item_display,tag=2260.Model.Target,distance=..30,sort=nearest,limit=1] at @s run function animated_java:gem_attack_drone/animations/summon/tween {duration:1, to_frame: 1}
...
# idleに移行
    execute if score @s General.Object.Tick matches 50.. run function asset:object/2260.gem_attack_drone/tick/start_idle
