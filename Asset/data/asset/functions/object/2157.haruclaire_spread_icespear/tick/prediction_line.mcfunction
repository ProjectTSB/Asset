...
# 予告線表示
    ...
    execute positioned ~ ~0.1 ~ rotated 0 0 run function api:object/summon
    ...
    data modify storage api: Argument.FieldOverride.Interpolation set value 40
    data modify storage api: Argument.FieldOverride.Tick set value 45
    execute positioned ~ ~0.1 ~ rotated 45 0 run function api:object/summon
    ...
    data modify storage api: Argument.FieldOverride.Tick set value 45
    execute positioned ~ ~0.1 ~ rotated 135 0 run function api:object/summon
    ...
    data modify storage api: Argument.FieldOverride.Interpolation set value 45
    data modify storage api: Argument.FieldOverride.Tick set value 45
    execute positioned ~ ~0.1 ~ rotated 225 0 run function api:object/summon
    ...
    data modify storage api: Argument.FieldOverride.Interpolation set value 45
    data modify storage api: Argument.FieldOverride.Tick set value 45
    execute positioned ~ ~0.1 ~ rotated 270 0 run function api:object/summon
    ...
    data modify storage api: Argument.FieldOverride.Interpolation set value 45
    data modify storage api: Argument.FieldOverride.Tick set value 45
    execute positioned ~ ~0.1 ~ rotated 315 0 run function api:object/summon
