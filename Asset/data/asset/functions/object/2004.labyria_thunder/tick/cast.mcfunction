...
# パーティクル表示
    particle dust 1 1 0.3 1.5 ~ ~1 ~ 0.5 0.5 0.5 0 30 force @a[distance=..32]
    particle dust 1 1 0.3 1.5 ~ ~5 ~ 0.25 2.5 0.25 0 40 force @a[distance=..32]
# 音
...
# ダメージ
    ...
    # デスログ
        data modify storage lib: Argument.DeathMessage append value '[{"translate": "%1$sは落雷によって感電してしまった","with":[{"selector":"@s"}]}]'
# 補正functionを実行
