#> asset:object/1169.plasma_beam/register
#
# Objectのデータを指定
#
# @within function asset:object/alias/1169/register
...
# ID (int)
    data modify storage asset:object ID set value 1169
# フィールド(オプション)
    data modify storage asset:object Field.Damage set value 0
    data modify storage asset:object Field.AdditionalMPHeal set value 0
