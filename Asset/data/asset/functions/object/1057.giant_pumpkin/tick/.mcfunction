...
# 高速回転状態じゃない時、前方の敵の方を向かせる
    #execute if entity @s[tag=!2031.HighSpeedSpinning] positioned ^ ^ ^15 run tag @e[type=#lib:living_without_player,tag=Enemy,tag=!Uninterferable,distance=..15] add Targetable
