...
# 演出
    particle explosion ~ ~1 ~ 0.3 0.3 0.3 0 5 force @a
    particle cloud ~ ~1 ~ 0 0 0 0.3 50 force @a
    particle flame ~ ~1 ~ 0 0 0 0.2 100 force @a
    particle dust 1 0.6 0 3.5 ~ ~ ~ 1.2 1.2 1.2 0 50 force @a
    particle dust 0.851 0 1 3.5 ~ ~ ~ 1.2 1.2 1.2 0 50 force @a
