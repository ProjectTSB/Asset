...
# エフェクト付与
    ...
    execute as @e[type=#lib:living,type=!player,tag=1009.Target,distance=..0.1] run function api:entity/mob/effect/give
...
# TP
    execute as @e[type=#lib:living,type=!player,tag=1009.Target,distance=..0.1] at @a[tag=1009.Player] rotated ~ 0 run tp @s ^ ^ ^2
