#> asset:object/1110.heavy_lava_bomb/summon/
#
# Object召喚処理の呼び出し時に実行されるfunction
#
# @within asset:object/alias/1110/summon
...
# 元となるEntityを召喚する
    ...
    function asset:object/1110.heavy_lava_bomb/summon/m with storage asset:temp Args
