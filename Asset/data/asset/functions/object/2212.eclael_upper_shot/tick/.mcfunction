...
# 演出
    ...
    execute if entity @s[scores={General.Object.Tick=60}] run data merge entity @s {interpolation_duration:3,start_interpolation:0,transformation:{left_rotation:{axis:[1,0,0],angle:-1.5708f},right_rotation:[0f,0f,0f,1f],translation:[0f,0f,0f],scale:[10f,300f,10f]},text:'[{"text":""}]'}
