...
# 設計上よろしくないものの、ハルクレアの接地処理を流用して攻撃位置を地表に揃える
    ...
    execute if entity @s[scores={General.Object.Tick=40}] if predicate api:global_vars/difficulty/max/normal at @s run function asset:object/2151.haruclaire_icewall_center/tick/prediction
    execute if entity @s[scores={General.Object.Tick=75}] if predicate api:global_vars/difficulty/min/hard at @s run function asset:object/2151.haruclaire_icewall_center/tick/prediction_hard
    ...
    execute if entity @s[scores={General.Object.Tick=80}] if predicate api:global_vars/difficulty/max/normal at @s run function asset:object/2151.haruclaire_icewall_center/tick/prediction
    execute if entity @s[scores={General.Object.Tick=115}] if predicate api:global_vars/difficulty/min/hard at @s run function asset:object/2151.haruclaire_icewall_center/tick/prediction_hard
    ...
    execute if entity @s[scores={General.Object.Tick=120}] if predicate api:global_vars/difficulty/max/normal at @s run function asset:object/2151.haruclaire_icewall_center/tick/prediction
    execute if entity @s[scores={General.Object.Tick=155}] if predicate api:global_vars/difficulty/min/hard at @s run function asset:object/2151.haruclaire_icewall_center/tick/prediction_hard
    ...
    execute if entity @s[scores={General.Object.Tick=160}] if predicate api:global_vars/difficulty/max/normal at @s run function asset:object/2151.haruclaire_icewall_center/tick/prediction
    execute if entity @s[scores={General.Object.Tick=195}] if predicate api:global_vars/difficulty/min/hard at @s run function asset:object/2151.haruclaire_icewall_center/tick/prediction_hard
    ...
    execute if entity @s[scores={General.Object.Tick=200}] if predicate api:global_vars/difficulty/max/normal at @s run function asset:object/2151.haruclaire_icewall_center/tick/prediction
    execute if entity @s[scores={General.Object.Tick=235}] if predicate api:global_vars/difficulty/min/hard at @s run function asset:object/2151.haruclaire_icewall_center/tick/prediction_hard
