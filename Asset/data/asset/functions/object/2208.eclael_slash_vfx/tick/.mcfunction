...
# モデル変更
    ...
    execute if entity @s[scores={General.Object.Tick=7}] run data modify entity @s text set value '{"text":"4","font":"object/2208/0"}'
    execute if entity @s[scores={General.Object.Tick=9}] run data modify entity @s text set value '{"text":"5","font":"object/2208/0"}'
    execute if entity @s[scores={General.Object.Tick=9}] run data merge entity @s {interpolation_duration:3,start_interpolation:0}
    execute if entity @s[scores={General.Object.Tick=9}] run data modify entity @s transformation.scale set value [0f,4f,0f]
