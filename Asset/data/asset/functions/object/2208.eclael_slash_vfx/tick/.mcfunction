...
# モデル変更
    ...
    execute if entity @s[scores={General.Object.Tick=4}] run data modify entity @s text set value '{"text":"1","font":"object/2208/0","color":"#FFFFFF"}'
    execute if entity @s[scores={General.Object.Tick=5}] run data modify entity @s text set value '{"text":"2","font":"object/2208/0","color":"#C4F1FF"}'
    execute if entity @s[scores={General.Object.Tick=8}] run data modify entity @s text set value '{"text":"3","font":"object/2208/0","color":"#C7FFDB"}'
    execute if entity @s[scores={General.Object.Tick=11}] run data modify entity @s text set value '{"text":"4","font":"object/2208/0","color":"#E1FFC7"}'
    execute if entity @s[scores={General.Object.Tick=13}] run data modify entity @s text set value '{"text":"5","font":"object/2208/0","color":"#FFF8CC"}'
