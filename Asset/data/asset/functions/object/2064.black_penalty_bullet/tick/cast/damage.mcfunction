...
# 引数の設定
    ...
    # デスログ
        data modify storage api: Argument.DeathMessage append value '[{"translate": "%1$sはズルしようとしたが、ウサギたちに咎められてしまった","with":[{"nbt":"Return.AttackerName","storage":"api:","interpret":true}]}]'
# 補正functionを実行
