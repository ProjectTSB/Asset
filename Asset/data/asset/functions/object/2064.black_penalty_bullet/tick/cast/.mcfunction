...
# ループ処理
    function asset:object/2064.black_penalty_bullet/tick/cast/loop

# ダメージ処理
    execute as @a[tag=2064.Landing,distance=..55] run function asset:object/2064.black_penalty_bullet/tick/cast/damage
