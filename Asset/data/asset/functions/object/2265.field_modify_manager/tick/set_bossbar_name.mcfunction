...
# ピリオド
    ...
    execute if score @s 2265.Period matches ..9 run data modify storage asset:context this.BossBar.Period set value ['{"text":".","bold":false,"font":"default"}','{"text":"\\uE004","font":"uniform","bold":false}']
    execute if score @s 2265.Period matches 10..19 run data modify storage asset:context this.BossBar.Period set value ['{"text":"..","bold":false,"font":"default"}','{"text":"\\uE002","font":"uniform","bold":false}']
    execute if score @s 2265.Period matches 20.. run data modify storage asset:context this.BossBar.Period set value ['{"text":"...","bold":false,"font":"default"}']
