...
# ピリオド
    ...
    execute if score @s 2265.Period matches ..9 run data modify storage asset:context this.BossBar.Period set value ['{"text":"."}','{"text":"\\uF004","font":"default"}']
    execute if score @s 2265.Period matches 10..19 run data modify storage asset:context this.BossBar.Period set value ['{"text":".."}','{"text":"\\uF002","font":"default"}']
