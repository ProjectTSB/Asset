#> asset:object/1171.torch_ballet/register
#
# Objectのデータを指定
#
# @within function asset:object/alias/1171/register
...
# ID (int)
    data modify storage asset:object ID set value 1171
# フィールド(オプション)
    # data modify storage asset:object Field.myValue set value
    data modify storage asset:context this.Speed set value 2
    data modify storage asset:context this.Range set value 20
