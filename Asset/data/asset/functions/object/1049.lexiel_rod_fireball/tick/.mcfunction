...
# 前方にいる一番近い敵をターゲットする
    execute if data storage asset:context this{HomingDelay:0} positioned ^ ^ ^15 as @e[type=#lib:living,tag=Enemy,tag=!Uninterferable,distance=..15] run tag @s add 1049.TargetCandidate
