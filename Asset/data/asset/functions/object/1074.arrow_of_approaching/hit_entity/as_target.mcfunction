...
# SE
    execute positioned as @s rotated as @a[tag=1074.Player] rotated ~ 0 positioned ^ ^ ^-2 run playsound minecraft:entity.enderman.teleport player @a ~ ~ ~ 0.8 1
    execute at @a[tag=1074.Player] run playsound minecraft:entity.enderman.teleport player @a ~ ~ ~ 0.8 1
