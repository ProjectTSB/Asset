...
# 移動
    ...
    execute if entity @s[scores={General.Object.Tick=3..115}] if predicate api:global_vars/difficulty/min/hard facing entity @p[tag=!PlayerShouldInvulnerable] feet run tp @s ~ ~ ~ ~ ~-10
