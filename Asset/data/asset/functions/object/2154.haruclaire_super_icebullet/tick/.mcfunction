...
# 移動
    ...
    execute if entity @s[scores={General.Object.Tick=1..120}] facing entity @p[tag=!PlayerShouldInvulnerable] feet run tp @s ~ ~ ~ ~ ~-10
    ...
    execute if entity @s[scores={General.Object.Tick=80..}] at @s run tp @s ~ ~ ~ ~ ~1
