#> asset:object/1085.sanguis_obj/tick/slash2
#
#
#
...
# 攻撃判定
    execute as @e[type=#lib:living,tag=Enemy,tag=!Uninterferable,distance=..3] run function asset:object/1085.sanguis_obj/tick/damage
