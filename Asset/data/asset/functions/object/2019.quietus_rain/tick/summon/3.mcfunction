...
# 召喚
    ...
    execute if predicate api:global_vars/difficulty/max/2_hard rotated ~120 ~ positioned ^ ^ ^22.5 run function asset:object/2019.quietus_rain/tick/summon/0
    execute if predicate api:global_vars/difficulty/max/2_hard rotated ~240 ~ positioned ^ ^ ^22.5 run function asset:object/2019.quietus_rain/tick/summon/0
