...
#
#
# @within function asset:object/1161.ice_brand_arts_axe/tick/
    ...
    execute if score @s 1161.Kind matches 3 on target run data modify storage api: Argument.ID set value 1461
    execute if score @s 1161.Kind matches 4 on target run data modify storage api: Argument.ID set value 1462
    execute if score @s 1161.Kind matches 5 on target run data modify storage api: Argument.ID set value 1460
