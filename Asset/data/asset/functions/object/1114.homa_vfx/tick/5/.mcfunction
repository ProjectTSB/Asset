#> asset:object/1114.homa_vfx/tick/5/
#
#
#
...
# 5の1段目
    execute if score @s General.Object.Tick matches 1 run function asset:object/1114.homa_vfx/tick/5/1/1
    execute if score @s General.Object.Tick matches 2 run function asset:object/1114.homa_vfx/tick/5/1/2
    execute if score @s General.Object.Tick matches 3 run function asset:object/1114.homa_vfx/tick/5/1/3

# OwnerへTP
    #execute if score @s General.Object.Tick matches 4 run function asset:object/1114.homa_vfx/tick/5/tp_to_owner
