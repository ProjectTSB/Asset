...
# 演出
    ...
    execute if entity @s[scores={General.Object.Tick=64..}] run particle dust 0.851 0 1 1.3 ~ ~ ~ 0.8 0.8 0.8 0 3 normal @a
    execute if entity @s[scores={General.Object.Tick=64..}] run particle block carved_pumpkin ~ ~0.1 ~ 0.8 0 0.8 0 10 normal @a
