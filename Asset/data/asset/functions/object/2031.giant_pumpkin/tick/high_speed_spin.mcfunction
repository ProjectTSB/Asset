...
# 演出
    particle dust 1 0.6 0 1.3 ~ ~ ~ 0.8 0.8 0.8 0 3 force @a
    particle dust 0.851 0 1 1.3 ~ ~ ~ 0.8 0.8 0.8 0 3 force @a
    particle block carved_pumpkin ~ ~-1 ~ 0.8 0 0.8 0 10 force @a
