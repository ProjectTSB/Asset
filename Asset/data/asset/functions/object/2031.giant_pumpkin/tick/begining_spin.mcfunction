...
# 徐々に加速する縦回転をする
    ...
    execute if entity @s[scores={General.Object.Tick=2}] run data modify entity @s interpolation_duration set value 16
    execute if entity @s[scores={General.Object.Tick=2}] run function asset:object/2031.giant_pumpkin/tick/set_spin
...
# 演出
    ...
    execute if entity @s[scores={General.Object.Tick=18}] run playsound minecraft:entity.wither.shoot hostile @a ~ ~ ~ 0.5 1.1
    execute if entity @s[scores={General.Object.Tick=18}] run particle cloud ~ ~0.2 ~ 0.1 0 0.1 0.2 6 normal @a
    execute if entity @s[scores={General.Object.Tick=26}] run playsound minecraft:entity.wither.shoot hostile @a ~ ~ ~ 0.5 1.2
    execute if entity @s[scores={General.Object.Tick=26}] run particle cloud ~ ~0.2 ~ 0.1 0 0.1 0.2 7 normal @a
    execute if entity @s[scores={General.Object.Tick=33}] run playsound minecraft:entity.wither.shoot hostile @a ~ ~ ~ 0.5 1.3
    execute if entity @s[scores={General.Object.Tick=33}] run particle cloud ~ ~0.2 ~ 0.1 0 0.1 0.2 8 normal @a
    execute if entity @s[scores={General.Object.Tick=40}] run playsound minecraft:entity.wither.shoot hostile @a ~ ~ ~ 0.5 1.4
    execute if entity @s[scores={General.Object.Tick=40}] run particle cloud ~ ~0.2 ~ 0.1 0 0.1 0.2 9 normal @a
    execute if entity @s[scores={General.Object.Tick=46}] run playsound minecraft:entity.wither.shoot hostile @a ~ ~ ~ 0.5 1.5
    execute if entity @s[scores={General.Object.Tick=46}] run particle cloud ~ ~0.2 ~ 0.1 0 0.1 0.2 10 normal @a
    execute if entity @s[scores={General.Object.Tick=52}] run playsound minecraft:entity.wither.shoot hostile @a ~ ~ ~ 0.5 1.6
    execute if entity @s[scores={General.Object.Tick=57}] run particle cloud ~ ~0.2 ~ 0.1 0 0.1 0.2 11 normal @a
    execute if entity @s[scores={General.Object.Tick=57}] run playsound minecraft:entity.wither.shoot hostile @a ~ ~ ~ 0.5 1.7
    execute if entity @s[scores={General.Object.Tick=62}] run particle cloud ~ ~0.2 ~ 0.1 0 0.1 0.2 12 normal @a
    execute if entity @s[scores={General.Object.Tick=62}] run playsound minecraft:entity.wither.shoot hostile @a ~ ~ ~ 0.5 1.8
    execute if entity @s[scores={General.Object.Tick=66}] run particle cloud ~ ~0.2 ~ 0.1 0 0.1 0.2 13 normal @a
    execute if entity @s[scores={General.Object.Tick=66}] run playsound minecraft:entity.wither.shoot hostile @a ~ ~ ~ 0.5 1.9
    execute if entity @s[scores={General.Object.Tick=70}] run particle cloud ~ ~0.2 ~ 0.1 0 0.1 0.2 14 normal @a
    execute if entity @s[scores={General.Object.Tick=70}] run playsound minecraft:entity.wither.shoot hostile @a ~ ~ ~ 0.5 2
