...
# 敵の付近にテレポート
    execute at @e[type=#lib:living,tag=Enemy,distance=..20,sort=nearest,limit=1] positioned ~ ~0.5 ~ run function asset:object/1050.call_fulstuka/tick/spreadteleport
