...
# 1発目に限り、前方の敵を優先する
    execute if data storage asset:context this{FirstShot:true} run function asset:object/1178.yumeori_falling_arrow_manager/tick/set_pos/first/m with storage asset:context this.Pos
...
# 範囲内のランダムな敵の位置で攻撃
    function asset:object/1178.yumeori_falling_arrow_manager/tick/set_pos/1.set_y.m with storage asset:context this.Pos
