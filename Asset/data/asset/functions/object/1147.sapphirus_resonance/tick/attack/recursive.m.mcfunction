...
# 命中判定
    execute positioned ~-.5 ~-.5 ~-.5 as @e[type=#lib:living_without_player,tag=!Uninterferable,dx=0,limit=1] at @s run return run function asset:object/1147.sapphirus_resonance/tick/attack/hit
# 再帰
