#> asset:object/2200.twins_escape_animation/tick/event_rubiel
#
# Objectのtick時の処理
#
...
# 消去
    execute if score @s General.Object.Tick matches 66 run function asset:object/2200.twins_escape_animation/tick/remove_rubiel
