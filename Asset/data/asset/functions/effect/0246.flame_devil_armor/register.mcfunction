#> asset:effect/0246.flame_devil_armor/register
#
# Effectのデータを指定
#
# @within function asset:effect/0246.flame_devil_armor/_/register

# ExtendsSafe (boolean) (default = false)
    # data modify storage asset:effect ExtendsSafe set value true
# ID (int)
    data modify storage asset:effect ID set value 246
