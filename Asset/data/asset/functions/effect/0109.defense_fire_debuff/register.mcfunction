#> asset:effect/0109.defense_fire_debuff/register
#
#
#
# @within function asset:effect/0109.defense_fire_debuff/_/register
...
# 説明文
    data modify storage asset:effect Description set value ['{"text":"敵から受ける火属性ダメージが減少する"}']
