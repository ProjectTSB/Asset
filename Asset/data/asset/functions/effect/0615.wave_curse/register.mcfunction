#> asset:effect/0615.wave_curse/register
#
# Effectのデータを指定
#
# @within function asset:effect/0615.wave_curse/_/register
...
# 名前 (TextComponentString)
    data modify storage asset:effect Name set value '{"text":"荒波の呪い","color":"blue"}'
