...
# 説明文 (TextComponentString[])
    data modify storage asset:effect Description set value ['{"text":"雨が降っている、または水に触れている時","color":"white"}','{"text":"暗視、イルカの好意、コンジットパワーを得る","color":"white"}','{"text":"水攻撃+5%","color":"green"}']
