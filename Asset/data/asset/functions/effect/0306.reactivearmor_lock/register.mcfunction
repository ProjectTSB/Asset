#> asset:effect/0306.reactivearmor_lock/register
#
# Effectのデータを指定
#
# @within function asset:effect/0306.reactivearmor_lock/_/register

# ExtendsSafe (boolean) (default = false)
    # data modify storage asset:effect ExtendsSafe set value true
# ID (int)
    data modify storage asset:effect ID set value 306
# 名前 (TextComponentString)
    data modify storage asset:effect Name set value '{"text":"リアクティブアーマー"}'
