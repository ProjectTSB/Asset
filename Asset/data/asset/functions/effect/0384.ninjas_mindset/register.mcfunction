#> asset:effect/0384.ninjas_mindset/register
#
# Effectのデータを指定
#
# @within function asset:effect/0384.ninjas_mindset/_/register

# ExtendsSafe (boolean) (default = false)
    # data modify storage asset:effect ExtendsSafe set value true
# ID (int)
    data modify storage asset:effect ID set value 384
# 名前 (TextComponentString)
    data modify storage asset:effect Name set value '{"text": "忍ビノ心得"}'
# 説明文 (TextComponentString[])
    data modify storage asset:effect Description set value ['{"text": "物理攻撃 +5%", "color": "green"}','{"text": "暗所にいるとき、さらに", "extra": [{"text": "物理攻撃 +10%", "color": "green"}]}']
