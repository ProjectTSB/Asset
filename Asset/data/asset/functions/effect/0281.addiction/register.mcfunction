#> asset:effect/0281.addiction/register
#
# Effectのデータを指定
#
# @within function asset:effect/0281.addiction/_/register

# ExtendsSafe (boolean) (default = false)
    # data modify storage asset:effect ExtendsSafe set value true
# ID (int)
    data modify storage asset:effect ID set value 281
# 名前 (TextComponentString)
    data modify storage asset:effect Name set value '{"text":"中毒","color":"red"}'
# 説明文 (TextComponentString[])
    data modify storage asset:effect Description set value ['{"text":"与ダメージが大きく低下し、被ダメージが大きく上昇する","color":"red"}']
