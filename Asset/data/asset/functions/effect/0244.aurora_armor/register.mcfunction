#> asset:effect/0244.aurora_armor/register
#
# Effectのデータを指定
#
# @within function asset:effect/0244.aurora_armor/_/register

# ExtendsSafe (boolean) (default = false)
    # data modify storage asset:effect ExtendsSafe set value true
# ID (int)
    data modify storage asset:effect ID set value 244
...
# 説明文 (TextComponentString[])
    data modify storage asset:effect Description set value ['{"text":"雷攻撃 +10%","color":"green"}','{"text":"MP回復量 +10%","color":"green"}']
