#> asset:effect/0268.macaron_barrier/register
#
# Effectのデータを指定
#
# @within function asset:effect/0268.macaron_barrier/_/register

# ExtendsSafe (boolean) (default = false)
    # data modify storage asset:effect ExtendsSafe set value true
# ID (int)
    data modify storage asset:effect ID set value 268
# 名前 (TextComponentString)
    data modify storage asset:effect Name set value '{"text":"マカロンバリア","color":"#F6BFFF"}'
