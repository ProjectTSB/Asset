#> asset:effect/0312.deadly_poison/register
#
# Effectのデータを指定
#
# @within function asset:effect/0312.deadly_poison/_/register

# ExtendsSafe (boolean) (default = false)
    # data modify storage asset:effect ExtendsSafe set value true
# ID (int)
    data modify storage asset:effect ID set value 312
# 名前 (TextComponentString)
    data modify storage asset:effect Name set value '{"text":"猛毒"}'
