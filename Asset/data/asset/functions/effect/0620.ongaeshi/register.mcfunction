#> asset:effect/0620.ongaeshi/register
#
# Effectのデータを指定
#
# @within function asset:effect/0620.ongaeshi/_/register

# ExtendsSafe (boolean) (default = false)
    # data modify storage asset:effect ExtendsSafe set value true
# ID (int)
    data modify storage asset:effect ID set value 620
# 名前 (TextComponentString)
    data modify storage asset:effect Name set value '{"text":"恩返し"}'
