#> asset:effect/0106.attack_thunder_debuff/register
#
#
#
# @within function asset:effect/0106.attack_thunder_debuff/_/register
...
# 説明文
    data modify storage asset:effect Description set value ['{"text":"敵に与える雷属性ダメージが減少する"}']
