...
# 説明文 (TextComponentString[])
    data modify storage asset:effect Description set value ['{"text":"白雪で身を覆った時、"}','{"text":"攻撃に対して追撃が発生し、"}','{"text":"周囲の動きを鈍らせる。"}','{"text":"水攻撃 +20%","color":"green"}','{"text":"被回復量 -10%","color":"red"}']
