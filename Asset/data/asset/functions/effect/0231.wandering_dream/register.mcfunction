#> asset:effect/0231.wandering_dream/register
#
# Effectのデータを指定
#
# @within function asset:effect/0231.wandering_dream/_/register

# ExtendsSafe (boolean) (default = false)
    data modify storage asset:effect ExtendsSafe set value false
# ID (int)
    data modify storage asset:effect ID set value 231
