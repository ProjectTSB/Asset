...
# チャージ段階に比例して演出とスタックを変える
    execute if score $Charge Temporary matches 0 run playsound entity.evoker.prepare_summon player @a[distance=..10] ~ ~ ~ 0.8 1.4 0.8
    ...
    execute if score $Charge Temporary matches 12 run playsound entity.evoker.prepare_summon player @a[distance=..10] ~ ~ ~ 0.8 1.6 0.8
    ...
    execute if score $Charge Temporary matches 24 run playsound entity.evoker.prepare_summon player @a[distance=..10] ~ ~ ~ 0.8 1.8 0.8
