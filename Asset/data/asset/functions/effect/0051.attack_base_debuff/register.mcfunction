#> asset:effect/0051.attack_base_debuff/register
#
# Effectのデータを指定
#
# @within function asset:effect/0051.attack_base_debuff/_/register

# ExtendsSafe (boolean) (default = false)
    # data modify storage asset:effect ExtendsSafe set value true
# ID (int)
    data modify storage asset:effect ID set value 51
