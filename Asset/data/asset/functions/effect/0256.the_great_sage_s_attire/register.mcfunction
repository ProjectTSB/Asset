#> asset:effect/0256.the_great_sage_s_attire/register
#
# Effectのデータを指定
#
# @within function asset:effect/0256.the_great_sage_s_attire/_/register

# ExtendsSafe (boolean) (default = false)
    # data modify storage asset:effect ExtendsSafe set value true
# ID (int)
    data modify storage asset:effect ID set value 256
# 名前 (TextComponentString)
    data modify storage asset:effect Name set value '{"text":"大賢者の装束","color":"#FED4FF"}'
