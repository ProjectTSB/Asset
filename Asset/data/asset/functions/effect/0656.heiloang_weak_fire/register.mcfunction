#> asset:effect/0656.heiloang_weak_fire/register
#
# Effectのデータを指定
#
# @within function asset:effect/0656.heiloang_weak_fire/_/register
...
# 説明文 (TextComponentString[])
    data modify storage asset:effect Description set value ['{"text":"黒龍の呪いが、炎への守りを妨げる"}']
