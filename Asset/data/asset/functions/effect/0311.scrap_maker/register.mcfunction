#> asset:effect/0311.scrap_maker/register
#
# Effectのデータを指定
#
# @within function asset:effect/0311.scrap_maker/_/register
...
# 説明文 (TextComponentString[])
    data modify storage asset:effect Description set value '{"text":"持続ダメージを与える"}'
