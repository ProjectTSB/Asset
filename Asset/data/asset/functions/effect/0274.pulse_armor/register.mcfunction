#> asset:effect/0274.pulse_armor/register
#
# Effectのデータを指定
#
# @within function asset:effect/0274.pulse_armor/_/register

# ExtendsSafe (boolean) (default = false)
    # data modify storage asset:effect ExtendsSafe set value true
# ID (int)
    data modify storage asset:effect ID set value 274
# 名前 (TextComponentString)
    data modify storage asset:effect Name set value '{"text":"パルスアーマー","color":"#44bbff"}'
# 説明文 (TextComponentString[])
    data modify storage asset:effect Description set value ['{"text":"すべて装備した時、最大稼動する。"}']
