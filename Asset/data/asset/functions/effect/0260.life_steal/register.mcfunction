...
# 説明文 (TextComponentString[])
    data modify storage asset:effect Description set value '{"text":"最大体力に比例して与える物理ダメージが上昇する","color":"white"}'
# 効果時間 (int) (default = API || error)
    data modify storage asset:effect Duration set value 450
...
# 最大効果時間 (int) (default = 2147483647)
    data modify storage asset:effect MaxDuration set value 450
