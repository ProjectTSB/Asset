#> asset:effect/0316.aurora_slash/tick/slash/2
#
#
#
...
# 演出
    playsound entity.evoker.prepare_summon hostile @a ~ ~ ~ 0.8 1.85 0
    playsound minecraft:item.trident.throw player @a ~ ~ ~ 0.4 0.8
    execute anchored eyes positioned ^ ^-0.2 ^1.5 run function asset:effect/0316.aurora_slash/tick/vfx/slash2
...
# ダメージ
    ...
    execute as @e[type=#lib:living,type=!player,tag=Enemy,tag=316.Target,distance=..4] run function api:damage/
