#> asset:effect/0108.defense_physical_debuff/register
#
#
#
# @within function asset:effect/0108.defense_physical_debuff/_/register

# ExtendsSafe (boolean) (オプション)
    data modify storage asset:effect ExtendsSafe set value true
# ID
    data modify storage asset:effect ID set value 108
# 名前
    data modify storage asset:effect Name set value '{"text":"物理耐性低下"}'
# 説明文
    data modify storage asset:effect Description set value ['{"text":"敵から受ける物理ダメージが減少する"}']
