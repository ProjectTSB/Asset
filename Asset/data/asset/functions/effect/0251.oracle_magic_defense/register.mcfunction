#> asset:effect/0251.oracle_magic_defense/register
#
# Effectのデータを指定
#
# @within function asset:effect/0251.oracle_magic_defense/_/register

# ExtendsSafe (boolean) (default = false)
    # data modify storage asset:effect ExtendsSafe set value true
# ID (int)
    data modify storage asset:effect ID set value 251
# 名前 (TextComponentString)
    data modify storage asset:effect Name set value '{"text":"神託・魔法耐性","color":"#F0E265"}'
# 説明文 (TextComponentString[])
    data modify storage asset:effect Description set value ['{"text":"魔法被ダメージが減少する","color":"white"}']
