#> asset:effect/0319.karma/register
#
# Effectのデータを指定
#
# @within function asset:effect/0319.karma/_/register

# ExtendsSafe (boolean) (default = false)
    # data modify storage asset:effect ExtendsSafe set value true
# ID (int)
    data modify storage asset:effect ID set value 319
# 名前 (TextComponentString)
    data modify storage asset:effect Name set value '{"text":"カルマ"}'
# 説明文 (TextComponentString[])
    data modify storage asset:effect Description set value ['{"text":"一定時間後にダメージを受ける"}']
