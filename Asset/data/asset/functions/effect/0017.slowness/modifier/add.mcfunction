...
# (Stack * 5)%移動速度を下げる
    data modify storage asset:temp 17.ID set from storage asset:context originID
    data modify storage asset:temp 17.UUID set from storage asset:context this.UUID
