...
# 名前 (TextComponentString)
    data modify storage asset:effect Name set value '{"text":"かぐや姫の難題","color":"#ffffe0","bold":true}'
# 説明文 (TextComponentString[])
    data modify storage asset:effect Description set value ['{"text":"水耐性 +15%","color":"green"}','{"text":"火耐性 +20%","color":"green"}','{"text":"物理耐性 +10%","color":"green"}','{"text":"落下耐性 +15%","color":"green"}']
