#> asset:effect/0113.heal_debuff/register
#
#
#
# @within function asset:effect/0113.heal_debuff/_/register
...
# 説明文
    data modify storage asset:effect Description set value ['{"text":"自分と味方に与える回復量が減少する"}']
