...
# 取引 シャードLv1
    ...
    data modify storage asset:trader Trades[-1].RequiredProgress set value 10
...
# 取引 シャードLv2
    ...
    data modify storage asset:trader Trades[-1].RequiredProgress set value 35
...
# 取引 シャードLv3
    ...
    data modify storage asset:trader Trades[-1].RequiredProgress set value 60
...
# 取引 シャードLv4
    ...
    data modify storage asset:trader Trades[-1].RequiredProgress set value 85
