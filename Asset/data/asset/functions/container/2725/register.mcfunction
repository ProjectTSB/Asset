#> asset:container/2725/register
#
# コンテナの定義データ
#
# @within function asset:container/2725/


execute unless loaded 279 60 -243 run return 1

# ID (int)
    data modify storage asset:container ID set value 2725
# Pos ([int] @ 3)
    data modify storage asset:container Pos set value [279, 60, -243]
