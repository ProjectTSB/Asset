#> asset:container/1183/register
#
# コンテナの定義データ
#
# @within function asset:container/1183/


execute unless loaded -162 147 -350 run return 1

# ID (int)
    data modify storage asset:container ID set value 1183
# Pos ([int] @ 3)
