#> asset:container/2729/register
#
# コンテナの定義データ
#
# @within function asset:container/2729/


execute unless loaded 281 60 -243 run return 1

# ID (int)
    data modify storage asset:container ID set value 2729
# Pos ([int] @ 3)
    data modify storage asset:container Pos set value [281, 60, -243]
