#> asset:container/2720/register
#
# コンテナの定義データ
#
# @within function asset:container/2720/


execute unless loaded 56 96 -250 run return 1

# ID (int)
    data modify storage asset:container ID set value 2720
# Pos ([int] @ 3)
