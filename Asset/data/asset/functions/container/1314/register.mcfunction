#> asset:container/1314/register
#
# コンテナの定義データ
#
# @within function asset:container/1314/


execute unless loaded 23 118 -393 run return 1

# ID (int)
    data modify storage asset:container ID set value 1314
# Pos ([int] @ 3)
