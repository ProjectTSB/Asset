#> asset:container/136/register
#
# コンテナの定義データ
#
# @within function asset:container/136/


execute unless loaded 177 38 -38 run return 1

# ID (int)
    data modify storage asset:container ID set value 136
# Pos ([int] @ 3)
