#> asset:container/1245/register
#
# コンテナの定義データ
#
# @within function asset:container/1245/


execute unless loaded 121 39 40 run return 1

# ID (int)
    data modify storage asset:container ID set value 1245
# Pos ([int] @ 3)
