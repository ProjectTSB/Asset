#> asset:container/1728/register
#
# コンテナの定義データ
#
# @within function asset:container/1728/


execute unless loaded 111 204 608 run return 1

# ID (int)
    data modify storage asset:container ID set value 1728
# Pos ([int] @ 3)
    data modify storage asset:container Pos set value [111, 204, 608]
