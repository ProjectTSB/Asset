#> asset:container/2726/register
#
# コンテナの定義データ
#
# @within function asset:container/2726/


execute unless loaded 280 60 -243 run return 1

# ID (int)
    data modify storage asset:container ID set value 2726
# Pos ([int] @ 3)
    data modify storage asset:container Pos set value [280, 60, -243]
