#> asset:container/2700/register
#
# コンテナの定義データ
#
# @within function asset:container/2700/


execute unless loaded -456 95 51 run return 1

# ID (int)
    data modify storage asset:container ID set value 2700
# Pos ([int] @ 3)
