#> asset:container/2714/register
#
# コンテナの定義データ
#
# @within function asset:container/2714/


execute unless loaded 149 82 39 run return 1

# ID (int)
    data modify storage asset:container ID set value 2714
# Pos ([int] @ 3)
    data modify storage asset:container Pos set value [149, 82, 39]
# ブロック (id(minecraft:block))
    data modify storage asset:container Block set value "minecraft:dropper[facing=north]{CustomName:\"§8冷蔵庫\"}"
