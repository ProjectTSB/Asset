...
# 神器のトリガー処理
#
# @within function asset:artifact/alias/948/click/
...
# 発砲
    execute anchored eyes positioned ^-0.35 ^-0.15 ^ facing entity @e[type=marker,tag=SpreadMarker,limit=1] feet run function asset:artifact/0948.ft_139_rifle/click/bullet
