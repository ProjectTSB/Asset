#> asset:artifact/0948.ft_139_rifle/click/bullet
#
#
#
# @within function
#       asset:artifact/0948.ft_139_rifle/click/
#       asset:artifact/0948.ft_139_rifle/click/bullet
...
# 着弾
    execute if entity @s[tag=Landing] run function asset:artifact/0948.ft_139_rifle/click/hit

# 再起
    execute positioned ^ ^ ^0.5 if entity @s[tag=!Landing,distance=..30] run function asset:artifact/0948.ft_139_rifle/click/bullet