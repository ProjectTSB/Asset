#> asset:artifact/0948.ft_139_rifle/using_item/bullet
#
#
#
# @within function
...
# 着弾
    execute if entity @s[tag=Landing] run function asset:artifact/0948.ft_139_rifle/using_item/hit

# 再起
    execute positioned ^ ^ ^0.5 if entity @s[tag=!Landing,distance=..30] run function asset:artifact/0948.ft_139_rifle/using_item/bullet
