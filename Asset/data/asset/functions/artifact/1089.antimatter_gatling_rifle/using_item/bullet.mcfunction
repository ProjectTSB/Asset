#> asset:artifact/1089.antimatter_gatling_rifle/using_item/bullet
#
# ビーム部
#
# @within function
#    asset:artifact/1089.antimatter_gatling_rifle/using_item/bullet
#    asset:artifact/1089.antimatter_gatling_rifle/using_item/shot
...
# 着弾
    execute if entity @s[tag=Landing] run function asset:artifact/1089.antimatter_gatling_rifle/using_item/hit

# 再起
    execute positioned ^ ^ ^0.5 if entity @s[tag=!Landing,distance=..20] run function asset:artifact/1089.antimatter_gatling_rifle/using_item/bullet
