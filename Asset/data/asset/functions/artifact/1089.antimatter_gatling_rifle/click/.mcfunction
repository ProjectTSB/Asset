#> asset:artifact/1089.antimatter_gatling_rifle/click/
#
# 神器のトリガー処理
#
# @within function asset:artifact/alias/1089/click/
...
# 発砲
    function asset:artifact/1089.antimatter_gatling_rifle/click/shot
    function asset:artifact/1089.antimatter_gatling_rifle/click/shot
