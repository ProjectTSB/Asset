#> asset:artifact/1089.antimatter_gatling_rifle/click/hit
#
#
# @within function
...
# ダメージ設定
    ...
    # もし、適正距離じゃなかった場合、距離-適正距離=減少ダメージにする
        execute if score $Distance_Damping Temporary >= $Appropriate_Distance Temporary run function asset:artifact/1089.antimatter_gatling_rifle/click/damage_attenuation
    # ダメージ量確定
