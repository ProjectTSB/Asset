#> asset:artifact/0927.lexiel_s_oath/attack_melee/
#
# 神器のトリガー処理
#
...
# 確率で相手に9999ダメージ
    execute if predicate lib:random_pass_per/5 run function asset:artifact/0927.lexiel_s_oath/attack_melee/4.critical_hit
