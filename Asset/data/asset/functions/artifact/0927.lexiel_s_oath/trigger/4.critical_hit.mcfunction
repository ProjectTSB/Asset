...
# 9999の貫通ダメージを与える
    # 与えるダメージ = 9999 ボスは999
        execute if entity @e[type=#lib:living,tag=Victim,tag=Enemy.Boss,tag=!Uninterferable,distance=..10] run data modify storage lib: Argument.Damage set value 999f
