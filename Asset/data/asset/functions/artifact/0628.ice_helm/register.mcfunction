#> asset:artifact/0628.ice_helm/register
#
# 神器の生成処理
#
# @within function asset:artifact/alias/628/register
...
# 装備時補正 (Compound[]) (オプション)
    ...
    data modify storage asset:artifact Modifiers append value {Type:"attack/water",Amount:0.01d,Operation:"multiply_base"}
