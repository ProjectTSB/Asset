...
# 神器の名前 (TextComponentString)
    data modify storage asset:artifact Name set value '{"text":"クァンタム・デストロイヤー","color":"#820000"}'
# 神器の説明文 (TextComponentString[])
    data modify storage asset:artifact Lore set value ['{"text":"長押しすることでチャージを行う"}','{"text":"チャージをすると短射程貫通レーザーで相手を破壊する"}']
