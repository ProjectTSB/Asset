...
# 神器の生成処理
#
# @within function asset:artifact/alias/725/register
...
# 装備時補正 (Compound[]) (オプション)
    ...
    data modify storage asset:artifact Modifiers append value {Type:"receive_heal",Amount:-0.15d,Operation:"multiply_base"}
# 扱える神 (string[]) Wikiを参照
