...
# 神器のトリガー処理
#
# @within function asset:artifact/alias/967/using_item/

# 30%の確率でMPを消費しない
    execute if predicate lib:random_pass_per/30 run function asset:artifact/0967.enhanced_protection/using_item/add_mp
...
# タグ
    schedule function asset:artifact/0967.enhanced_protection/using_item/schedule_task 1t
