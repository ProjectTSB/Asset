#> asset:artifact/0268.heal_lv.10/click/
#
# 神器のトリガー処理
#
# @within function asset:artifact/alias/268/click/
...
# 回復
    data modify storage lib: Argument.Heal set value 8.0f
    function lib:heal/modifier
    execute as @a[distance=..4.5,sort=nearest,limit=6] run function lib:heal/
# リセット
