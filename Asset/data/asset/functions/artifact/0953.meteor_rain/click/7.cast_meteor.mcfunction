#> asset:artifact/0953.meteor_rain/click/7.cast_meteor
#
# メテオを召喚して拡散させる
#
# @within function asset:artifact/0953.meteor_rain/click/6.summon_meteor
...
# init処理実行
    execute as @e[type=armor_stand,tag=QH.MeteorInit,distance=..50,sort=nearest,limit=1] at @s run function asset:artifact/0953.meteor_rain/click/meteor/1.init

# メテオのループ処理開始
    schedule function asset:artifact/0953.meteor_rain/click/meteor/2.tick 1t replace
