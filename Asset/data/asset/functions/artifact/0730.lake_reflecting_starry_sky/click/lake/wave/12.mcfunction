#> asset:artifact/0730.lake_reflecting_starry_sky/click/lake/wave/12
#
# 波の演出と処理12
#
...
# ドーナツ状の当たり判定にentityがいた場合Tagを付与
    execute as @e[type=#lib:living,tag=Enemy,tag=!Uninterferable,distance=5.01..5.5] positioned ~-7.5 ~-1 ~-7.5 if entity @s[dx=14,dy=1,dz=14] run tag @s add Target
