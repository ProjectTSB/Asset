#> asset:artifact/0730.lake_reflecting_starry_sky/click/lake/ripple/damage
#
# ダメージと演出
#
# @within function asset:artifact/0730.lake_reflecting_starry_sky/click/lake/ripple/main

# 演出
    execute positioned ~ ~0.4 ~ run function asset:artifact/0730.lake_reflecting_starry_sky/click/lake/ripple/vfx
