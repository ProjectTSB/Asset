...
# 装備時のステータス補正 (Component[]) (オプション)
    data modify storage asset:artifact Modifiers set value [{Type:"defenseWater",Slot:"feet",Amount:0.05d,Operation:"multiply_base"},{Type:"defenseThunder",Slot:"feet",Amount:0.05d,Operation:"multiply_base"}]
# 扱える神 (string[]) Wikiを参照
