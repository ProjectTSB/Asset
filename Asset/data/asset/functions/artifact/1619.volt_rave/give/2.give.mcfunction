#> asset:artifact/1619.volt_rave/give/2.give
#
# 神器の作成部 ここでID等を定義する
#
# @user
# @within function asset:artifact/1619.volt_rave/give/1.trigger

# 神器の説明や消費MPなどをここで設定する。
# 最後にasset:artifact/common/giveを実行することで入手可能。

# 神器のID (int) スプレッドシートの値を入れる
    data modify storage asset:artifact ID set value 1619
# 神器のベースアイテム
...
# 神器の説明文 (TextComponentString[])
    data modify storage asset:artifact Lore set value ['{"text":"長押しすることでチャージを行い"}','{"translate":"%1$sを離すことでプラズマレーザーを放つ","with":[{"keybind":"key.use"}]}','{"text":"最大までチャージすると出力が飛躍的に増大する"}','{"text":"プラズマを圧縮・収束させ放つ光線銃","color":"gray"}']
