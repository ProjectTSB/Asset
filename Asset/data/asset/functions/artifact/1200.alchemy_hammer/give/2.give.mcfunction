...
# 神器の説明文 (TextComponentString[])
    data modify storage asset:artifact Lore set value ['[{"text":"攻撃時、確率で","color":"white"},{"text":"光の柱","color":"#FFFFC7"},{"text":"を召喚する。","color":"white"}]','[{"text":"光の柱","color":"#FFFFC7"},{"text":"は周囲のMobに本来の50%分のダメージを与える。","color":"white"}]','[{"text":"錬金用のハンマーは万能なんだぜ！","color":"gray"}]']
...
# 攻撃に関する情報 -Damage量 (literal[]/literal) Wikiを参照 (オプション)
    data modify storage asset:artifact AttackInfo.Damage set value [1100,1200]
