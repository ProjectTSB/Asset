...
# 装備を外した時のメイン処理
#
# @within function asset:artifact/0634.elec_leggings/equip/dis_equip/
...
# 一式効果削除
    execute if entity @s[tag=HL.Fullset] run function asset:artifact/0633.elec_armor/equip/5.fullset_dis_equip
