...
# 敵の位置で演出
    execute at @e[type=#lib:living,tag=Enemy,distance=..30] run particle dust 255 255 255 0.5 ~ ~0.25 ~ 0.025 5 0.025 0 100 force @a
...
# 物理
    ...
    execute as @e[type=#lib:living,tag=Enemy,distance=..30] run function api:damage/
