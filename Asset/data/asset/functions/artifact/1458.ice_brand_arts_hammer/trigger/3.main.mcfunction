...
# 攻撃時演出
    ...
    execute at @e[type=#lib:living_without_player,tag=Victim,distance=..6] run playsound entity.zombie.attack_wooden_door player @a ~ ~ ~ 0.4 0.7

# 引数を set
    data modify storage api: Argument.Damage set value 850f
