...
# 神器の説明文 (TextComponentString[])
    data modify storage asset:artifact Lore set value ['[{"text":"火攻撃+5% ","color":"red"},{"text":"移動速度+5%","color":"white"}]','[{"text":"水攻撃-10%","color":"dark_red"}]','[{"text":"黄昏の輝きを秘めた羽。","color":"gray"}]','[{"text":"淡い茜色の光を放っている。","color":"gray"}]']
