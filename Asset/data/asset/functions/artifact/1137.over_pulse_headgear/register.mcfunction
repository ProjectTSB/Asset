...
# 神器の作成部 ここでID等を定義する
#
# @within function asset:artifact/alias/1137/register

# 神器のID (int) スプレッドシートの値を入れる
    data modify storage asset:artifact ID set value 1137
# 神器のベースアイテム
...
# 神器の説明文 (TextComponentString[])
    data modify storage asset:artifact Lore set value ['{"text":"暗所でよく見えるようになる。"}','{"text":"他部位を装備すると採掘速度が上昇する。"}']
    function asset:artifact/1137.over_pulse_headgear/model_num/
...
# 装備時補正 (Compound[]) (オプション)
    ...
    data modify storage asset:artifact Modifiers append value {Type:"generic.armor",Amount:6d,Operation:"add"}
