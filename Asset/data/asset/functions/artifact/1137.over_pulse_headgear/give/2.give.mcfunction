#> asset:artifact/1137.over_pulse_headgear/give/2.give
#
# 神器の作成部 ここでID等を定義する
#
# @user
# @within function asset:artifact/1137.over_pulse_headgear/give/1.trigger
...
# 神器の発動条件 (TextComponentString) (オプション)
    # data modify storage asset:artifact Condition set value '{"text":"暗所"}'
