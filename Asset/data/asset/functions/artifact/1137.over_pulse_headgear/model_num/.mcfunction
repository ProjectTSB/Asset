#> asset:artifact/1137.over_pulse_headgear/model_num/
#
#
#
# @within function asset:artifact/1137.over_pulse_headgear/register

#> private
# @within function asset:artifact/1137.over_pulse_headgear/model_num/*
...
# ランダムに数値を取得する
    ...
    data modify storage asset:temp VL.scarcity_history_size set value 10
...
# 文字列にする
    ...
    function asset:artifact/1137.over_pulse_headgear/model_num/string.m with storage asset:temp VL
# リセット
