#> asset:artifact/1342.fruit_milk_pack/trigger/3.main
#
# 神器のメイン処理部
#
# @within function asset:artifact/1342.fruit_milk_pack/trigger/2.check_condition
...
# なんと、体力も回復
    data modify storage api: Argument.Heal set value 10
