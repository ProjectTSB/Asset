#> asset:artifact/0899.power_ring/give/2.give
#
# 神器の作成部 ここでID等を定義する
#
# @user
# @within function asset:artifact/0899.power_ring/give/1.trigger
...
# 装備時ステータス補正 ({Type: string, Amount: double, Operation: string, StackReduction?: double}[]) (オプション)
    data modify storage asset:artifact Equipment.Modifiers set value [{Type:"attack/base",Amount:0.03d,Operation:"multiply_base"}]
# 扱える神 (string[]) Wikiを参照
