...
# 神器の生成処理
#
# @within function asset:artifact/alias/1027/register
...
# 神器の説明文 (TextComponentString[])
    data modify storage asset:artifact Lore set value ['{"text":"天の使いから賜ったとされる","color":"gray"}','{"text":"新たな誕生を祝祭し、朽ち逝くものを","color":"gray"}','{"text":"聖火によって灰へと還す不死鳥を象った杖。","color":"gray"}']
...
# 攻撃に関する情報 -Damage量 (literal[]/literal) Wikiを参照 (オプション)
    data modify storage asset:artifact AttackInfo.Damage set value "350×8"
