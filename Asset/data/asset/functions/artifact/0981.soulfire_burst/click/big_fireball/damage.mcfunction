#> asset:artifact/0981.soulfire_burst/click/big_fireball/damage
#
#
#
# @within function asset:artifact/0981.soulfire_burst/click/big_fireball/hit
...
# ダメージ値設定
    #ダメージブレのための処理
        ...
        # 剰余算する。追加ダメージ発生
          scoreboard players operation $RandomDamage Temporary %= $201 Const
        # 最低ダメージ設定
