...
# 他にアイテム等確認する場合はここに書く
#範囲内に敵がいるか確認
    execute anchored eyes positioned ^ ^ ^ positioned ~-1 ~0.5 ~-1 unless entity @e[type=#lib:living_without_player,tag=Enemy,tag=!Uninterferable,dx=1,dy=1,dz=1] run tag @s remove CanUsed
