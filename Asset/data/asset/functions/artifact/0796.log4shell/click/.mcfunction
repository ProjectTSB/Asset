...
# 発射
    execute facing entity @e[type=marker,tag=M4.SpreadMarker,limit=1] feet anchored eyes positioned ^ ^ ^ run function asset:artifact/0796.log4shell/click/3.1.shell
