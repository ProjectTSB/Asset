#> asset:artifact/0320.divine_thunder_sword/attack_melee/3.2.particle_line
#
# 神器のメイン処理部
#
# @within function
#    asset:artifact/0320.divine_thunder_sword/attack_melee/
#    asset:artifact/0320.divine_thunder_sword/attack_melee/3.1.particle
#    asset:artifact/0320.divine_thunder_sword/attack_melee/3.2.particle_line
...
# 線を書く
    ...
    execute if score $Line Temporary matches ..12 rotated ~30 ~ run function asset:artifact/0320.divine_thunder_sword/attack_melee/3.2.particle_line