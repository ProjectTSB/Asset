...
# MP割合が34%以上なら2個目
    execute if score $MPValue Temporary matches 34.. positioned ~ ~1.3 ~ run function asset:artifact/0822.sound_of_a_star/click/4.summon_2nd

# MP割合が67%以上なら3個目
    execute if score $MPValue Temporary matches 67.. positioned ~ ~1.3 ~ run function asset:artifact/0822.sound_of_a_star/click/5.summon_3rd
