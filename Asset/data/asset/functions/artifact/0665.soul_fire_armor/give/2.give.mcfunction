...
# 神器の説明文 (TextComponentString[])
    data modify storage asset:artifact Lore set value ['[{"text":"物理攻撃+2.5% ","color":"dark_green"},{"text":"火耐性+10% 火攻撃+5% ","color":"red"}]','[{"text":"MP回復量+2% ","color":"green"},{"text":"最大体力-2.5%","color":"dark_red"}]','[{"text":"魂炎を完全に纏いし時","color":"#01A7AC"}]','[{"text":"火攻撃+10% ","color":"red"},{"text":"MP回復量+2% ","color":"green"}]','[{"text":"魂炎を纏う者に代償を。","color":"#017C80","italic":true}]','[{"text":"代償背負いし者へ力を。","color":"#017C80","italic":true}]']
