...
# 神器の説明文 (TextComponentString[])
    data modify storage asset:artifact Lore set value ['{"text":"自身と周囲の2名の体力を","color":"white"}','{"text":"自身の最大体力の12%分回復する。","color":"white"}','{"text":"(現在体力割合の最も低いプレイヤーを優先)","color":"white"}','{"text":"かつて空から降ってきた流れ星の一部。","color":"gray"}','{"text":"青空のように澄んだ蒼色をしている。","color":"gray"}']
