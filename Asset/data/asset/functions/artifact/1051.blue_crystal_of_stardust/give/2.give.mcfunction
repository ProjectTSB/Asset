...
# 神器の説明文 (TextComponentString[])
    data modify storage asset:artifact Lore set value ['{"text":"発動時、自身の最大体力の12%分、","color":"white"}','{"text":"自身と周囲のプレイヤーの体力を回復する。","color":"white"}','{"text":"かつて空から降ってきた流れ星の一部。","color":"gray"}','{"text":"青空のように透き通った蒼色をしている。","color":"gray"}']
