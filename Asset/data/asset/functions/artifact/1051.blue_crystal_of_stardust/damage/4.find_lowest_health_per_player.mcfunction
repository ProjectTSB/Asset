#> asset:artifact/1051.blue_crystal_of_stardust/damage/4.find_lowest_health_per_player
#
...
# 一定範囲内のプレイヤーの体力割合をスコアへ代入
    execute as @a[tag=SearchTarget] store result score @s Temporary run function asset:artifact/1051.blue_crystal_of_stardust/damage/5.get_health_per
