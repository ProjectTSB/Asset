#> asset:artifact/1111.rod_o_redeem/click/
#
# 神器のトリガー処理
#
# @within function asset:artifact/alias/1111/click/


# 演出
    execute rotated ~ 0 positioned ~ ~0.3 ~ run function asset:artifact/1111.rod_o_redeem/click/vfx
    execute rotated ~90 30 positioned ~ ~0.8 ~ run function asset:artifact/1111.rod_o_redeem/click/vfx2
    execute rotated ~90 -30 positioned ~ ~0.8 ~ run function asset:artifact/1111.rod_o_redeem/click/vfx2
