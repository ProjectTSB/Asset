#> asset:artifact/0985.ark_of_the_sanctuary/click/slash/slash2
#
#
#
# @within function asset:artifact/0985.ark_of_the_sanctuary/click/**
...
# アニメーション開始
    execute unless entity @e[type=armor_stand,tag=RD.SlashSweep,distance=..100,limit=1] run function asset:artifact/0985.ark_of_the_sanctuary/click/slash/slash_schedule
    execute if entity @e[type=armor_stand,tag=RD.SlashSweep,distance=..100,limit=1] run schedule function asset:artifact/0985.ark_of_the_sanctuary/click/slash/slash_schedule 1t