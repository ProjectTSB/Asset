#> asset:artifact/0985.ark_of_the_sanctuary/click/sword/sword
#
#
#
# @within function asset:artifact/0985.ark_of_the_sanctuary/click/sword/schedule
...
# 2tickおきに実行
    ...
    execute if score $2tInterval Temporary matches 0 run function asset:artifact/0985.ark_of_the_sanctuary/click/sword/damage
# リセット
