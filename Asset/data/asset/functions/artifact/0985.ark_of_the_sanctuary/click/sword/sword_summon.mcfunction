...
#
#
# @within function asset:artifact/0985.ark_of_the_sanctuary/click/skill/skill?
...
# スケジュール開始
    schedule function asset:artifact/0985.ark_of_the_sanctuary/click/sword/schedule 1t