#> asset:artifact/0985.ark_of_the_sanctuary/click/sword/damage
#
#
#
# @within function asset:artifact/0985.ark_of_the_sanctuary/click/sword/sword
...
# ダメージを与える
    # 与えるダメージ
        data modify storage api: Argument.Damage set value 115f
    # 属性
