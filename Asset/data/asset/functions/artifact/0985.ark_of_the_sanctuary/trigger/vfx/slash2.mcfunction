#> asset:artifact/0985.ark_of_the_sanctuary/trigger/vfx/slash2
#
#
#
...
# 斬撃
    ...
    data modify storage api: Argument.FieldOverride set value {Item:{id:"minecraft:potion"},Frames:[20242,20243,20244],Scale:[4f,4f,0.1f],Transformation:{left_rotation:[-0.213f,-0.674f,-0.627f,0.327f],right_rotation:[0f,0f,0f,1f],translation:[0f,0f,0f]}}
