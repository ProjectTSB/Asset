#> asset:artifact/1078.pigeon_blood/attack_melee/resonance_attack/6.shot_recursive
#
# 射撃の再帰処理
#
# @within function
...
# 再帰
    execute if entity @s[tag=!Landing] positioned ^ ^ ^0.6 if entity @s[distance=..15] if block ^ ^ ^ #lib:no_collision run function asset:artifact/1078.pigeon_blood/attack_melee/resonance_attack/6.shot_recursive
