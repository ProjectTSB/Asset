...
# 共鳴攻撃用entityのメイン処理部
#
# @within function asset:artifact/1078.pigeon_blood/attack_melee/resonance_attack/3.loop
...
# 射撃する 2,3回目で異なる位置で実行する
    ...
    execute if entity @s[scores={TY.Tick=1}] run function asset:artifact/1078.pigeon_blood/attack_melee/resonance_attack/5.shot
    execute if entity @s[scores={TY.Tick=6}] at @p[tag=Owner] run tp @s ^1.2 ^3.5 ^0.4
    execute if entity @s[scores={TY.Tick=6}] at @s run function asset:artifact/1078.pigeon_blood/attack_melee/resonance_attack/5.shot
    execute if entity @s[scores={TY.Tick=11}] at @p[tag=Owner] run tp @s ^-1.2 ^3.5 ^0.4
    execute if entity @s[scores={TY.Tick=11}] at @s run function asset:artifact/1078.pigeon_blood/attack_melee/resonance_attack/5.shot
