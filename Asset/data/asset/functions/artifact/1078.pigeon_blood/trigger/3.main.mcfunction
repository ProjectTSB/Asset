...
# 確率でダメージ上昇、共鳴時にダメージ上昇
    ...
    execute if predicate lib:random_pass_per/20 store result storage api: Argument.Damage double 1.5 run data modify storage api: Argument.Damage set value 1
