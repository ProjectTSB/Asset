...
# entityのInit処理
    execute as @e[type=marker,tag=Init,tag=TY.AttackEntity,distance=..10] run function asset:artifact/1078.pigeon_blood/trigger/resonance_attack/2.entity_init
