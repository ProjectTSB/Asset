#> asset:artifact/1078.pigeon_blood/trigger/resonance_attack/3.loop
#
# ループさせる
#
# @within function
...
# 実行
    execute as @e[type=marker,tag=TY.AttackEntity] at @s run function asset:artifact/1078.pigeon_blood/trigger/resonance_attack/4.main