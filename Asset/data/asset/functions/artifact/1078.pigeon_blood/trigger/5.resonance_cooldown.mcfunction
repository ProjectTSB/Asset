...
# 差分を計算
    scoreboard players operation $TY.Cooldown Temporary -= @s TY.ResonanceCooldown
...
# 成功時にその時のtickを保存
    execute if score $TY.Cooldown Temporary matches 20.. store result score @s TY.ResonanceCooldown run time query gametime