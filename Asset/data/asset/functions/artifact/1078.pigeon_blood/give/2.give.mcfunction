...
# 神器の説明文 (TextComponentString[])
    data modify storage asset:artifact Lore set value ['{"translate":"- 使用時、%2$s%1$s%2$sを得る。","with":[{"translate":"[共鳴・%s]","color":"#ffdd66","with":[{"text":"紅","color":"#ffbfd4"}]},{"text":"\\u0002","font":"space"}]}','{"translate":"- %2$s%1$sの確率で、ダメージが%1$s%3$s%1$s増加する。","with":[{"text":"\\u0002","font":"space"},{"text":"20%","color":"aqua"},{"text":"50%","color":"aqua"}]}','{"translate":"- 自身か周囲20mのプレイヤーに%2$s%1$s%2$sがあれば、","with":[{"translate":"[共鳴・%s]","color":"#ffdd66","with":[{"text":"蒼","color":"#a1faf5"}]},{"text":"\\u0002","font":"space"}]}','{"translate":"\\uE003\\uF006 ダメージが%1$s%2$s%1$s増加する。","with":[{"text":"\\u0002","font":"space"},{"text":"20%","color":"aqua"}]}','{"text":"- 自身を除く周囲20mのプレイヤーに"}','{"translate":"\\uE003\\uF006 %1$sがあれば追撃が発生する。","with":[{"translate":"[共鳴・%s]","color":"#ffdd66","with":[{"text":"蒼","color":"#a1faf5"}]}]}','{"text":"深き血の如き光を放つ、紅き少女の力の結晶。","color":"gray"}','{"text":"主の心の赴くまま、気まぐれに敵を斬り裂く。","color":"gray"}']
