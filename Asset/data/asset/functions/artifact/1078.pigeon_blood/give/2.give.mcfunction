...
# 神器の説明文 (TextComponentString[])
    data modify storage asset:artifact Lore set value ['[{"text":"使用時、斬撃を放ち、共鳴・","color":"white"},{"text":"紅","color":"#ffbfd4"},{"text":"効果を得る。","color":"white"}]','{"text":"自身または周囲のプレイヤーが","color":"white"}','[{"text":"共鳴・","color":"white"},{"text":"蒼","color":"#a1faf5"},{"text":"効果を持つなら性能が強化される。","color":"white"}]','{"text":"深き血の如き光を放つ、紅き少女の力の結晶。","color":"gray"}','{"text":"主の心の赴くまま、気まぐれに敵を斬り裂く。","color":"gray"}']
...
# 攻撃に関する情報 -Damage量 (literal[]/literal) Wikiを参照 (オプション)
    data modify storage asset:artifact AttackInfo.Damage set value [550-650]
