...
# 装備を外した時のメイン処理
#
# @within function asset:artifact/0557.catastrophe/equip/dis_equip/
...
# ノクバ耐性+2
    attribute @s generic.knockback_resistance modifier remove 00000001-0000-0001-0000-022d00000003
