#> asset:artifact/0606.traffic_sign/give/2.give
#
# 神器の作成部 ここでID等を定義する
#
# @user
# @within function asset:artifact/0606.traffic_sign/give/1.trigger
...
# 神器の説明文 (TextComponentString[])
    data modify storage asset:artifact Lore set value ['{"text":"どこにでもありそうな交通標識","color":"white"}','{"text":"とても手に馴染んで振り回しやすい","color":"white"}','{"text":"ちなみに地面にぶっ刺すこともできる","color":"white"}','{"text":"「うわっ、前から車が！！」","color":"gray"}']
