...
# 若干斜めにする
    execute store result entity @e[type=item_display,tag=GU.Sign.Init,distance=..0.01,limit=1] Rotation[0] float 1 run random value 0..359
    execute store result score $GU.Temp Temporary run random value 0..65535
