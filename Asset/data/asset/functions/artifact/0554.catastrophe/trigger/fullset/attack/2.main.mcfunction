#> asset:artifact/0554.catastrophe/trigger/fullset/attack/2.main
#
# フルセット時の攻撃のメイン処理
#
...
# 前回効果発動時の時間との差からクールダウン中かどうかを判定する
    ...
    execute if score $FE.Cooldown Temporary matches 20.. run function asset:artifact/0554.catastrophe/trigger/fullset/attack/3.damage
...
# 与ダメージ1000毎(10倍で記録)にバフを得る
    ...
    execute if entity @s[scores={FE.DamageSum=10000..}] run function asset:artifact/0554.catastrophe/trigger/fullset/attack/4.give_buff
