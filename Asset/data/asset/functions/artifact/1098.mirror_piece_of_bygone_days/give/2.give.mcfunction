...
# 神器の説明文 (TextComponentString[])
    data modify storage asset:artifact Lore set value ['[{"text":"デバフ"},{"text":"[弱]","color":"#FFDD66"},{"text":"を全て解除し"}]','{"text":"最大体力+16%を15秒間得る。"}','{"text":"過去に砕け散った手鏡。","color":"gray"}','{"text":"割れた今でも過ぎ去った日々の風景を映している。","color":"gray"}']
...
# 神器のクールダウン (int) (オプション)
    data modify storage asset:artifact LocalCooldown set value 250
