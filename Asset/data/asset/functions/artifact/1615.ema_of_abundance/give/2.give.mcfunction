#> asset:artifact/1615.ema_of_abundance/give/2.give
#
# 神器の作成部 ここでID等を定義する
#
# @user
# @within function asset:artifact/1615.ema_of_abundance/give/1.trigger

# 神器の説明や消費MPなどをここで設定する。
# 最後にasset:artifact/common/giveを実行することで入手可能。

# 神器のID (int) スプレッドシートの値を入れる
    data modify storage asset:artifact ID set value 1615
# 神器のベースアイテム
    data modify storage asset:artifact Item set value "minecraft:stick"
# 神器の名前 (TextComponentString)
    data modify storage asset:artifact Name set value '{"text":"豊穣の絵馬","color":"#C6FF87"}'
# 神器の説明文 (TextComponentString[])
    data modify storage asset:artifact Lore set value ['{"text":"敵から攻撃を受けたとき、たまにお腹が減ってしまう"}','{"text":"飢饉が起こるたび、村人たちは祈るしかなかった","color":"gray","italic":true}','{"text":"...神は稲を育むことも枯らすこともできる","color":"gray","italic":true}']
...
# 装備時ステータス補正 ({Type: string, Amount: double, Operation: string, StackReduction?: double}[]) (オプション)
    ...
    data modify storage asset:artifact Equipment.Modifiers append value {Type:"max_mp",Amount:0.05d,Operation:"multiply_base"}
