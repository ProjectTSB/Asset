#> asset:artifact/1221.hardened_leather_armor/trigger/3.main
#
# 神器のメイン処理部
#
# @within function asset:artifact/1221.hardened_leather_armor/trigger/2.check_condition
...
# 頭
    data modify storage api: Argument.ID set value 1231
...
# 胴
    data modify storage api: Argument.ID set value 1232
...
# 脚
    data modify storage api: Argument.ID set value 1233
...
# 足
    data modify storage api: Argument.ID set value 1234
