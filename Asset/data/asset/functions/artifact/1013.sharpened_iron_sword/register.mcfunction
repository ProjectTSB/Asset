#> asset:artifact/1013.sharpened_iron_sword/register
#
# 神器の生成処理
#
# @within function asset:artifact/alias/1013/register
...
# 攻撃に関する情報 -Damage量 (literal[]/literal) Wikiを参照 (オプション)
    data modify storage asset:artifact AttackInfo.Damage set value [36]
