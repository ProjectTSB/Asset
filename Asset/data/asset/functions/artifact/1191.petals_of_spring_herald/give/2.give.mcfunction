#> asset:artifact/1191.petals_of_spring_herald/give/2.give
#
# 神器の作成部 ここでID等を定義する
#
# @user
# @within function asset:artifact/1191.petals_of_spring_herald/give/1.trigger

# 神器の説明や消費MPなどをここで設定する。
# 最後にasset:artifact/common/giveを実行することで入手可能。

# 神器のID (int) スプレッドシートの値を入れる
    data modify storage asset:artifact ID set value 1191
# 神器のベースアイテム
    data modify storage asset:artifact Item set value "minecraft:stick"
# 神器の名前 (TextComponentString)
    data modify storage asset:artifact Name set value '{"text":"春を告げる花びら","color":"#FFCCFC"}'
# 神器の説明文 (TextComponentString[])
    data modify storage asset:artifact Lore set value ['{"text":"最大体力を超えて回復した対象に","color":"white"}','{"text":"超えた回復量の100%分のバリアを付与する(最大20)","color":"white"}','{"text":"春ですよー","color":"gray"}']
...
# 神器の発動条件 (TextComponentString) (オプション)
    data modify storage asset:artifact Condition set value '{"text":"最大体力を超える回復を与える"}'
