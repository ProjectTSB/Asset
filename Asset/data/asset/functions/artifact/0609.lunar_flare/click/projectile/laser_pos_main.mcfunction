...
# 次tickも実行
    execute if entity @e[type=marker,tag=GX.LaserPos,scores={GX.BeamTime=1..},limit=1] run schedule function asset:artifact/0609.lunar_flare/click/projectile/laser_pos_main 1t replace