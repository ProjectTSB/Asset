...
# 神器の生成処理
#
# @within function asset:artifact/alias/930/register
...
# 装備時補正 (Component[]) (オプション)
    ...
    data modify storage asset:artifact Modifiers append value {Type:"attack/base",Amount:0.25d,Operation:"multiply_base"}
    data modify storage asset:artifact Modifiers append value {Type:"defense/base",Amount:-0.35d,Operation:"multiply_base"}
# 扱える神 (string[]) Wikiを参照
