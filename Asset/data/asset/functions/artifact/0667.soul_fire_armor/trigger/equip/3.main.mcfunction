#> asset:artifact/0667.soul_fire_armor/trigger/equip/3.main
#
# 神器のメイン処理部
#
# @within function asset:artifact/0667.soul_fire_armor/trigger/equip/2.check_condition
...
# 演出
    execute unless data storage api: Return.Effect{Stack:4} positioned ~ ~0.2 ~ run function asset:artifact/0664.soul_fire_armor/trigger/equip/4.particle
