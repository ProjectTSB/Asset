#> asset:artifact/0001.book_of_all-seeing/click/print_defense_messages
#
# 実行者の情報を表示
#
# @within function asset:artifact/0001.book_of_all-seeing/click/
...
# 物理と魔法
    # 物理耐性取得
        ...
        function asset:artifact/0001.book_of_all-seeing/click/get_defense_info
