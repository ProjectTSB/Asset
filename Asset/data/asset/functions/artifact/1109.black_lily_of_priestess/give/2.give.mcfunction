...
# 神器の説明文 (TextComponentString[])
    data modify storage asset:artifact Lore set value ['{"text":"自身に付与されたデバフ1つにつき"}','[{"text":"攻撃+2.5%","color":"green"},{"text":"、","color":"white"},{"text":"被回復量-5%","color":"red"},{"text":"を10秒間得る","color":"white"}]','{"text":"(それぞれ最大10%、20%)"}','{"text":"穢れに染まってしまった黒い花","color":"gray"}','{"text":"穢れに染まってしまった黒い花","color":"gray"}']
