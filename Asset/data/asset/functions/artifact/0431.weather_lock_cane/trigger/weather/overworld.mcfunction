...
execute if data storage asset:temp BZ{Weather:"Sunny"} run tellraw @s [{"text": "火属性の与ダメージ","color": "red"},{"text": "が40%上がった！","color": "white"}]
...
execute if data storage asset:temp BZ{Weather:"Rain"} run tellraw @s [{"text": "水属性の与ダメージ","color": "aqua"},{"text": "が40%上がった！","color": "white"}]
...
execute if data storage asset:temp BZ{Weather:"Thunder"} run tellraw @s [{"text": "雷属性の与ダメージ","color": "yellow"},{"text": "が40%上がった！","color": "white"}]
