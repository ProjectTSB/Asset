...
execute if data storage asset:temp BZ{Weather:"Sunny"} run tellraw @s [{"text": "火属性与ダメージ","color": "red"},{"text": "が40%上昇した！","color": "white"}]
...
execute if data storage asset:temp BZ{Weather:"Rain"} run tellraw @s [{"text": "水属性与ダメージ","color": "aqua"},{"text": "が40%上昇した！","color": "white"}]
...
execute if data storage asset:temp BZ{Weather:"Thunder"} run tellraw @s [{"text": "雷属性与ダメージ","color": "yellow"},{"text": "が40%上昇した！","color": "white"}]
