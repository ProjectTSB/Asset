#> asset:artifact/0431.weather_lock_cane/click/weather/another
#
#
#
...
tellraw @s [{"text":"火・水・雷属性与ダメージ","color":"light_purple"},{"text":"が15%上昇した！","color":"white"}]
function api:entity/mob/effect/give
function api:entity/mob/effect/reset
execute rotated ~ 0 positioned ~ ~0.2 ~ run function asset:artifact/0431.weather_lock_cane/click/vfx/another
