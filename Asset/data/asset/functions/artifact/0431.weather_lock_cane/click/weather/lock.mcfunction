...
# プレイヤーにエフェクトを付ける
    execute if data storage asset:temp BZ as @a at @s run function asset:artifact/0431.weather_lock_cane/click/weather/
# ループする
    execute if data storage asset:temp BZ run schedule function asset:artifact/0431.weather_lock_cane/click/weather/lock 1t replace
