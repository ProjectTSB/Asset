...
# 攻撃をさせる
    execute as @e[type=cod,tag=GY.Fish,scores={GY.FishCool=20}] at @s if entity @e[tag=Enemy,distance=..10] run function asset:artifact/0610.call_fish/trigger/3.2.attack
