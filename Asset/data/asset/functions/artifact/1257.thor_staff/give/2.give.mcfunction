#> asset:artifact/1257.thor_staff/give/2.give
#
# 神器の作成部 ここでID等を定義する
#
# @user
# @within function asset:artifact/1257.thor_staff/give/1.trigger

# 神器の説明や消費MPなどをここで設定する。
# 最後にasset:artifact/common/giveを実行することで入手可能。

# 神器のID (int) スプレッドシートの値を入れる
    data modify storage asset:artifact ID set value 1257
# 神器のベースアイテム
    data modify storage asset:artifact Item set value "minecraft:carrot_on_a_stick"
# 神器の名前 (TextComponentString)
    data modify storage asset:artifact Name set value '{"text":"雷鎚の戦杖","color":"#FFD857"}'
# 神器の説明文 (TextComponentString[])
    data modify storage asset:artifact Lore set value ['{"text":"視点先へ鉄槌の雷を5本降らせダメージを与える","color":"white"}','{"text":"強烈な雷を呼び出す杖","color":"gray"}','{"text":"かの雷神の如き力を秘めている","color":"gray"}']
