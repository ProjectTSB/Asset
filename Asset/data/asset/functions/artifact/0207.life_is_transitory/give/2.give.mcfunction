...
# 神器の説明文 (TextComponentString[])
    data modify storage asset:artifact Lore set value ['{"text":"体力が大幅に減少するが、"}','{"text":"周囲から姿が見えなくなり、敵に見つかりにくくなる"}']
...
# 装備時効果 ({ID: int, Visible: boolean}[]) (オプション)
    data modify storage asset:artifact Equipment.Effects set value [{ID:297,Visible:false}]
# 扱える神 (string[]) Wikiを参照
