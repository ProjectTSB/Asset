#> asset:artifact/0266.angel_ray_lv.5/click/effect/
#
#
#
# @within function asset:artifact/0266.angel_ray_lv.5/click/
...
# 対象探索
    function asset:artifact/0266.angel_ray_lv.5/click/effect/find_target
# 自身を対象から外す
