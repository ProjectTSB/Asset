...
# 命中判定を行うためのscheduleをセットする
    schedule function asset:artifact/1045.mini_black_hole/click/schedule/1.tick 1t replace
...
# 演出
    execute anchored eyes positioned ^ ^ ^0.5 run function asset:artifact/1045.mini_black_hole/click/3.1.vfx
