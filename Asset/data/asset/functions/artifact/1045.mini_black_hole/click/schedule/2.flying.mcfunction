#> asset:artifact/1045.mini_black_hole/click/schedule/2.flying
#
# 飛翔時処理
#
...
# 演出
    execute at @s run function asset:artifact/1045.mini_black_hole/click/schedule/2.1.flying_vfx
