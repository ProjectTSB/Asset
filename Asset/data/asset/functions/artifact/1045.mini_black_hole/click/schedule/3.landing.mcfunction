#> asset:artifact/1045.mini_black_hole/click/schedule/3.landing
#
# 着弾後処理
#
# @within function asset:artifact/1045.mini_black_hole/click/schedule/1.tick
...
# ダメージ付与
    ...
    # ダメージ
        ...
        execute as @e[tag=Enemy,tag=T1.Landing,tag=!Uninterferable,distance=..8] run function lib:damage/

# 敵吸い込み
    execute at @s as @e[tag=Enemy,tag=!Enemy.Boss,tag=!Uninterferable,distance=..15] run function asset:artifact/1045.mini_black_hole/click/schedule/4.enemy_suction
