...
# 着弾検知
    execute positioned ~-0.5 ~-0.5 ~-0.5 if entity @e[type=#lib:living,tag=Enemy,dx=0,sort=nearest,limit=1] run tag @e[type=#lib:living,tag=Enemy,dx=0,sort=nearest,limit=1] add CZ.HitEntity
