...
# 暫くダメージを受けていないならバリア作動
    execute unless score @s VM.Tick matches 1.. if entity @s[tag=!VM.NotDamaged,tag=VM.Equipped] run function asset:artifact/1138.over_pulse_bodyarmor/tick/absorption
