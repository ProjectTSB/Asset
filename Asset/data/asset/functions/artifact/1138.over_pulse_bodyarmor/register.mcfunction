#> asset:artifact/1138.over_pulse_bodyarmor/register
#
# 神器の作成部 ここでID等を定義する
#
# @within function asset:artifact/alias/1138/register
...
# 神器の説明文 (TextComponentString[])
    data modify storage asset:artifact Lore set value ['{"text":"暫くダメージを受けていない場合、"}','{"text":"衝撃を吸収する電磁バリアを生成する。"}','{"text":"他部位を装備するとバリアはより強固になる。"}','{"text":"─ 電磁バリア 展開。","color":"gray","italic":true}','{"text":"─ 魔術干渉ニ 注意シテクダサイ。","color":"gray","italic":true}']
...
# 神器のサブトリガー (string[]) (オプション)
    data modify storage asset:artifact SubTriggers set value ["tick","equip","damage"]
...
# セット装備のID (int) (オプション)
    data modify storage asset:artifact EquipID set value 274
# 装備時補正 (Compound[]) (オプション)
    data modify storage asset:artifact Modifiers set value []
    data modify storage asset:artifact Modifiers append value {Type:"generic.armor",Amount:10d,Operation:"add"}
    data modify storage asset:artifact Modifiers append value {Type:"generic.armor_toughness",Amount:2.5d,Operation:"add"}
