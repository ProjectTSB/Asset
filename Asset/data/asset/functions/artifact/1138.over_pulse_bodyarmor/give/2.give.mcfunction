...
# 神器の説明文 (TextComponentString[])
    data modify storage asset:artifact Lore set value ['{"text":"暫くダメージを受けていない場合、"}','{"translate":"衝撃を吸収する電磁バリアを現在体力の %s 分生成する。","with":[{"text":"2.5%","color":"aqua"}]}','{"translate":"他部位を装備するとその数だけバリアの生成量が %s 増加する。","with":[{"text":"100%","color":"aqua"}]}','{"text":"─ 電磁バリア 展開。","color":"gray","italic":true}','{"text":"─ 魔術干渉ニ 注意シテクダサイ。","color":"gray","italic":true}']
