#> asset:artifact/0573.final_prism/keep_sneak/laser
#
# レーザー
#
...
# 前進
    execute if entity @s[distance=..45] if block ~ ~ ~ #lib:no_collision positioned ^ ^ ^0.5 run function asset:artifact/0573.final_prism/keep_sneak/laser
