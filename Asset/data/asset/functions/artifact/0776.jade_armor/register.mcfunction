#> asset:artifact/0776.jade_armor/register
#
# 神器の生成処理
#
# @within function asset:artifact/alias/776/register
...
# 装備時補正 (Compound[]) (オプション)
    ...
    data modify storage asset:artifact Modifiers append value {Type:"attack/water",Amount:0.04d,Operation:"multiply_base"}
    ...
    data modify storage asset:artifact Modifiers append value {Type:"mp_regen",Amount:0.04d,Operation:"multiply_base"}
# 扱える神 (string[]) Wikiを参照
