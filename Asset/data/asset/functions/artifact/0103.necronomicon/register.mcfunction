...
# 神器の生成処理
#
# @within function asset:artifact/alias/103/register
...
# 攻撃に関する情報 -Damage量 (literal[]/literal) Wikiを参照 (オプション)
    data modify storage asset:artifact AttackInfo.Damage set value [750]
...
# MP消費量 (int)
    data modify storage asset:artifact MPCost set value 270
# MP必要量 (int) (オプション)
