#> asset:artifact/0702.bright_lamp/tick/vfx
#
#
#
# @within function
...
# 一周するまで再帰
    execute if score $RecursiveLimit Temporary matches ..17 rotated ~20 ~ run function asset:artifact/0702.bright_lamp/tick/vfx