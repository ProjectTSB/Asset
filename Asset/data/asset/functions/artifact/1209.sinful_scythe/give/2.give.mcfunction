#> asset:artifact/1209.sinful_scythe/give/2.give
#
# 神器の作成部 ここでID等を定義する
#
# @user
# @within function asset:artifact/1209.sinful_scythe/give/1.trigger

# 神器の説明や消費MPなどをここで設定する。
# 最後にasset:artifact/common/giveを実行することで入手可能。

# 神器のID (int) スプレッドシートの値を入れる
    data modify storage asset:artifact ID set value 1209
# 神器のベースアイテム
    data modify storage asset:artifact Item set value "minecraft:stick"
# 神器の名前 (TextComponentString)
    data modify storage asset:artifact Name set value '{"text":"罪深き鎌","color":"#FFFFFF"}'
# 神器の説明文 (TextComponentString[])
    data modify storage asset:artifact Lore set value ['{"text":"相手に罪を与える"}','{"text":"周囲のモブが2体にも同様に罪を与える"}','{"text":"周囲にモブがいない場合、同じ相手に罪を重ねる"}']
