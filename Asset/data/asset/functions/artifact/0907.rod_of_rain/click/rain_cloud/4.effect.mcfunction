#> asset:artifact/0907.rod_of_rain/click/rain_cloud/4.effect
#
# 雨のダメージ処理と回復処理
#
# @within function asset:artifact/0907.rod_of_rain/click/rain_cloud/2.main
...
# 演出
    ...
    execute positioned ~ ~0.25 ~ run function asset:artifact/0907.rod_of_rain/click/rain_cloud/5.effect_vfx
    execute positioned ~ ~0.8 ~ run function asset:artifact/0907.rod_of_rain/click/rain_cloud/5.effect_vfx
