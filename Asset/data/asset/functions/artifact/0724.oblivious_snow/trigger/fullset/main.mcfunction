...
# 演出
    particle snowflake ~ ~4 ~ 1.8 0.25 1.8 0.0 2 normal @a[distance=..16]
    execute if predicate lib:random_pass_per/30 run particle snowflake ~ ~0.3 ~ 1.5 0.1 1.5 0.1 1 normal @a[distance=..16]
