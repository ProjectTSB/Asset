#> asset:artifact/0724.oblivious_snow/equip/fullset/equip
#
# フルセット時の処理
#
# @within function
#   asset:artifact/0724.oblivious_snow/equip/
#   asset:artifact/0725.oblivious_snow/equip/
...
# ループ開始
    schedule function asset:artifact/0724.oblivious_snow/equip/fullset/loop 1t replace
