#> asset:artifact/0641.spirit_garment/register
#
# 神器の生成処理
#
# @within function asset:artifact/alias/641/register
...
# 装備時補正 (Compound[]) (オプション)
    ...
    data modify storage asset:artifact Modifiers append value {Type:"max_health",Amount:8d,Operation:"add"}
