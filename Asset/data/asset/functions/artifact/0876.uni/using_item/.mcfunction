...
# 神器のトリガー処理
#
# @within function asset:artifact/alias/876/using_item/
...
# 発砲
    execute anchored eyes positioned ^-0.35 ^-0.15 ^ facing entity @e[type=marker,tag=SpreadMarker,limit=1] feet run function asset:artifact/0876.uni/using_item/bullet
