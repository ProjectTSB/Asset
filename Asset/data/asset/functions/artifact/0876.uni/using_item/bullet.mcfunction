...
# 着弾
    execute if entity @s[tag=Landing] run function asset:artifact/0876.uni/using_item/hit

# 再起
    execute positioned ^ ^ ^0.5 if entity @s[tag=!Landing,distance=..10] run function asset:artifact/0876.uni/using_item/bullet
