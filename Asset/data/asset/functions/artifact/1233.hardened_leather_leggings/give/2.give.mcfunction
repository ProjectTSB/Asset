#> asset:artifact/1233.hardened_leather_leggings/give/2.give
#
# 神器の作成部 ここでID等を定義する
#
# @user
# @within function asset:artifact/1233.hardened_leather_leggings/give/1.trigger

# 神器の説明や消費MPなどをここで設定する。
# 最後にasset:artifact/common/giveを実行することで入手可能。

# 神器のID (int) スプレッドシートの値を入れる
    data modify storage asset:artifact ID set value 1233
# 神器のベースアイテム
    data modify storage asset:artifact Item set value "minecraft:leather_leggings"
# 神器の名前 (TextComponentString)
    data modify storage asset:artifact Name set value "硬化革のズボン"
...
# 装備時ステータス補正 (Compound[]) (オプション)
    data modify storage asset:artifact Equipment.Modifiers set value [{Type:"generic.armor",Amount:2.5d,Operation:"add"}]
# 扱える神 (string[]) Wikiを参照
