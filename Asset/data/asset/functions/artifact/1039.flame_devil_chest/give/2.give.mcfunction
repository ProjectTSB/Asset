...
# 神器の説明文 (TextComponentString[])
    data modify storage asset:artifact Lore set value ['[{"text":"炎魔","color":"#C71585"},{"text":"の力が全て揃いし時、痛みを力に変えられるだろう","color":"#FF7F50"}]','[{"text":"火攻撃+10% ","color":"red"},{"text":"水攻撃-7.5% ","color":"dark_red"}]','[{"text":"魔法攻撃+5%","color":"dark_purple"},{"text":" MP回復量+2%","color":"green"}]','[{"text":"「憎いのだろう？ アイツのことが」","color":"#C71585","italic":true}]']
