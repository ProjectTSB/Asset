...
# 神器の説明文 (TextComponentString[])
    data modify storage asset:artifact Lore set value ['{"translate":"-%1$s攻撃時にチャージされ、ダメージが上昇する(最大%2$s段階)","with":[{"text":"\\u0002","font":"space"},{"text":"10"}]}','[{"translate":"-%1$sクリティカル攻撃時にチャージを全消費し範囲攻撃を行う","with":[{"text":"\\u0002","font":"space"}]}]','[{"translate":"%1$s最大チャージ時、敵の耐性を無視する","color":"gray","with":[{"text":"\\u0008","font":"space"}]}]','[{"translate":"-%1$s被ダメージでチャージがリセットされ、","color":"white","with":[{"text":"\\u0002","font":"space"}]}]','[{"translate":"%1$s%2$sのダメージを受ける","color":"white","with":[{"text":"\\u0008","font":"space"},{"text":"(最大体力の10% × チャージ数)","color":"red"}]}]']
