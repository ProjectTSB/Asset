#> asset:artifact/1324.balance_star/trigger/vfx/recursive
#
#
#
# @within function
...
# 再帰
    execute if entity @s[distance=..40] positioned ^ ^ ^1 run function asset:artifact/1324.balance_star/trigger/vfx/recursive
