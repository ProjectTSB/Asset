#> asset:artifact/1324.balance_star/trigger/find_target
#
#
#
...
# 各プレイヤーの現在MPをスコアへ代入
    execute as @a[tag=10S.SearchTarget] store result score @s Temporary run function asset:artifact/1324.balance_star/trigger/get_mp
