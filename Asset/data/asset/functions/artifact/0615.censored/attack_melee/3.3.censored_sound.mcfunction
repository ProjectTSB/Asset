#> asset:artifact/0615.censored/attack_melee/3.3.censored_sound
#
# ピー音を鳴らす処理
#
...
# 再帰
    execute if entity @e[type=area_effect_cloud,tag=H3.CensoredSound,limit=1] run schedule function asset:artifact/0615.censored/attack_melee/3.3.censored_sound 1t