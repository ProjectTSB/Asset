#> asset:artifact/0615.censored/trigger/execution/execution_boss
#
# ボス級の処刑
#
...
# 演出
    execute as @e[type=#lib:living,tag=Victim,distance=..0.01,limit=1] anchored eyes positioned ^ ^ ^ run function asset:artifact/0615.censored/trigger/object_summon
