#> asset:artifact/0737.summer_festival_of_remembrance/click/firework_process/summon/append_color
#
...
# $ColorCountが1以上でかつ $RecursiveCount = $ColorCountになるまで再帰
    execute if score $ColorCount Temporary matches 1.. unless score $RecursiveCount Temporary = $ColorCount Temporary run function asset:artifact/0737.summer_festival_of_remembrance/click/firework_process/summon/append_color