#> asset:artifact/0737.summer_festival_of_remembrance/click/firework_process/core/main
#
# 花火のコアのメイン処理
#
# @within function asset:artifact/0737.summer_festival_of_remembrance/click/firework_process/core/loop
...
# 一定間隔で花火召喚のためのランダムな位置にマーカーを配置する
    ...
    execute if score $Temp Temporary matches 0 run function asset:artifact/0737.summer_festival_of_remembrance/click/firework_process/core/spread
