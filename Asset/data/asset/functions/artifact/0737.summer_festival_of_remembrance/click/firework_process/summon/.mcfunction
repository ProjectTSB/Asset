#> asset:artifact/0737.summer_festival_of_remembrance/click/firework_process/summon/
#
# 花火を召喚する
#
# @within function asset:artifact/0737.summer_festival_of_remembrance/click/firework_process/core/spread
...
# storageに色のデータを突っ込む
    function asset:artifact/0737.summer_festival_of_remembrance/click/firework_process/summon/append_color

# データ適用
    execute as @e[type=firework_rocket,tag=FireworkInit,distance=..1,limit=1] run function asset:artifact/0737.summer_festival_of_remembrance/click/firework_process/summon/set_data
