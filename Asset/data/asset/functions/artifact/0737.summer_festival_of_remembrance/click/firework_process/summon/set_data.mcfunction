#> asset:artifact/0737.summer_festival_of_remembrance/click/firework_process/summon/set_data
#
# storageに入れたデータを適用する
#
# @within function asset:artifact/0737.summer_festival_of_remembrance/click/firework_process/summon/
