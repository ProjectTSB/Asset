#> asset:artifact/1080.allochromatic_empty/sneak_1s/
#
# 神器のトリガー処理
#
# @within function asset:artifact/alias/1080/sneak_1s/
...
# give
    ...
    data modify storage api: Argument.Slot set from storage asset:context Slot
