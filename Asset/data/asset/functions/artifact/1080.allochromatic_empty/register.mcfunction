#> asset:artifact/1080.allochromatic_empty/register
#
# 神器の生成処理
#
# @within function asset:artifact/alias/1080/register
...
# 神器のトリガー (string) Wikiを参照
    data modify storage asset:artifact Trigger set value "sneak_1s"
