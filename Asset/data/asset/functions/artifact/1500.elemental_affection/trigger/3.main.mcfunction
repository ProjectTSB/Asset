...
# ここから先は神器側の効果の処理を書く
    ...
    execute if data storage asset:context Damage run function api:entity/mob/effect/give
    execute if data storage asset:context Damage run function api:entity/mob/effect/reset
