#> asset:artifact/0917.flame_hunter_clothes/equip/
#
# 神器のトリガー処理
#
# @within function asset:artifact/alias/917/equip/


# 演出
    execute unless data storage asset:context id.all{head:915,chest:916,legs:917,feet:918} run function asset:artifact/0917.flame_hunter_clothes/equip/vfx
