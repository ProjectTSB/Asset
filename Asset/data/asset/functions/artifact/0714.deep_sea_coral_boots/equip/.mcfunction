...
# 演出
    ...
    execute unless data storage asset:context id.all{head:711,chest:712,legs:713,feet:714} positioned ~ ~0.3 ~ rotated ~ 0 run function asset:artifact/0711.deep_sea_coral_crown/equip/vfx
