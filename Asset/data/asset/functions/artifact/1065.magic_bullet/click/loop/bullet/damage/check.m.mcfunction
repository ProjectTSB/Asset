#> asset:artifact/1065.magic_bullet/click/loop/bullet/damage/check.m
#
...
#     ID: int
#
# @within function asset:artifact/1065.magic_bullet/click/loop/bullet/damage/check_target
