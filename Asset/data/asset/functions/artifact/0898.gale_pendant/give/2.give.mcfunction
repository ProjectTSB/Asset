...
# 神器の説明文 (TextComponentString[])
    data modify storage asset:artifact Lore set value ['{"text":"非戦闘時、移動速度が40%上昇する","color":"white"}','{"text":"風の力を蓄えたペンダント","color":"gray"}','{"text":"付けると体が軽くなる","color":"gray"}']
...
# 装備時効果 ({ID: int, Visible: boolean}[]) (オプション)
    data modify storage asset:artifact Equipment.Effects set value [{ID:261,Visible:false}]
# 扱える神 (string[]) Wikiを参照
