...
# 神器の説明文 (TextComponentString[])
    data modify storage asset:artifact Lore set value ['{"text":"雷耐性+3% 雷攻撃+4%","color":"yellow"}','{"text":"セット効果で特殊な能力を得る"}','{"text":"セット効果発動時、雷耐性+5%","color":"yellow"}','{"text":"雷鳴が鳴り止むことはない","color":"gray"}']
