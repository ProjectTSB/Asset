...
# 神器の説明文 (TextComponentString[])
    data modify storage asset:artifact Lore set value ['{"translate":"-%1$s被ダメージ量の%2$s倍のダメージを攻撃者に与える(最大%3$s)","with":[{"text":"\\u0002","font":"space"},{"text":"30"},{"text":"2000"}]}','{"translate":"-%1$s被ダメージ量の%2$s分体力を回復する(最大%3$s)","with":[{"text":"\\u0002","font":"space"},{"text":"30%"},{"text":"20"}]}','{"translate":"-%1$sこの回復効果で累計%2$s回復するたび","with":[{"text":"\\u0002","font":"space"},{"text":"50"}]}','{"translate":"%1$s%2$sと%3$sを%4$s秒間得る","with":[{"text":"\\u0008","font":"space"},{"text":"攻撃+10%","color":"green"},{"text":"与回復量+10%","color":"green"},{"text":"15"}]}','{"text":"血を吸い深紅に咲いた薔薇の一輪","color":"gray"}','{"text":"尽きぬ渇きのまま、更なる血を求め根を伸ばす","color":"gray"}']
