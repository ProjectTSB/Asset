...
# 装備を外した時のメイン処理
#
# @within function asset:artifact/1122.guardian_ironlump/equip/dis_equip/
...
# ホットバー内に残ってない場合、削除する。
    execute if score $ItemCount Temporary matches ..0 run function asset:artifact/1122.guardian_ironlump/equip/removal
