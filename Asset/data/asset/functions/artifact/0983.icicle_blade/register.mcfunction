#> asset:artifact/0983.icicle_blade/register
#
# 神器の生成処理
#
# @within function asset:artifact/alias/983/register
...
# 攻撃に関する情報 -Damage量 (literal[]/literal) Wikiを参照 (オプション)
    data modify storage asset:artifact AttackInfo.Damage set value [179]
