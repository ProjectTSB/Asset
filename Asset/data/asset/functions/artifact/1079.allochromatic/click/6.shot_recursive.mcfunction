...
# 再帰
    execute if entity @s[tag=!Landing] positioned ^ ^ ^0.6 if entity @s[distance=..30] if block ^ ^ ^ #lib:no_collision run function asset:artifact/1079.allochromatic/click/6.shot_recursive