...
# 命中判定
    execute positioned ~-.5 ~-.5 ~-.5 as @e[type=#lib:living_without_player,tag=!Uninterferable,dx=0,limit=1] at @s run return run function asset:artifact/1079.allochromatic/click/shot/hit.m with storage asset:temp TZ.Const.Damage
# 再帰
