...
# 射撃 - 再帰
    execute facing entity @e[type=marker,tag=SpreadMarker,limit=1] feet run function asset:artifact/1079.allochromatic/click/shot/recursive.m with storage asset:temp TZ.Const
# リセット
