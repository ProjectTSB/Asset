#> asset:artifact/1079.allochromatic/click/7.damage
#
# ダメージを与える
#
# @within function asset:artifact/1079.allochromatic/click/6.shot_recursive
...
# 適正距離じゃないければダメージ減衰の計算を行う
    execute if score $Distance_Damping Temporary >= $Appropriate_Distance Temporary run function asset:artifact/1079.allochromatic/click/8.damage_attenuation
...
# 共鳴攻撃
    execute if entity @s[tag=Resonance] run function asset:artifact/1079.allochromatic/click/9.resonance_cooldown
