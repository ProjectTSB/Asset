...
# ダメージ計算用
    data modify storage asset:temp TZ.Const.Damage.Base set value 360
    data modify storage asset:temp TZ.Const.Damage.Min set value 300
    data modify storage asset:temp TZ.Const.Damage.MultiplierResonance set value 1.2
    data modify storage asset:temp TZ.Const.Damage.DistanceAppropriate set value 12
    data modify storage asset:temp TZ.Const.Damage.DistanceAttenuation set value 20
# 共鳴攻撃
