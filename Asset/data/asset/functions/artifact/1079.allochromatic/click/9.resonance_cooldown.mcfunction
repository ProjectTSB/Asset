#> asset:artifact/1079.allochromatic/click/9.resonance_cooldown
#
# 共鳴攻撃のクールダウン設定
#
# @within function asset:artifact/1079.allochromatic/click/7.damage
...
# 差が20以上なら共鳴攻撃が発動
    execute if score $TZ.Cooldown Temporary matches 20.. run function asset:artifact/1079.allochromatic/click/resonance_attack/1.summon_entity
