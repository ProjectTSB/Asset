...
# 神器の説明文 (TextComponentString[])
    data modify storage asset:artifact Lore set value ['{"translate":"- 使用時、%2$s%1$s%2$sを得る。","with":[{"translate":"[共鳴・%s]","color":"#ffdd66","with":[{"text":"蒼","color":"#a1faf5"}]},{"text":"\\u0002","font":"space"}]}','{"text":"- スニーク時、弾の集弾性が向上する。"}','{"translate":"- 自身または周囲のプレイヤーが%2$s%1$s%2$sを持っているとき、","with":[{"translate":"[共鳴・%s]","color":"#ffdd66","with":[{"text":"紅","color":"#ffbfd4"}]},{"text":"\\u0002","font":"space"}]}','{"text":"  ダメージと弾の集弾性が向上する。"}','{"translate":"- 周囲のプレイヤーが%2$s%1$s%2$sを持っているとき、","with":[{"translate":"[共鳴・%s]","color":"#ffdd66","with":[{"text":"紅","color":"#ffbfd4"}]},{"text":"\\u0002","font":"space"}]}','{"text":"  追撃が発生する。"}','{"text":"- 弾をすべて消費したとき、"}','{"text":"  魔力による弾の生成が必要となる。"}','{"text":"双星の輝きを秘める、蒼き少女の力の結晶。","color":"gray"}','{"text":"正確無比かつ冷酷に、敵の急所を撃ち抜く。","color":"gray"}']
