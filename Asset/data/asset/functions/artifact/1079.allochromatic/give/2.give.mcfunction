...
# 神器の説明文 (TextComponentString[])
    data modify storage asset:artifact Lore set value ['{"translate":"- 使用時、%2$s%1$s%2$sを得る。","with":[{"translate":"[共鳴・%s]","color":"#ffdd66","with":[{"text":"蒼","color":"#a1faf5"}]},{"text":"\\u0002","font":"space"}]}','{"text":"- スニーク時、弾の集弾性が向上する。"}','{"translate":"- 自身または周囲20mのプレイヤーに%2$s%1$s%2$sがあれば、","with":[{"translate":"[共鳴・%s]","color":"#ffdd66","with":[{"text":"紅","color":"#ffbfd4"}]},{"text":"\\u0002","font":"space"}]}','{"translate":"\\uE003\\uF006 ダメージが%1$s%2$s%1$s増加し、弾の集弾性が向上する。","with":[{"text":"\\u0002","font":"space"},{"text":"20%","color":"aqua"}]}','{"text":"- 自身を除く周囲20mのプレイヤーに"}','{"translate":"\\uE003\\uF006 %1$sがあれば追撃が発生する。","with":[{"translate":"[共鳴・%s]","color":"#ffdd66","with":[{"text":"紅","color":"#ffbfd4"}]}]}','{"text":"- 魔力で弾を補充することができる。"}','{"text":"双星の輝きを秘める、蒼き少女の力の結晶。","color":"gray"}','{"text":"正確無比かつ冷酷に、敵の急所を撃ち抜く。","color":"gray"}']
...
# 攻撃に関する情報 -Damage量 (literal[]/literal) Wikiを参照 (オプション)
    data modify storage asset:artifact AttackInfo.Damage set value "110-455 / 150x2"
