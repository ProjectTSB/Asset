...
# 差分を計算
    scoreboard players operation $TZ.Cooldown Temporary -= @s TZ.ResonanceCooldown
...
# 成功時にその時のtickを保存
    execute if score $TZ.Cooldown Temporary matches 20.. store result score @s TZ.ResonanceCooldown run time query gametime