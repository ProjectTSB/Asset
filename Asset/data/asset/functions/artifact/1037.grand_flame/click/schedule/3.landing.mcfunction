#> asset:artifact/1037.grand_flame/click/schedule/3.landing
#
# 着弾時の処理
#
# @within function asset:artifact/1037.grand_flame/click/schedule/1.tick
...
# 球体演出
    function asset:artifact/1037.grand_flame/click/schedule/3.1.vfx
...
# 動的パーティクル演出
    execute at @s run function asset:artifact/1037.grand_flame/click/schedule/3.2.random_vfx
