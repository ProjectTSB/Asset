...
# 弾が飛んでいる時の処理
#
# @within function asset:artifact/0769.shaking_splash/click/bullet/loop
...
# 雪玉がいない場合ヒット
    execute unless predicate lib:is_vehicle run function asset:artifact/0769.shaking_splash/click/bullet/hit
...
# ループ
    schedule function asset:artifact/0769.shaking_splash/click/bullet/loop 1t replace
