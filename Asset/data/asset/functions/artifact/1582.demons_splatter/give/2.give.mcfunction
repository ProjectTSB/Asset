...
# 神器の説明文 (TextComponentString[])
    data modify storage asset:artifact Lore set value ['[{"text":"攻撃+250%","color":"green"},{"text":"と","color":"white"},{"text":"最大体力-99.9%","color":"red"},{"text":"を30秒間得る","color":"white"}]','{"text":"鬼神の怨嗟のこもった返り血","color":"#610000"}','{"text":"使用者に生命力と引き換えに圧倒的な力を与える","color":"#610000"}',]
