#> asset:artifact/0027.bow_of_apollo/give/2.give
#
# 神器の作成部 ここでID等を定義する
#
# @user
# @within function asset:artifact/0027.bow_of_apollo/give/1.trigger

# 神器の説明や消費MPなどをここで設定する。
# 最後にasset:artifact/common/giveを実行することで入手可能。

# 神器のID (int) スプレッドシートの値を入れる
    data modify storage asset:artifact ID set value 27
# 神器のベースアイテム
    data modify storage asset:artifact Item set value "minecraft:bow"
# 神器の名前 (TextComponentString)
    data modify storage asset:artifact Name set value '{"text":"アポロンの弓","color":"#c0c0c0"}'
# 神器の説明文 (TextComponentString[])
    data modify storage asset:artifact Lore set value ['{"text":"弓を溜め続けると魔力を消費してチャージする。"}','{"text":"チャージの段階に応じて射程・ダメージが増加する。"}','{"text":"ただし、一度魔力が尽きるとそれ以上チャージされなくなる。"}','{"text":"アポロンが用いたとされる銀の弓。","color":"gray"}','{"text":"射られた矢は周囲の敵を灼きながら飛び去るだろう。","color":"gray"}']
