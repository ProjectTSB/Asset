...
# 神器の説明文 (TextComponentString[])
    data modify storage asset:artifact Lore set value ['[{"text":"最大体力+5% ","color":"light_purple"},{"text":"MP回復量+7.5%","color":"green"}]','[{"text":"回復量+8% ","color":"light_purple"},{"text":"攻撃-2.5%","color":"dark_red"}]','[{"text":"世界を見据える大樹に祝福を。","color":"gray"}]','[{"text":"根治へと到らせる世界樹の根。","color":"gray"}]']
