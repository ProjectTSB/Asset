...
# 演出
    execute unless data storage api: Return.Effect{Stack:4} positioned ~ ~0.4 ~ run function asset:artifact/0664.soul_fire_armor/vfx/equip
    execute unless data storage api: Return.Effect{Stack:4} positioned ~ ~0.6 ~ run function asset:artifact/0664.soul_fire_armor/vfx/equip
