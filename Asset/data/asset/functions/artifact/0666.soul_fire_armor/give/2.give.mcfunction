...
# 装備時のステータス補正 (Component[]) (オプション)
    data modify storage asset:artifact Modifiers set value [{Type:"maxHealth",Slot:"legs",Amount:-0.10d,Operation:"multiply_base"},{Type:"attackPhysical",Slot:"legs",Amount:0.05d,Operation:"multiply_base"},{Type:"attackFire",Slot:"legs",Amount:0.10d,Operation:"multiply_base"},{Type:"defenseFire",Slot:"legs",Amount:0.10d,Operation:"multiply_base"},{Type:"mpRegen",Slot:"legs",Amount:0.08d,Operation:"multiply_base"}]
# 扱える神 (string[]) Wikiを参照
    data modify storage asset:artifact CanUsedGod set value ["Urban", "Nyaptov", "Rumor"]
# カスタムNBT (NBTCompound) 追加で指定したいNBT (オプション)
    data modify storage asset:artifact CustomNBT set value {HideFlags:196,display:{color:3071974},Trim:{material:"diamond",pattern:"tsb_armor:664"},Unbreakable:1b,AttributeModifiers:[{AttributeName:"generic.armor",Name:"generic.armor",Amount:5,Operation:0,UUID:[I;1,1,664,6],Slot:"legs"},{AttributeName:"generic.armor_toughness",Name:"generic.armor_toughness",Amount:2.5,Operation:0,UUID:[I;1,1,664,6],Slot:"legs"}]}
