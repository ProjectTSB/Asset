#> asset:artifact/0717.world_tree_stem/register
#
# 神器の生成処理
#
# @within function asset:artifact/alias/717/register
...
# 神器の説明文 (TextComponentString[])
    data modify storage asset:artifact Lore set value ['[{"text":"世界を見据える大樹に祝福を。","color":"gray"}]','[{"text":"骨幹を模した世界樹の幹。","color":"gray"}]']
