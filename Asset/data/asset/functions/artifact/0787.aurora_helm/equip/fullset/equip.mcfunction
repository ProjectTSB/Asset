...
# フルセット時の演出
    execute rotated ~ 0 positioned ~ ~0.3 ~ run function asset:artifact/0787.aurora_helm/equip/fullset/vfx
...
# スケジュールループ
    schedule function asset:artifact/0787.aurora_helm/equip/fullset/loop 1t replace
