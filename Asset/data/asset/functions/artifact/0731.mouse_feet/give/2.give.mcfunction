...
# 神器の説明文 (TextComponentString[])
    data modify storage asset:artifact Lore set value ['{"text":"移動速度+40%を3秒間得る","color":"white"}','{"text":"臆病なネズミの足 叩かないで！","color":"gray"}']
...
# カスタムNBT (NBTCompound) 追加で指定したいNBT (オプション)
    data modify storage asset:artifact CustomNBT set value {HideFlags:68,display:{color:9411002},Unbreakable:1b}
