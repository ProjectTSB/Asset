#> asset:artifact/0005.musket_matchlock/click/3.1.2.damage
#
...
# Damage計算
    ...
    execute store result storage api: Argument.Damage float 4 run scoreboard players get @s 5.FlyingDuration
# 属性セット
