#> asset:artifact/0837.the_world_knife/click/knife/summon/
#
#
#
...
# 弾を召喚
    execute positioned ^ ^-0.8 ^1 run function asset:artifact/0837.the_world_knife/click/knife/summon/exec.m with storage asset:temp 837
# ユーザーID適応
