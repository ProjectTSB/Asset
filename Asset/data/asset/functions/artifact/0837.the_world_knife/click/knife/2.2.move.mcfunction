#> asset:artifact/0837.the_world_knife/click/knife/2.2.move
#
#
#
# @within function asset:artifact/0837.the_world_knife/click/knife/1.tick
...
# 着弾処理
    execute positioned ~ ~0.8 ~ if entity @s[tag=Landing] run function asset:artifact/0837.the_world_knife/click/knife/3.damage
