#> asset:artifact/0837.the_world_knife/click/knife/summon/surround
#
#
#
...
# 拡散したマーカーの上空に召喚
    execute at @e[type=marker,tag=SpreadMarker,distance=..20] facing entity @e[type=#lib:living,tag=N9.Target,distance=..20,limit=1] eyes positioned ^ ^ ^-3 run function asset:artifact/0837.the_world_knife/click/knife/summon/
# 前方拡散をキル
