#> asset:artifact/0837.the_world_knife/register
#
# 神器の生成処理
#
# @within function asset:artifact/alias/837/register
...
# 攻撃に関する情報 -Damage量 (literal[]/literal) Wikiを参照 (オプション)
    data modify storage asset:artifact AttackInfo.Damage set value ["70-80x3 / 90-110x3"]
