...
#> Private
# @private
#declare tag N9.TargetCandidate
...
# 視点先に敵が居なかったら正面の一番近い敵を対象とする
    execute unless entity @e[type=#lib:living,tag=N9.Target,distance=..5] anchored eyes positioned ^ ^ ^2.5 run tag @e[type=#lib:living,tag=Enemy,tag=!Uninterferable,distance=..2.5] add N9.TargetCandidate
