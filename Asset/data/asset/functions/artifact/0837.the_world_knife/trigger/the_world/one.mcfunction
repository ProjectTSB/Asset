...
# 拡散したマーカーの上空に召喚
    execute at @e[type=marker,tag=SpreadMarker,distance=..20] facing entity @s feet positioned ^ ^ ^-2 facing entity @s eyes run function asset:artifact/0837.the_world_knife/trigger/summon_knife.m {TheWorld:"true",Spread:0.25,DamageMin:90,DamageMax:110}
# 前方拡散をキル
