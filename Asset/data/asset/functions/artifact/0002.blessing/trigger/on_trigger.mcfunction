...
# 攻撃
    ...
    execute if score @s 02.Trigger matches 3 run scoreboard players add $BonusAttackSelectCount 02.SelectCount 1
...
# 防御
    ...
    execute if score @s 02.Trigger matches 4 run scoreboard players add $BonusDefenseSelectCount 02.SelectCount 1
