#> asset:artifact/0002.blessing/click/on_trigger
#
#
#
# @within function asset:artifact/0002.blessing/click/listener

# エラー値
    execute unless score @s 02.Trigger matches 1..4 run function lib:message/invalid_operation
    execute unless score @s 02.Trigger matches 1..4 run function asset:artifact/0002.blessing/click/show_trigger_chat
# 体力
