...
# 神器の説明文 (TextComponentString[])
    data modify storage asset:artifact Lore set value ['{"text":"発動時、自身含む周囲のランダムな3名に","color":"white"}','{"text":"物理攻撃、物理耐性、魔法攻撃、魔法耐性の","color":"white"}','{"text":"各+8%のどれかを8秒間付与する。","color":"white"}']
