#> asset:artifact/1145.nurse_call/give/2.give
#
# 神器の作成部 ここでID等を定義する
#
# @user
# @within function asset:artifact/1145.nurse_call/give/1.trigger

# 神器の説明や消費MPなどをここで設定する。
# 最後にasset:artifact/common/giveを実行することで入手可能。

# 神器のID (int) スプレッドシートの値を入れる
    data modify storage asset:artifact ID set value 1145
# 神器のベースアイテム
...
# 神器の説明文 (TextComponentString[])
    data modify storage asset:artifact Lore set value ['{"text":"一定時間回復をしてくれるメディックを召喚する"}','{"text":"メディックは周囲10mのプレイヤーを20秒間かけて65回復する"}','{"text":"彼女はあなたのためにその身を削る","color":"gray"}','{"text":"自己犠牲のもとに、彼女の治癒は成り立つ","color":"gray"}']
...
# 第二種別クールダウン ({Type: string, Duration: int}) (オプション)
    data modify storage asset:artifact SecondaryTypeCooldown.Type set value "summon"
    data modify storage asset:artifact SecondaryTypeCooldown.Duration set value 400
