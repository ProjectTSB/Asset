...
# 神器の説明文 (TextComponentString[])
    data modify storage asset:artifact Lore set value ['{"text":"一定時間回復をしてくれるメディックを召喚する"}','{"text":"メディックは周囲10mのプレイヤーを20秒間かけて80回復する"}','{"text":"彼女はあなたのためにその身を削る","color":"gray"}','{"text":"自己犠牲のもとに、彼女の治癒は成り立つ","color":"gray"}']
