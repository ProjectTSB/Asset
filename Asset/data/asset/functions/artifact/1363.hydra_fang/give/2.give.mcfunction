...
# 神器の説明文 (TextComponentString[])
    data modify storage asset:artifact Lore set value ['{"text":"与えたダメージ量の100%分のダメージを与える(最大1000)","color":"white"}','{"text":"このダメージは自身のステータス補正の影響を受けない","color":"white"}','{"text":"猛毒が滴る魔獣の牙","color":"gray"}','{"text":"一度傷をついたが最後、死に至るまで獲物を逃がさない","color":"gray"}']
