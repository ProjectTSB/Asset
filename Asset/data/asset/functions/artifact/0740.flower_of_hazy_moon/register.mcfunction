...
# 神器の生成処理
#
# @within function asset:artifact/alias/740/register
...
# 神器の説明文 (TextComponentString[])
    data modify storage asset:artifact Lore set value ['[{"text":"微かに月光が射す時のみに咲く花。","color":"gray"}]','[{"text":"見た者の心を惑わし、狂わせる。","color":"gray"}]','{"text":"装備時、MPを150消費する。","color":"dark_purple"}']
