#> asset:artifact/1390.red_refraction_prism/trigger/2.check_condition/get_damage/recursive
#
#
#
# @within function
#   asset:artifact/1390.red_refraction_prism/trigger/2.check_condition/get_damage/pre
#   asset:artifact/1390.red_refraction_prism/trigger/2.check_condition/get_damage/recursive
...
# 要素がある && 一致してないなら再帰
    execute if data storage asset:temp Temp.To[0] unless score @s MobUUID = $TempID Temporary run function asset:artifact/1390.red_refraction_prism/trigger/2.check_condition/get_damage/recursive
