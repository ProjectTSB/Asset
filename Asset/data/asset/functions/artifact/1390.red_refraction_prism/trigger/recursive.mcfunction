#> asset:artifact/1390.red_refraction_prism/trigger/recursive
#
#
#
# @within function
#   asset:artifact/1390.red_refraction_prism/trigger/apply
#   asset:artifact/1390.red_refraction_prism/trigger/recursive
...
# 要素がある && 一致してないなら再帰
    execute if data storage asset:temp Temp.To[0] unless score @s MobUUID = $TempID Temporary run function asset:artifact/1390.red_refraction_prism/trigger/recursive
