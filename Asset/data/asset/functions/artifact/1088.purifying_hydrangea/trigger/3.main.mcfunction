...
# デバフを1つ解除
    execute if predicate lib:weather/is_sunny if predicate lib:random_pass_per/30 run function asset:artifact/1088.purifying_hydrangea/trigger/remove_debuff
    execute unless predicate lib:weather/is_sunny if predicate lib:random_pass_per/50 run function asset:artifact/1088.purifying_hydrangea/trigger/remove_debuff
