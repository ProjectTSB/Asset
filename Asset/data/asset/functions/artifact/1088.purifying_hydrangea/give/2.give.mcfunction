#> asset:artifact/1088.purifying_hydrangea/give/2.give
#
# 神器の作成部 ここでID等を定義する
#
# @user
# @within function asset:artifact/1088.purifying_hydrangea/give/1.trigger

# 神器の説明や消費MPなどをここで設定する。
# 最後にasset:artifact/common/giveを実行することで入手可能。

# 神器のID (int) スプレッドシートの値を入れる
    data modify storage asset:artifact ID set value 1088
# 神器のベースアイテム
    data modify storage asset:artifact Item set value "minecraft:stick"
# 神器の名前 (TextComponentString)
    data modify storage asset:artifact Name set value '{"text":"浄藍の紫陽花","color":"#83aaf7"}'
# 神器の説明文 (TextComponentString[])
    data modify storage asset:artifact Lore set value ['[{"text":"自身と周囲20mの1名に","color":"white"},{"text":"水攻撃+7.5%","color":"aqua"},{"text":"を15秒間付与する","color":"white"}]','[{"text":"加えて、30%の確率で自身のデバフ"},{"text":"[弱/強]","color":"#FFDD66"},{"text":"を1つ解除する","color":"white"}]','{"text":"また、雨の場合、デバフ解除確率が50%になり"}','[{"text":"追加で","color":"white"},{"text":"水攻撃+7.5%","color":"aqua"},{"text":"を付与する","color":"white"}]','{"text":"(水攻撃補正の最も高いプレイヤーを優先)","color":"white"}','{"text":"雨の中にだけ咲く、深い藍色の紫陽花","color":"gray"}','{"text":"穢れを浄化し、雨に還す力を持つ","color":"gray"}']
...
# 神器の発動条件 (TextComponentString) (オプション)
    data modify storage asset:artifact Condition set value '{"text":"累計で50回復","color":"white"}'
