#> asset:artifact/1029.conviction_bone/click/shot/shot
#
#
#
# @within function asset:artifact/1029.conviction_bone/click/shot/schedule
...
# ダメージ
    execute if score @s SL.CoolTime matches 4.. if entity @e[type=#lib:living,tag=Enemy,tag=!Uninterferable,distance=..2,sort=nearest,limit=1] run function asset:artifact/1029.conviction_bone/click/shot/hit
