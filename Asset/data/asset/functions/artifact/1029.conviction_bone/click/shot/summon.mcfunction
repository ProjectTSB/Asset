...
#
#
# @within function asset:artifact/1029.conviction_bone/click/sword/sword_kill
...
# 再帰先へ飛ばす
    execute as @e[type=marker,tag=SL.Shot,limit=1] run function asset:artifact/1029.conviction_bone/click/shot/schedule
