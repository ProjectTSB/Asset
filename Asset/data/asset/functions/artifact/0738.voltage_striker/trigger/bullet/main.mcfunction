...
# ヒット処理
    execute if entity @s[scores={KI.Tick=14..}] positioned ~-0.5 ~-0.5 ~-0.5 if entity @e[type=#lib:living,tag=Enemy,tag=!Uninterferable,dx=0,limit=1] at @s run function asset:artifact/0738.voltage_striker/trigger/bullet/hit
