#> asset:artifact/0719.sword_of_divine_sound/attack_melee/vfx/lightning
#
# 雷のパーティクルを出す処理
#
# @within function
#   asset:artifact/0719.sword_of_divine_sound/attack_melee/vfx/start_lightning
#   asset:artifact/0719.sword_of_divine_sound/attack_melee/vfx/random_rotation
...
# 向きを変える
    execute if score $RecursiveLimit Temporary matches ..6 positioned ^ ^ ^1.95 rotated ~ -90 run function asset:artifact/0719.sword_of_divine_sound/attack_melee/vfx/random_rotation
