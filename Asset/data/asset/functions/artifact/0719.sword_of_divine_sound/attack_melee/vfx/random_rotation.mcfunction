...
# 雷の曲がる部分の処理
#
# @within function asset:artifact/0719.sword_of_divine_sound/attack_melee/vfx/lightning
...
# 再帰
    execute at @s run function asset:artifact/0719.sword_of_divine_sound/attack_melee/vfx/lightning
