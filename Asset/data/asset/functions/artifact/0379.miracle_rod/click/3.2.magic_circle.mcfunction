...
# 発動
    execute as @e[type=area_effect_cloud,tag=AJ.Magic,scores={AJ.CoolTime=0}] at @s positioned ~ ~1.5 ~ positioned ^ ^ ^2 run function asset:artifact/0379.miracle_rod/click/3.3.shoot
...
# ループ
    execute if entity @e[type=area_effect_cloud,tag=AJ.Magic,limit=1] run schedule function asset:artifact/0379.miracle_rod/click/3.2.magic_circle 1t replace