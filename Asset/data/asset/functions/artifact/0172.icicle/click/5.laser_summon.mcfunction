#> asset:artifact/0172.icicle/click/5.laser_summon
#
#
#
# @within function asset:artifact/0172.icicle/click/4.block_check
...
#演出
    function asset:artifact/0172.icicle/click/particle