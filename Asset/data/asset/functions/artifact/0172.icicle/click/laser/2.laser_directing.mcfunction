#> asset:artifact/0172.icicle/click/laser/2.laser_directing
#
#
#
...
# 発砲
    execute facing entity @e[type=marker,tag=SpreadMarker,distance=..50,limit=1] feet as @e[type=marker,tag=SpreadMarker,distance=..50,limit=1] run function asset:artifact/0172.icicle/click/laser/particle_special
