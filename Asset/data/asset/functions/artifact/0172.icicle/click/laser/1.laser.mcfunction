#> asset:artifact/0172.icicle/click/laser/1.laser
#
#
#
# @within function asset:artifact/0172.icicle/click/laser/schedule
...
# ばちばちする
    execute if score @s 4S.Time matches 60 positioned ~ ~17 ~ rotated ~ 90 run function asset:artifact/0172.icicle/click/laser/2.laser_directing
    execute if score @s 4S.Time matches 73 positioned ~ ~17 ~ rotated ~ 90 run function asset:artifact/0172.icicle/click/laser/2.laser_directing
    execute if score @s 4S.Time matches 85 positioned ~ ~17 ~ rotated ~ 90 run function asset:artifact/0172.icicle/click/laser/2.laser_directing
    execute if score @s 4S.Time matches 87..110 positioned ~ ~17 ~ rotated ~ 90 run function asset:artifact/0172.icicle/click/laser/2.laser_directing
...
# 2tickおきに実行
    ...
    execute if score $2tInterval Temporary matches 0 run function asset:artifact/0172.icicle/click/laser/2t_interval
# リセット
...
# スコアが110以上で動かす
    execute if score $4tInterval Temporary matches 0 if score @s 4S.Time matches 110.. positioned ~ ~15 ~ rotated 0 90 run function asset:artifact/0172.icicle/click/laser/5.damage_laser
