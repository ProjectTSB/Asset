#> asset:artifact/0172.icicle/register
#
# 神器の生成処理
#
# @within function asset:artifact/alias/172/register
...
# 神器の説明文 (TextComponentString[])
    data modify storage asset:artifact Lore set value ['{"text":"前方につららの雨を降らせ相手を串刺しにする"}','{"text":"この攻撃は大きな敵に対して大きく減衰する"}']
...
# 攻撃に関する情報 -Damage量 (literal[]/literal) Wikiを参照 (オプション)
    data modify storage asset:artifact AttackInfo.Damage set value ["550x48"]
