...
# 突進する
    ...
    execute as @e[type=#lib:living,tag=Enemy,tag=!Uninterferable,tag=!Enemy.Boss,distance=..2] at @s facing entity @e[type=area_effect_cloud,tag=4S.Laser,distance=..100,sort=nearest,limit=1] eyes rotated ~ 0 run function lib:motion/
# リセット
