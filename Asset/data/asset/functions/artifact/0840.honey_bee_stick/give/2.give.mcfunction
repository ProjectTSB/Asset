...
# 神器の説明文 (TextComponentString[])
    data modify storage asset:artifact Lore set value ['{"text":"ハチミツを大量に内包した杖","color":"yellow"}','{"text":"周囲のプレイヤーを20.0回復し","color":"#FFBD24"}','{"text":"周囲の敵にダメージと鈍足を付与する","color":"yellow"}']
