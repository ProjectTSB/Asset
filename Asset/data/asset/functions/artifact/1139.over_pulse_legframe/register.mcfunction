#> asset:artifact/1139.over_pulse_legframe/register
#
# 神器の作成部 ここでID等を定義する
#
# @within function asset:artifact/alias/1139/register

# 神器のID (int) スプレッドシートの値を入れる
    data modify storage asset:artifact ID set value 1139
# 神器のベースアイテム
...
# 神器の説明文 (TextComponentString[])
    data modify storage asset:artifact Lore set value ['{"text":"垂直方向の移動力が向上する。"}','{"text":"他部位を装備するとさらに落下の衝撃を軽減する。"}','{"text":"─ 対落下衝撃フレーム 活性化。","color":"gray","italic":true}','{"text":"─ 生体ノ破損ニ 注意シテクダサイ。","color":"gray","italic":true}']
...
# 装備時補正 (Compound[]) (オプション)
    ...
    data modify storage asset:artifact Modifiers append value {Type:"generic.armor",Amount:9d,Operation:"add"}
