#> asset:artifact/0258.cat_dream_pillow/heal/give_barrier
#
# バリアをプレイヤーに再帰で付与していく
#
# @within function
...
# 要素がまだあれば再帰
    execute if data storage asset:temp Temp.To[-1] run function asset:artifact/0258.cat_dream_pillow/heal/give_barrier
