...
# 装備時のステータス補正 (Component[]) (オプション)
    data modify storage asset:artifact Modifiers set value [{Type:"maxHealth",Slot:"head",Amount:8,Operation:"add"},{Type:"heal",Slot:"head",Amount:0.06d,Operation:"multiply_base"},{Type:"defensePhysical",Slot:"head",Amount:-0.05d,Operation:"multiply_base"}]
# 扱える神 (string[]) Wikiを参照
