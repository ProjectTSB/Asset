...
# 神器の説明文 (TextComponentString[])
    data modify storage asset:artifact Lore set value ['{"text":"水平方向の移動力が向上する。"}','{"text":"他部位を装備するとさらに移動力が向上する。"}','{"text":"─ 浮上装置ノ 破損ヲ 確認。","color":"gray","italic":true}','{"text":"─ 代替トシテ 移動補助ヲ 実行シマス。","color":"gray","italic":true}']
