...
# 神器の説明文 (TextComponentString[])
    data modify storage asset:artifact Lore set value ['{"text":"クロスヘアに捉えた敵に向かってミサイルを発射する。","color":"white"}','{"text":"発射時の姿勢によってミサイルの性質が変化する。","color":"white"}','{"text":" スニーク：火属性の範囲ダメージを与える","color":"white"}','{"text":" 直立：耐性を貫通する無属性単体ダメージを与える","color":"white"}','{"text":"最大火力を発揮するためにはミサイルが一定距離以上飛翔する必要がある。","color":"white"}','{"text":"?「正式名称は両用支援打撃弾(Bipurpose Launching Equipment for Support Strike)","color":"dark_aqua","italic":true}','{"text":"撃つも殴るもよし、対地対空両用の万能な兵器。","color":"dark_aqua","italic":true}','{"text":"魔力と適正さえあれば人でも天使でも、誰でも簡単に扱える。」","color":"dark_aqua","italic":true}']
...
# 攻撃に関する情報 -Damage量 (literal[]/literal) Wikiを参照 (オプション)
    data modify storage asset:artifact AttackInfo.Damage set value ["700/1400","3500/7000"]
