...
# reset
    tag @e[type=#lib:living,tag=Enemy,tag=WO.Candidate,tag=!Uninterferable] remove WO.Candidate
    tag @e[type=#lib:living,tag=Enemy,tag=WO.Target,tag=!Uninterferable] remove WO.Target
