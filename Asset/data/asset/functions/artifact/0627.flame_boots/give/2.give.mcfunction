...
# 装備時のステータス補正 (Component[]) (オプション)
    data modify storage asset:artifact Modifiers set value [{Type:"attackFire",Slot:"feet",Amount:0.03d,Operation:"multiply_base"},{Type:"defenseFire",Slot:"feet",Amount:0.03d,Operation:"multiply_base"}]
# 扱える神 (string[]) Wikiを参照
