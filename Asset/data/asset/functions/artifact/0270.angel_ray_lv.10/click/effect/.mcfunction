#> asset:artifact/0270.angel_ray_lv.10/click/effect/
#
#
#
# @within function asset:artifact/0270.angel_ray_lv.10/click/
...
# 対象探索
    function asset:artifact/0270.angel_ray_lv.10/click/effect/find_target
# 自身を対象から外す
