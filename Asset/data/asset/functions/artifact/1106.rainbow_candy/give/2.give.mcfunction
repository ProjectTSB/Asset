#> asset:artifact/1106.rainbow_candy/give/2.give
#
# 神器の作成部 ここでID等を定義する
#
# @user
# @within function asset:artifact/1106.rainbow_candy/give/1.trigger

# 神器の説明や消費MPなどをここで設定する。
# 最後にasset:artifact/common/giveを実行することで入手可能。

# 神器のID (int) スプレッドシートの値を入れる
    data modify storage asset:artifact ID set value 1106
# 神器のベースアイテム
...
# 神器の説明文 (TextComponentString[])
    data modify storage asset:artifact Lore set value ['{"text":"HPとMPを1~10回復する。","color":"white"}','{"text":"7つの味があるキャンディ。","color":"gray"}','{"text":"舐める度に味が変わる。","color":"gray"}']
