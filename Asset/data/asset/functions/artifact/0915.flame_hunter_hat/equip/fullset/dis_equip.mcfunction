#> asset:artifact/0915.flame_hunter_hat/equip/fullset/dis_equip
#
# フルセット解除時の処理
#
# @within function
#   asset:artifact/0915.flame_hunter_hat/equip/dis_equip/main
#   asset:artifact/0916.flame_hunter_clothes/equip/dis_equip/main
#   asset:artifact/0917.flame_hunter_clothes/equip/dis_equip/main
#   asset:artifact/0918.flame_hunter_boots/equip/dis_equip/main
