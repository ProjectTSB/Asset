...
# 神器の説明文 (TextComponentString[])
    data modify storage asset:artifact Lore set value ['{"translate":"-%1$s矢を3発命中させると曲射が可能になり","with":[{"text":"\\u0002","font":"space"}]}','{"translate":"%1$sその状態で上を向いて発射すると敵に矢の雨を降り注がせる","with":[{"text":"\\u0008","font":"space"}]}','{"translate":"-%1$s使用時のMPが%2$s以下の時、MP回復量+%3$s","with":[{"text":"\\u0002","font":"space"},{"text":"60%"},{"text":"30%"}]}','{"text":"オーロラの天使の持っていた弓","color":"gray"}','{"text":"その天衣の弦から放たれた矢は寒空を貫き降り注ぐ","color":"gray"}']
