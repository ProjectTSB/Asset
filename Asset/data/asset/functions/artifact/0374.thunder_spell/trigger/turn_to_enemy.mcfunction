...
# 最も近い敵を狙って方向転換
    execute positioned ~ ~1 ~ positioned ^ ^ ^4 if entity @e[type=#lib:living_without_player,tag=NearestTarget,distance=..4] facing entity @e[type=#lib:living_without_player,tag=NearestTarget,distance=..4,sort=nearest,limit=1] eyes run function asset:artifact/0374.thunder_spell/trigger/line
