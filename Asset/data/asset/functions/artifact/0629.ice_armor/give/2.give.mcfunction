...
# 装備時のステータス補正 (Component[]) (オプション)
    data modify storage asset:artifact Modifiers set value [{Type:"attackWater",Slot:"chest",Amount:0.03d,Operation:"multiply_base"},{Type:"defenseWater",Slot:"chest",Amount:0.03d,Operation:"multiply_base"}]
# 扱える神 (string[]) Wikiを参照
