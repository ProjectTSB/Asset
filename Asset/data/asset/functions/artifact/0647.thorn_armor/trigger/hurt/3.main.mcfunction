...
# 神器のメイン処理
#
# @within function asset:artifact/0647.thorn_armor/trigger/hurt/2.check_condition
...
# 演出
    ...
    # 再帰使用：相手に棘を伸ばす演出
        execute positioned ~ ~1.5 ~ facing entity @e[type=#lib:living,tag=Attacker,distance=..50] eyes run function asset:artifact/0647.thorn_armor/trigger/hurt/4.extend_thorn
