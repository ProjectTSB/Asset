#> asset:artifact/1075.fairy_vial/receive_heal/4.find_target_player
#
# 現在体力の低いプレイヤーを見つける
#
...
# 各プレイヤーの現在体力をスコアへ代入
    execute as @a[tag=SearchTarget] store result score @s Temporary run function asset:artifact/1075.fairy_vial/receive_heal/5.get_lost_health
