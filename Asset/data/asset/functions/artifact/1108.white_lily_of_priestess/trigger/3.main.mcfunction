...
# デバフ数が最も多いプレイヤー2名を検索する
    execute if entity @p[tag=!ClearTarget,distance=..20] run function asset:artifact/1108.white_lily_of_priestess/trigger/4.find_highest_debuff_player
    execute if entity @p[tag=!ClearTarget,distance=..20] run function asset:artifact/1108.white_lily_of_priestess/trigger/4.find_highest_debuff_player
