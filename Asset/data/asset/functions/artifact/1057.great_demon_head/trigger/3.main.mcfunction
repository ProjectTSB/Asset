...
# 神器のメイン処理部
#
# @within function asset:artifact/1057.great_demon_head/trigger/2.check_condition
...
# 演出
    execute positioned ~ ~1.6 ~ run function asset:artifact/1057.great_demon_head/trigger/common/equip_vfx
