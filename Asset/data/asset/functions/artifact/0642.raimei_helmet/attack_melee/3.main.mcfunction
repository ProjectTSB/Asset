...
# 演出
    ...
    execute at @e[type=#lib:living,type=!player,tag=Victim,distance=..10,sort=nearest,limit=1] run particle dust 0.867 0.667 0.161 1 ~ ~1 ~ 0 1 0 0 100
...
# ダメージ
    ...
    execute as @e[type=#lib:living,type=!player,tag=Victim,distance=..10,sort=nearest,limit=1] run function api:damage/
