#> asset:artifact/0959.whirlwind_scabbard/register
#
# 神器の生成処理
#
# @within function asset:artifact/alias/959/register
...
# 神器の説明文 (TextComponentString[])
    data modify storage asset:artifact Lore set value ['{"text":"前を塞ぐ者を吹き飛ばす。","color":"white"}','{"text":"抜いた刀に旋風を纏わせる鞘。","color":"gray"}','{"text":"その旋風は何にも止めることはできない。","color":"gray"}']
