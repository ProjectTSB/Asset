#> asset:artifact/1225.hardened_netherite_armor/trigger/3.main
#
# 神器のメイン処理部
#
# @within function asset:artifact/1225.hardened_netherite_armor/trigger/2.check_condition
...
# 頭
    data modify storage api: Argument.ID set value 1247
...
# 胴
    data modify storage api: Argument.ID set value 1248
...
# 脚
    data modify storage api: Argument.ID set value 1249
...
# 足
    data modify storage api: Argument.ID set value 1250
