#> asset:artifact/0759.sina_tk_empty/register
#
# 神器の生成処理
#
# @within function asset:artifact/alias/759/register
...
# 消費アイテム ({Item: TextComponent, Count: int, Extra?: TextComponent}) (オプション)
    data modify storage asset:artifact ConsumeItem.Item set value '{"translate":"block.minecraft.bamboo"}'
...
# 神器のトリガー (string) Wikiを参照
    data modify storage asset:artifact Trigger set value "keep_sneak"
