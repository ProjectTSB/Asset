#> asset:artifact/0870.samurai_blade/click/skill_list/skill_3/skill
#
#
#
...
# 剣を振る
    execute if score @s O6.Time matches 2 anchored eyes run function asset:artifact/0870.samurai_blade/click/particle/particle3
    execute if score @s O6.Time matches 2 run function asset:artifact/0870.samurai_blade/click/slash
    execute if score @s O6.Time matches 4 anchored eyes run function asset:artifact/0870.samurai_blade/click/particle/particle7
