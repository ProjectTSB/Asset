#> asset:artifact/0329.approaching_hook_shot/register
#
# 神器の生成処理
#
# @within function asset:artifact/alias/329/register
...
# 神器のトリガー (string) Wikiを参照
    data modify storage asset:artifact Trigger set value "attack_projectile"
