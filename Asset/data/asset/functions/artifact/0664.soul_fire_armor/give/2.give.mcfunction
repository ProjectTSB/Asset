...
# 装備時のステータス補正 (Component[]) (オプション)
    data modify storage asset:artifact Modifiers set value [{Type:"maxHealth",Slot:"head",Amount:-0.10d,Operation:"multiply_base"},{Type:"attackPhysical",Slot:"head",Amount:0.05d,Operation:"multiply_base"},{Type:"attackFire",Slot:"head",Amount:0.10d,Operation:"multiply_base"},{Type:"defenseFire",Slot:"head",Amount:0.10d,Operation:"multiply_base"},{Type:"mpRegen",Slot:"head",Amount:0.08d,Operation:"multiply_base"}]
# 扱える神 (string[]) Wikiを参照
