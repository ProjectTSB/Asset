#> asset:artifact/0664.soul_fire_armor/equip/fullset/attack
#
# フルセット時の近接攻撃
#
# @within function asset:artifact/0664.soul_fire_armor/equip/fullset/attack_trigger

# 演出
    execute as @e[type=#lib:living,type=!player,tag=Victim,distance=..64] at @s run function asset:artifact/0664.soul_fire_armor/equip/fullset/particle
