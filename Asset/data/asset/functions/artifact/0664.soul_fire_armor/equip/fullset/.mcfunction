...
# 演出
    function asset:artifact/0664.soul_fire_armor/equip/fullset/particle
...
# スケジュールループ開始
    schedule function asset:artifact/0664.soul_fire_armor/equip/fullset/loop 1t replace
