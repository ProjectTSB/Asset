...
# フルセット時のメイン処理
#
# @within function asset:artifact/0664.soul_fire_armor/equip/fullset/loop
...
# スケジュールループ
    execute if entity @s[tag=IG.Fullset] run schedule function asset:artifact/0664.soul_fire_armor/equip/fullset/loop 1t replace