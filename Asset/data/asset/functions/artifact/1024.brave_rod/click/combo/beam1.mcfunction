#> asset:artifact/1024.brave_rod/click/combo/beam1
#
#
#
# @within function asset:artifact/1024.brave_rod/click/
...
# 拡散させて実行
    ...
    # その位置から実行
        execute at @e[type=marker,tag=SpreadMarker,limit=1] rotated as @s run function asset:artifact/1024.brave_rod/click/combo/beam1_shot
    # リセット
