#> asset:artifact/1409.mana_charm/trigger/3.main
#
# 神器のメイン処理部
#
# @within function asset:artifact/1409.mana_charm/trigger/2.check_condition
...
# 演出
    ...
    particle dust 0.000 0.647 1.000 1 ~ ~1 ~ 0.2 0.2 0.2 0 20
