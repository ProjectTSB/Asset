#> asset:artifact/1222.hardened_iron_armor/trigger/3.main
#
# 神器のメイン処理部
#
# @within function asset:artifact/1222.hardened_iron_armor/trigger/2.check_condition
...
# 頭
    data modify storage api: Argument.ID set value 1235
...
# 胴
    data modify storage api: Argument.ID set value 1236
...
# 脚
    data modify storage api: Argument.ID set value 1237
...
# 足
    data modify storage api: Argument.ID set value 1238
