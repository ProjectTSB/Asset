...
# 神器の説明文 (TextComponentString[])
    data modify storage asset:artifact Lore set value ['{"text":"被ダメージが2倍になる","color":"white"}','{"text":"災厄を編んだ呪いの鎖","color":"gray"}','{"text":"縛られた者を破滅の運命へと導く","color":"gray"}']
...
# 破壊時の音を鳴らさないかどうか (boolean) (オプション)
    ...
    data modify storage asset:artifact Equipment.Modifiers append value {Type:"defense/base",Amount:-1d,Operation:"multiply"}
# 扱える神 (string[]) Wikiを参照
