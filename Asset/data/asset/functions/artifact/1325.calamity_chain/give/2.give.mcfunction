#> asset:artifact/1325.calamity_chain/give/2.give
#
# 神器の作成部 ここでID等を定義する
#
# @user
# @within function asset:artifact/1325.calamity_chain/give/1.trigger

# 神器の説明や消費MPなどをここで設定する。
# 最後にasset:artifact/common/giveを実行することで入手可能。

# 神器のID (int) スプレッドシートの値を入れる
    data modify storage asset:artifact ID set value 1325
# 神器のベースアイテム
...
# MP消費量 (int)
    # data modify storage asset:artifact MPCost set value 999
# MP必要量 (int) (オプション)
...
# 破壊時の音を鳴らさないかどうか (boolean) (オプション)
    ...
    data modify storage asset:artifact Equipment.Modifiers append value {Type:"attack/base",Amount:0.25d,Operation:"multiply_base"}
    data modify storage asset:artifact Equipment.Modifiers append value {Type:"mp_heal",Amount:0.25d,Operation:"multiply_base"}
    data modify storage asset:artifact Equipment.Modifiers append value {Type:"defense/base",Amount:-1d,Operation:"multiply_base"}
# 扱える神 (string[]) Wikiを参照
