#> asset:artifact/1391.blue_refraction_prism/trigger/attack
#
#
#
# @within function
...
# 要素がまだあるなら再帰
    execute if data storage asset:temp Temp.Main.To[0] run function asset:artifact/1391.blue_refraction_prism/trigger/attack
