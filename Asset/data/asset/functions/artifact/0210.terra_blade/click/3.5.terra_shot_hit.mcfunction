#> asset:artifact/0210.terra_blade/click/3.5.terra_shot_hit
#
...
# 魔法、無属性のダメージをぶちかます
    ...
    data modify storage api: Argument.AdditionalMPHeal set value 8.0f
    tag @s add this
...
#ショット削除
    function asset:artifact/0210.terra_blade/click/terra_shot_break
