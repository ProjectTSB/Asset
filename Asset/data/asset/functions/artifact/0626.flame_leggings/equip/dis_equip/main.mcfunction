...
# 装備を外した時のメイン処理
#
# @within function asset:artifact/0626.flame_leggings/equip/dis_equip/
...
# フルセット効果を削除
    execute if entity @s[tag=HD.Fullset] run function asset:artifact/0625.flame_armor/equip/5.fullset_dis_equip