#> asset:artifact/0373.ice_sorcery/click/3.2.beamshot2
#
# ビーム部
#
# @within function
...
# ビームを飛ばす
    ...
    execute as @s facing entity @e[type=marker,tag=SpreadMarker,limit=1] feet anchored eyes positioned ^ ^ ^ run function asset:artifact/0373.ice_sorcery/click/3.3.beam
    tag @s remove AD.Hit
