#> asset:artifact/0373.ice_sorcery/click/3.3.beam
#
# ビーム部
#
...
# 着弾
    execute if entity @s[tag=AD.Hit] run function asset:artifact/0373.ice_sorcery/click/3.4.hit

# 再起
    execute positioned ^ ^ ^0.5 if entity @s[tag=!AD.Hit,distance=..30] run function asset:artifact/0373.ice_sorcery/click/3.3.beam