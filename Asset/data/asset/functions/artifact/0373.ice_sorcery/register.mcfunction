#> asset:artifact/0373.ice_sorcery/register
#
# 神器の生成処理
#
# @within function asset:artifact/alias/373/register
...
# 攻撃に関する情報 -Damage量 (literal[]/literal) Wikiを参照 (オプション)
    data modify storage asset:artifact AttackInfo.Damage set value [35x5]
...
# MP回復量
    data modify storage asset:artifact MPHealWhenHit set value 4.8
# 神器のクールダウン (int) (オプション)
