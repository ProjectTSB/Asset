...
# 装備を外した時のメイン処理
#
# @within function asset:artifact/0789.aurora_leggings/equip/dis_equip/
...
# フルセット解除
    execute if entity @s[tag=LT.Fullset] run function asset:artifact/0787.aurora_helm/equip/fullset/dis_equip