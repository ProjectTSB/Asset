#> asset:artifact/0789.aurora_leggings/equip/3.main
#
# 神器のメイン処理部
#
# @within function asset:artifact/0789.aurora_leggings/equip/2.check_condition
...
# 演出
    execute unless data storage api: Return.Effect{Stack:4} rotated ~ 0 positioned ~ ~0.5 ~ run function asset:artifact/0789.aurora_leggings/equip/vfx
