...
# スタック毎のダメージ設定
    execute if score $Z9.Stack Temporary matches 1 run scoreboard players set $Damage Temporary 500
    execute if score $Z9.Stack Temporary matches 2 run scoreboard players set $Damage Temporary 1000
