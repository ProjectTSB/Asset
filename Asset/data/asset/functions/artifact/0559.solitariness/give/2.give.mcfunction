...
# 神器の説明文 (TextComponentString[])
    data modify storage asset:artifact Lore set value ['{"text":"セット効果：孤独"}','{"text":"孤独な時、移動速度+200%、MP回復量+50%"}','{"text":"時々自己嫌悪に陥る"}','{"text":"孤独が唯一の友人だった","color":"dark_gray"}','{"text":"みんな俺よりうまくやってる。俺はどうだ？","color":"dark_gray"}']
...
# カスタムNBT (NBTCompound) 追加で指定したいNBT (オプション)
    data modify storage asset:artifact CustomNBT set value {HideFlags:253,AttributeModifiers:[{UUID:[I;1,1,559,5],AttributeName:"generic.armor",Name:"armor",Slot:chest,Operation:0,Amount:8}],Trim:{material:"minecraft:iron",pattern:"tsb_armor:558"}}
