#> asset:artifact/0903.magic_water_accessories/attack_melee/
#
# 神器のトリガー処理
#
# @within function asset:artifact/alias/903/attack_melee/
...
# 個数を取得
    execute store result score $P3.Count Temporary run data get storage asset:context Count
