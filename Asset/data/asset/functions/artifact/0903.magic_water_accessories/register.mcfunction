#> asset:artifact/0903.magic_water_accessories/register
#
# 神器の生成処理
#
# @within function asset:artifact/alias/903/register
...
# 攻撃に関する情報 -Damage量 (literal[]/literal) Wikiを参照 (オプション)
    data modify storage asset:artifact AttackInfo.Damage set value ["§b(最大MP)"]
