...
# VFX
    execute at @e[type=#lib:living_without_player,tag=Victim,distance=..10,limit=1] run particle rain ~ ~1.2 ~ 0.3 0.3 0.3 0.05 30 normal @a[distance=..16]
    execute at @e[type=#lib:living_without_player,tag=Victim,distance=..10,limit=1] run particle dust 1 100000000 100000000 1 ~ ~1.5 ~ 0.5 0.5 0.5 0 50 normal @a[distance=..16]
    execute at @e[type=#lib:living_without_player,tag=Victim,distance=..10,limit=1] run playsound entity.dolphin.splash player @a[distance=..16] ~ ~ ~ 1 1.2 0
