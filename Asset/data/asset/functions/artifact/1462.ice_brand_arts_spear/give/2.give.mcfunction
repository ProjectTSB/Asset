#> asset:artifact/1462.ice_brand_arts_spear/give/2.give
#
# 神器の作成部 ここでID等を定義する
#
# @user
# @within function asset:artifact/1462.ice_brand_arts_spear/give/1.trigger

# 神器の説明や消費MPなどをここで設定する。
# 最後にasset:artifact/common/giveを実行することで入手可能。

# 神器のID (int) スプレッドシートの値を入れる
    data modify storage asset:artifact ID set value 1462
# 神器のベースアイテム
    data modify storage asset:artifact Item set value "minecraft:carrot_on_a_stick"
# 神器の名前 (TextComponentString)
    data modify storage asset:artifact Name set value '{"text":"アイスブランドアーツ(槍)","color":"#7DFFF2"}'
# 神器の説明文 (TextComponentString[])
    data modify storage asset:artifact Lore set value ['{"text":"アイスブランドアーツで生成した氷の槍","color":"white"}','{"text":"長射程の突きで正面の敵全体を貫く","color":"white"}','[{"text":"この神器の使用時、自身が","color":"white"},{"text":"アイシクルライン","color":"#7DFFF2"},{"text":"状態なら","color":"white"}]','{"text":"この神器の元々の消費MPの半分が戻ってくる","color":"white"}']
