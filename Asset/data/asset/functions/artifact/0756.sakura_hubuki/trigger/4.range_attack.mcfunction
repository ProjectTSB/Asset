...
# 鈍足を付与
    effect give @e[type=#lib:living_without_player,tag=!Friend,tag=!Uninterferable,tag=!Object,distance=..3] slowness 1 3 true
...
# ダメージ
    execute at @e[type=#lib:living_without_player,tag=Victim,distance=..6] as @e[type=#lib:living_without_player,tag=!Victim,tag=!Friend,tag=!Uninterferable,tag=!Object,distance=..3] at @s run function api:damage/
