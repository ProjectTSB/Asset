...
# 範囲ダメ
#
# @within function asset:artifact/0756.sakura_hubuki/attack_melee/
...
# 演出
    ...
    execute positioned ~ ~0.3 ~ rotated as @s rotated ~180 0 run function asset:artifact/0756.sakura_hubuki/attack_melee/vfx/ice_cherry_blossom
