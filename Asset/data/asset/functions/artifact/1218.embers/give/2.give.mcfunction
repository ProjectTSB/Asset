#> asset:artifact/1218.embers/give/2.give
#
# 神器の作成部 ここでID等を定義する
#
# @user
# @within function asset:artifact/1218.embers/give/1.trigger

# 神器の説明や消費MPなどをここで設定する。
# 最後にasset:artifact/common/giveを実行することで入手可能。

# 神器のID (int) スプレッドシートの値を入れる
    data modify storage asset:artifact ID set value 1218
# 神器のベースアイテム
...
# 種別クールダウン ({Type: string, Duration: int}) (オプション)
    ...
    data modify storage asset:artifact TypeCooldown.Duration set value 75
