#> asset:artifact/0973.call_rod_spirit/register
#
# 神器の生成処理
#
# @within function asset:artifact/alias/973/register
...
# 神器の説明文 (TextComponentString[])
    data modify storage asset:artifact Lore set value ['{"text":"付近の敵に魔法攻撃を行う精霊を呼び出す。","color":"white"}','{"text":"一匹までしか召喚できない。","color":"white"}','{"text":"\\"私が手伝ってあげる！\\"","color":"gray"}']
...
# 攻撃に関する情報 -Damage量 (literal[]/literal) Wikiを参照 (オプション)
    data modify storage asset:artifact AttackInfo.Damage set value [95,135]
