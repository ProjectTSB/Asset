...
# 神器の説明文 (TextComponentString[])
    data modify storage asset:artifact Lore set value ['{"text":"前方半径5m以内の敵の内部を魔力で","color":"white"}','{"text":"切断しダメージと出血を与える。","color":"white"}','{"text":"出血の効果時間は自分の現在HPが少ないほど長くなる。(最大5秒)","color":"white"}','{"text":"出血は敵に0.3秒ごとに3ダメージを与える。","color":"white"}','[{"text":"Message: ","color":"red"},{"text":"0x18 0x0302 0x0003 0x01 0x4000","color":"red","italic":true}]']
...
# MP消費量 (int) 
    data modify storage asset:artifact MPCost set value 32
# MP必要量 (int) (オプション)
