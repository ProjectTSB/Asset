...
# 神器の説明文 (TextComponentString[])
    data modify storage asset:artifact Lore set value ['{"text":"前方半径5m以内の敵の内部を魔力で切断しダメージと出血を与える。","color":"white"}','{"text":"出血の効果時間は自分の現在HPが少ないほど長くなる。","color":"white"}','[{"text":"Message: ","color":"red"},{"text":"0x18 0x0302 0x0003 0x01 0x4000","color":"red","italic":true}]']
