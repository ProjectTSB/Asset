#> asset:artifact/1141.bell_of_courage/give/2.give
#
# 神器の作成部 ここでID等を定義する
#
# @user
# @within function asset:artifact/1141.bell_of_courage/give/1.trigger

# 神器の説明や消費MPなどをここで設定する。
# 最後にasset:artifact/common/giveを実行することで入手可能。

# 神器のID (int) スプレッドシートの値を入れる
    data modify storage asset:artifact ID set value 1141
# 神器のベースアイテム
    data modify storage asset:artifact Item set value "minecraft:stick"
# 神器の名前 (TextComponentString)
    data modify storage asset:artifact Name set value '{"text":"勇気の鈴","color":"#FFFF7A"}'
# 神器の説明文 (TextComponentString[])
    data modify storage asset:artifact Lore set value ['{"text":"解除可能なデバフを1つ解除し、バリアを10得る","color":"white"}','{"text":"「おしえたでしょ、勇気がでる方法」","color":"gray","italic":true}','{"text":"「手の中の鈴をならすんだ」","color":"gray","italic":true}']
