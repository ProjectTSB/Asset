#> asset:artifact/0441.awaited_opportunity/attack_melee/message/
#
# メッセージを流す
#
...
# ランダムでメッセージを垂れ流す
    ...
    # プレイヤーが"不運"と"踊"っちまった時
        execute if score $Random Temporary matches 11 run function asset:artifact/0441.awaited_opportunity/attack_melee/message/hardluck
