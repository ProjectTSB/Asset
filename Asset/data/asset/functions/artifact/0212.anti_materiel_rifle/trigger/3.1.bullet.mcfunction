...
# 着弾
    ...
    execute if entity @s[tag=Landing] positioned ~-0.5 ~-0.5 ~-0.5 as @e[type=#lib:living,type=!player,tag=!Uninterferable,dx=0] at @s run function asset:artifact/0212.anti_materiel_rifle/trigger/3.2.bullet_damage
