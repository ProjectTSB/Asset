#> asset:artifact/1110.lantern_of_firefly/attack/schedule/vfx2
#
# 演出2
#
...
# 演出
    execute anchored eyes positioned ^ ^-1 ^ rotated ~90 30 run function asset:artifact/1110.lantern_of_firefly/attack/vfx/circle3
    execute anchored eyes positioned ^ ^-1 ^ rotated ~90 -30 run function asset:artifact/1110.lantern_of_firefly/attack/vfx/circle3
