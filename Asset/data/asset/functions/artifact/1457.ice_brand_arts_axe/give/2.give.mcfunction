...
# 神器の説明文 (TextComponentString[])
    data modify storage asset:artifact Lore set value ['{"text":"アイスブランドアーツで生成した氷の斧","color":"white"}','{"text":"敵単体に強烈な一撃をお見舞いする","color":"white"}','{"text":"生成して時間が経つほど威力が減衰する","color":"white"}']
