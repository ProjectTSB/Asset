#> asset:artifact/1028.executioner_axe/register
#
# 神器の生成処理
#
# @within function asset:artifact/alias/1028/register
...
# 神器の名前 (TextComponentString)
    data modify storage asset:artifact Name set value '{"text":"斬首斧","color":"dark_red"}'
# 神器の説明文 (TextComponentString[])
    data modify storage asset:artifact Lore set value ['{"text":"後ろを向いている敵に大ダメージを与える","color":"white"}','{"text":"この斧を振り上げし時、我は科人に永久の生を祈らん","color":"gray"}']
...
# 攻撃に関する情報 -Damage量 (literal[]/literal) Wikiを参照 (オプション)
    data modify storage asset:artifact AttackInfo.Damage set value [1550,2300]
