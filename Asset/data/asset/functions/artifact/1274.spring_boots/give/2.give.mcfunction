#> asset:artifact/1274.spring_boots/give/2.give
#
# 神器の作成部 ここでID等を定義する
#
# @user
# @within function asset:artifact/1274.spring_boots/give/1.trigger

# 神器の説明や消費MPなどをここで設定する。
# 最後にasset:artifact/common/giveを実行することで入手可能。

# 神器のID (int) スプレッドシートの値を入れる
    data modify storage asset:artifact ID set value 1274
# 神器のベースアイテム
    data modify storage asset:artifact Item set value "leather_boots"
# 神器の名前 (TextComponentString)
    data modify storage asset:artifact Name set value '{"text":"スプリングブーツ","color":"gray"}'
# 神器の説明文 (TextComponentString[])
    data modify storage asset:artifact Lore set value ['{"text":"靴の裏にバネが付いたブーツ"}','[{"text":"スニークして踏み込むと"},{"text":"ジャンプ力上昇VIII","color":"green"},{"text":"の効果を0.4秒得る"}]','{"text":"また、発動時地面に接地している場合は"}','[{"text":"落下耐性+100%","color":"green"},{"text":"の効果を2秒得る","color":"white"}]']
