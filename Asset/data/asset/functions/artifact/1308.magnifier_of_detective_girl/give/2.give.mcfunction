...
# 神器の説明文 (TextComponentString[])
    data modify storage asset:artifact Lore set value ['{"translate":"怪力を得るが、物理攻撃するたびにMPを%1$s消費する","color":"white","with":[{"text":"2"}]}','{"text":"密室殺人！ミステリーじゃないですか〜！","color":"gray"}','{"text":"高まりますね～！","color":"gray"}']
