...
# 神器の説明文 (TextComponentString[])
    data modify storage asset:artifact Lore set value ['{"text":"物理攻撃が強化されるが、物理攻撃のたびにMPを消費する","color":"white"}','{"text":"密室殺人！ミステリーじゃないですか〜！","color":"gray"}','{"text":"高まりますね～！","color":"gray"}']
