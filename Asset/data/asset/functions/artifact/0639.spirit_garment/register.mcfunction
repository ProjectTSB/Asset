#> asset:artifact/0639.spirit_garment/register
#
# 神器の生成処理
#
# @within function asset:artifact/alias/639/register
...
# 装備時補正 (Compound[]) (オプション)
    ...
    data modify storage asset:artifact Modifiers append value {Type:"heal",Amount:0.07d,Operation:"multiply_base"}
