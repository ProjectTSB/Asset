#> asset:artifact/0035.malleus_maleficarum/click/3.1.2.witchification
#
...
# 対象にタグ付け
    execute positioned ~-0.5 ~-0.5 ~-0.5 as @e[type=#lib:living,type=!player,tag=!Uninterferable,tag=!Enemy.Boss,tag=!MalleusMaleficarumIndicator,tag=!Uninterferable,dx=1,dy=1,dz=1,sort=nearest,limit=1] run tag @s add MalleusMaleficarumSacrifice
