#> asset:artifact/0035.malleus_maleficarum/click/3.1.entity_manager
#
...
#   asset:artifact/0035.malleus_maleficarum/click/3.1.entity_manager
#   asset:artifact/0035.malleus_maleficarum/click/rejoin_process


#アーマースタンドがエンダーパールの上に乗っていない状態なら命中処理
    execute as @e[type=armor_stand,tag=MalleusMaleficarumIndicator] unless predicate asset:artifact/0035.malleus_maleficarum/is_ride_on_enderpearl at @s run function asset:artifact/0035.malleus_maleficarum/click/3.1.2.witchification
