#> asset:artifact/0166.blessing_armor/register
#
# 神器の生成処理
#
# @within function asset:artifact/alias/166/register
...
# 装備時補正 (Compound[]) (オプション)
    ...
    data modify storage asset:artifact Modifiers append value {Type:"max_health",Amount:0.2d,Operation:"multiply_base"}
# 扱える神 (string[]) Wikiを参照
