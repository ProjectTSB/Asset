#> asset:artifact/0105.secret_meat/register
#
# 神器の生成処理
#
# @within function asset:artifact/alias/105/register
...
# 神器の説明文 (TextComponentString[])
    data modify storage asset:artifact Lore set value ['{"text":"食べると体力を66.6回復し"}','{"text":"攻撃+20%とMP回復量+50%を得るが"}','{"text":"回復を拒むようになる"}','{"text":"また、効果が終わった時には反動を受ける"}','{"text":"謎に包まれた肉。なんの動物かもわからない。","color":"gray"}']
