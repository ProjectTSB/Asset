#> asset:artifact/0566.great_sage_helmet/equip/fullset/tick/
#
#
#
# @within function asset:artifact/0566.great_sage_helmet/equip/fullset/tick/check

# 時間経過
    execute unless predicate lib:in_battle run scoreboard players add @s FQ.TalkTime 1

# 確率で喋る
    execute if score @s FQ.TalkTime matches 3000.. if predicate lib:random_pass_per/40 run function asset:artifact/0566.great_sage_helmet/equip/fullset/tick/talk
# 確率で好感度を1上げる
