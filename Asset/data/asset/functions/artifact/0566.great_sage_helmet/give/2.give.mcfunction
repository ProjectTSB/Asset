...
# アイテム更新をしないようにするか (boolean) (オプション)
    data modify storage asset:artifact DisabledFlag.Use.ItemUpdate set value true
# 装備時効果 (Component[]) (オプション)
    data modify storage asset:artifact Equipment.SetEffectID set value 256
# 装備時ステータス補正 (int) (オプション)
    data modify storage asset:artifact Equipment.Modifiers set value []
    data modify storage asset:artifact Equipment.Modifiers append value {Type:"attack/magic",Amount:0.075d,Operation:"multiply_base"}
    data modify storage asset:artifact Equipment.Modifiers append value {Type:"defense/magic",Amount:0.075d,Operation:"multiply_base"}
    data modify storage asset:artifact Equipment.Modifiers append value {Type:"attack/physical",Amount:-0.10d,Operation:"multiply_base"}
...
# カスタムNBT (NBTCompound) 追加で指定したいNBT (オプション)
    data modify storage asset:artifact CustomNBT set value {HideFlags:253,Unbreakable:1b,AttributeModifiers:[{AttributeName:"generic.armor",Name:"generic.armor",Amount:5,Operation:0,UUID:[I;1,1,566,6],Slot:"head"},{AttributeName:"generic.armor_toughness",Name:"generic.armor_toughness",Amount:2.5,Operation:0,UUID:[I;1,1,566,6],Slot:"head"}],Trim:{material:"minecraft:iron",pattern:"tsb_armor:566"}}
