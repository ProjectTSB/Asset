#> asset:artifact/0566.great_sage_helmet/heal/2.check_condition
#
#
#
# @within function asset:artifact/0566.great_sage_helmet/heal/1.trigger
...
# CanUsedタグをチェックして3.main.mcfunctionを実行する
    execute if entity @s[tag=CanUsed] run function asset:artifact/0566.great_sage_helmet/heal/3.main
