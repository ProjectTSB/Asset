#> asset:artifact/1017.cutlass_of_endless_silence/click/slash/second
#
#
#
# @within function asset:artifact/1017.cutlass_of_endless_silence/click/slash/

# 演出
    execute positioned ^ ^ ^1 run function asset:artifact/1017.cutlass_of_endless_silence/click/slash/vfx/2
...
# 上空へ飛ばす
    execute as @e[type=#lib:living,tag=Enemy,tag=!Immovable,tag=!Uninterferable,nbt={OnGround:1b},distance=..8] run function asset:artifact/1017.cutlass_of_endless_silence/click/slash/levitation
