#> asset:artifact/1017.cutlass_of_endless_silence/click/slash/first
#
#
#
...
# 演出
    execute positioned ^0.3 ^0.8 ^1 run function asset:artifact/1017.cutlass_of_endless_silence/click/slash/vfx/1
