#> asset:artifact/0295.call_elemental_familiar/click/fairy/
#
# ファミリアの動作部分
#
# @within asset:artifact/0295.call_elemental_familiar/click/fairy/2.tick
...
# 魔法攻撃
    execute if entity @s[scores={87.Tick=20..}] rotated ~ 0 positioned ^0.1 ^0.4 ^0.5 run function asset:artifact/0295.call_elemental_familiar/click/fairy/4.shoot
...
# 存在時間
    ...
    execute if score @s 87.LifeTime matches 0 run function asset:artifact/0295.call_elemental_familiar/click/fairy/5.disapper

# 離れ過ぎると消える
    execute unless entity @e[type=marker,tag=87.OwnerMarker,distance=..30,limit=1] run function asset:artifact/0295.call_elemental_familiar/click/fairy/5.disapper
