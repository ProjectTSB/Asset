...
# ショットのInit発動
    execute as @e[type=armor_stand,tag=87.ShotInit,distance=..0.01] at @s run function asset:artifact/0295.call_elemental_familiar/click/shot/1.init

# scheduleループ開始
    schedule function asset:artifact/0295.call_elemental_familiar/click/shot/2.tick 1t replace
