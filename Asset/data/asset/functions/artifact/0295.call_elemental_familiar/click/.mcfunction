...
# 精霊Init
    execute as @e[type=armor_stand,tag=87.FamiliarInit,distance=..5] at @s run function asset:artifact/0295.call_elemental_familiar/click/fairy/1.init
...
# 精霊さんを動かす
    schedule function asset:artifact/0295.call_elemental_familiar/click/fairy/2.tick 1t replace