#> asset:artifact/0295.call_elemental_familiar/click/shot/
#
# ショットが飛んでいく！
#
# @within function asset:artifact/0295.call_elemental_familiar/click/shot/2.tick
...
# モブに接触
    execute positioned ~-0.5 ~-0.5 ~-0.5 if entity @e[tag=Enemy,tag=!Uninterferable,dx=0,sort=nearest,limit=1] positioned ~0.5 ~0.5 ~0.5 run function asset:artifact/0295.call_elemental_familiar/click/shot/4.hit