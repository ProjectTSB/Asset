#> asset:artifact/1074.farothdal/register
#
# 神器の生成処理
#
# @within function asset:artifact/alias/1074/register
...
# 神器の説明文 (TextComponentString[])
    data modify storage asset:artifact Lore set value ['{"text":"狩人の足を意味する靴"}','{"text":"並外れた走りの力を与える"}']
...
# 装備時効果 (int) (オプション)
    data modify storage asset:artifact EquipID set value 230
# 扱える神 (string[]) Wikiを参照
