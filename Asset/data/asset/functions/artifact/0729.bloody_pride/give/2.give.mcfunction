...
# 神器の説明文 (TextComponentString[])
    data modify storage asset:artifact Lore set value ['[{"text":"体力を1.5%","color":"white"},{"text":"\\u0002","font":"space"},{"text":"+","color":"white"},{"text":"\\u0002","font":"space"},{"text":"1回復する","color":"white"}]','[{"text":"かつて誇り高き戦士がつけていた花。","color":"gray"}]','[{"text":"今はもう","color":"gray"},{"text":"鮮血","color":"dark_red"},{"text":"に染まり、無垢だった色の面影はない。","color":"gray"}]']
