...
# 神器の説明文 (TextComponentString[])
    data modify storage asset:artifact Lore set value ['[{"text":"発動時、体力を最大体力の値に応じて回復する。","color":"white"}]','[{"text":"多く持つほど回復量が増加する。","color":"white"}]','[{"text":"かつて誇り高き戦士がつけていた花。","color":"gray"}]','[{"text":"今はもう","color":"gray"},{"text":"鮮血","color":"dark_red"},{"text":"に染まり、無垢だった色の面影はない。","color":"gray"}]']
