...
# チェック
    $execute unless score $Progress Temporary matches $(Threshold).. unless score @s XW.ErrorCooldown matches 1.. run tellraw @s [{"text":"この材質の防具を加工するには攻略度が","color":"white"},{"text":"\u0002","font":"space"},{"text":"$(Threshold)%","font":"default","color":"aqua"},{"text":"\u0002","font":"space"},{"text":"必要なようだ...","font":"default","color":"white"}]
