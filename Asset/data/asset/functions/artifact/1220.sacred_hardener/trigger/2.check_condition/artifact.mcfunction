...
# 圧縮防具
    ...
    #   execute if data storage asset:context id{offhand:90} run function asset:artifact/1220.sacred_hardener/trigger/2.check_condition/check_progress.m {Threshold:00}
        execute if data storage asset:context id{offhand:91} run tag @s add XW.SetArmor
        execute if data storage asset:context id{offhand:91} run function asset:artifact/1220.sacred_hardener/trigger/2.check_condition/check_progress.m {Threshold:20}
        execute if data storage asset:context id{offhand:92} run tag @s add XW.SetArmor
        execute if data storage asset:context id{offhand:92} run function asset:artifact/1220.sacred_hardener/trigger/2.check_condition/check_progress.m {Threshold:20}
        execute if data storage asset:context id{offhand:93} run tag @s add XW.SetArmor
        execute if data storage asset:context id{offhand:93} run function asset:artifact/1220.sacred_hardener/trigger/2.check_condition/check_progress.m {Threshold:50}
