#> asset:artifact/1480.abyssal_zone/give/2.give
#
# 神器の作成部 ここでID等を定義する
#
# @user
# @within function asset:artifact/1480.abyssal_zone/give/1.trigger

# 神器の説明や消費MPなどをここで設定する。
# 最後にasset:artifact/common/giveを実行することで入手可能。

# 神器のID (int) スプレッドシートの値を入れる
    data modify storage asset:artifact ID set value 1480
# 神器のベースアイテム
    data modify storage asset:artifact Item set value "minecraft:leather_chestplate"
# 神器の名前 (TextComponentString)
    data modify storage asset:artifact Name set value '{"text":"アビサルゾーン","color":"aqua"}'
# 神器の説明文 (TextComponentString[])
    data modify storage asset:artifact Lore set value ['{"text":"ある日、荒れた海を見ると、巨大な目がこちらを見ていたんだ。"}']
...
# カスタムNBT (NBTCompound) 追加で指定したいNBT (オプション)
    data modify storage asset:artifact Equipment.Modifiers append value {Type:"attack/water",Amount:0.18d,Operation:"multiply_base"}
    data modify storage asset:artifact Equipment.Modifiers append value {Type:"defense/water",Amount:0.18d,Operation:"multiply_base"}
    ...
    data modify storage asset:artifact Equipment.Modifiers append value {Type:"attack/thunder",Amount:-0.22d,Operation:"multiply_base"}
    data modify storage asset:artifact Equipment.Modifiers append value {Type:"defense/thunder",Amount:-0.22d,Operation:"multiply_base"}
    ...
    data modify storage asset:artifact CustomNBT set value {HideFlags:68,display:{color:10283231},Unbreakable:1b}
