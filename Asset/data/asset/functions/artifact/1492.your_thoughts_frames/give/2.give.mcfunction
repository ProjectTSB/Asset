...
# 神器の説明文 (TextComponentString[])
    data modify storage asset:artifact Lore set value ['{"text":"発動時、敵が”気持ちの欠片”を近くに落とす"}','{"text":"気持ちの欠片に触れたプレイヤーはHPを5回復し"}','{"text":"10秒間MP回復量が+5%上昇する"}','{"text":"「まだ喉元に噛みつく牙はある？」","color":"gray"}']
...
# 神器の発動条件 (TextComponentString) (オプション)
    data modify storage asset:artifact Condition set value '{"text":"神器による攻撃時に3.1416%の確率で発動"}'
