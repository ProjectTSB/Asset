...
# 自身に最大HPの40%のダメージを与える
    execute store result storage api: Argument.Damage int 1 run scoreboard players get $A4.Current Temporary
