...
# 攻撃
    ...
    # レベル3
        execute if score @s[scores={Temporary=25..49}] A4.Combo matches 1 anchored eyes run function asset:artifact/0364.red_knights_sword/trigger/main_attack/combo/level_3/slash1
        execute if score @s[scores={Temporary=25..49}] A4.Combo matches 2 anchored eyes run function asset:artifact/0364.red_knights_sword/trigger/main_attack/combo/level_3/slash2
        execute if score @s[scores={Temporary=25..49}] A4.Combo matches 3 anchored eyes run function asset:artifact/0364.red_knights_sword/trigger/main_attack/combo/level_3/slash3
    # レベル4
        execute if score @s[scores={Temporary=0..24}] A4.Combo matches 1 anchored eyes run function asset:artifact/0364.red_knights_sword/trigger/main_attack/combo/level_2/slash1
        execute if score @s[scores={Temporary=0..24}] A4.Combo matches 2 anchored eyes run function asset:artifact/0364.red_knights_sword/trigger/main_attack/combo/level_2/slash2
        execute if score @s[scores={Temporary=0..24}] A4.Combo matches 3 anchored eyes run function asset:artifact/0364.red_knights_sword/trigger/main_attack/combo/level_2/slash3
