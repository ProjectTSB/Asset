#> asset:artifact/0788.aurora_armor/register
#
# 神器の生成処理
#
# @within function asset:artifact/alias/788/register
...
# 神器の説明文 (TextComponentString[])
    data modify storage asset:artifact Lore set value ['[{"text":"オーロラの抱擁をされし時","color":"#00FFE2"}]','[{"text":"雷攻撃+10% ","color":"yellow"},{"text":"MP回復+10%","color":"green"}]','[{"text":"夜空に輝くオーロラを封じ込めた鎧。","color":"gray"}]','[{"text":"その蒼翠の光は進むべき道を照らす。","color":"gray"}]']
...
# 装備時補正 (Compound[]) (オプション)
    ...
    data modify storage asset:artifact Modifiers append value {Type:"defense/thunder",Amount:0.10d,Operation:"multiply_base"}
    data modify storage asset:artifact Modifiers append value {Type:"defense/physical",Amount:-0.10d,Operation:"multiply_base"}
