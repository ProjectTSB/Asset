...
# 神器の説明文 (TextComponentString[])
    data modify storage asset:artifact Lore set value ['[{"text":"魔法耐性+5% ","color":"dark_purple"},{"text":"雷耐性+5% 雷攻撃+5%","color":"yellow"}]','[{"text":"MP回復+5% ","color":"green"},{"text":"物理耐性-5%","color":"dark_red"}]','[{"text":"オーロラの抱擁をされし時","color":"#00FFE2"}]','[{"text":"雷攻撃+10% ","color":"yellow"},{"text":"MP回復+5%","color":"green"}]','[{"text":"夜空に輝くオーロラを封じ込めた鎧。","color":"gray"}]','[{"text":"その蒼翠の光は進むべき道を照らす。","color":"gray"}]']
