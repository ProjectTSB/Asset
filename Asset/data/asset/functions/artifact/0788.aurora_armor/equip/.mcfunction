...
# 演出
    execute unless data storage asset:context id.all{head:787,chest:788,legs:789,feet:790} rotated ~ 0 positioned ~ ~1.1 ~ run function asset:artifact/0788.aurora_armor/equip/4.vfx
