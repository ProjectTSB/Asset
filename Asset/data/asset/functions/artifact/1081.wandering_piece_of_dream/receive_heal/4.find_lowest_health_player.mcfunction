#> asset:artifact/1081.wandering_piece_of_dream/receive_heal/4.find_lowest_health_player
#
# 現在体力の低いプレイヤーを検索する
#
# @within function asset:artifact/1081.wandering_piece_of_dream/receive_heal/
...
# 各プレイヤーの現在体力をスコアへ代入
    execute as @a[tag=SearchTarget] store result score @s Temporary run function asset:artifact/1081.wandering_piece_of_dream/receive_heal/5.get_health
