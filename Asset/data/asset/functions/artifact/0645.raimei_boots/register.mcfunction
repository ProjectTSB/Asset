#> asset:artifact/0645.raimei_boots/register
#
# 神器の生成処理
#
# @within function asset:artifact/alias/645/register
...
# カスタムNBT (NBTCompound) 追加で指定したいNBT (オプション)
    data modify storage asset:artifact CustomNBT set value {HideFlags:196,display:{color:16514938},Trim:{material:"gold",pattern:"tsb_armor:642"},Unbreakable:1b,AttributeModifiers:[{AttributeName:"generic.armor",Name:"generic.armor",Amount:3.5,Operation:0,UUID:[I;1,1,645,3],Slot:"feet"},{AttributeName:"generic.armor_toughness",Name:"generic.armor_toughness",Amount:1,Operation:0,UUID:[I;1,1,645,3],Slot:"feet"}]}
