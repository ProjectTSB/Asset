#> asset:artifact/1244.hardened_diamond_chestplate/give/2.give
#
# 神器の作成部 ここでID等を定義する
#
# @user
# @within function asset:artifact/1244.hardened_diamond_chestplate/give/1.trigger

# 神器の説明や消費MPなどをここで設定する。
# 最後にasset:artifact/common/giveを実行することで入手可能。

# 神器のID (int) スプレッドシートの値を入れる
    data modify storage asset:artifact ID set value 1244
# 神器のベースアイテム
    data modify storage asset:artifact Item set value "minecraft:diamond_chestplate"
# 神器の名前 (TextComponentString)
    data modify storage asset:artifact Name set value "神聖ダイヤのチェストプレート"
...
# 装備時ステータス補正 (Compound[]) (オプション)
    ...
    data modify storage asset:artifact Equipment.Modifiers append value {Type:"defense/base",Amount:0.015d,Operation:"multiply_base"}
# 扱える神 (string[]) Wikiを参照
