#> asset:artifact/0793.queen_bee_rocket/click/bee
#
# 火の玉が実行
#
# @within function asset:artifact/0793.queen_bee_rocket/click/schedule_loop
...
# 着弾処理
    execute if entity @s[tag=M1.Landing] run function asset:artifact/0793.queen_bee_rocket/click/attack
