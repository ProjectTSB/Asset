...
# MPが40%以下でダメージ1.5倍
    ...
    data modify storage api: Argument.FieldOverride.Damage set value {Slash1:200,Slash2:300,Slash3:450}
    execute if score $MPPer Temporary matches ..30 run data modify storage api: Argument.FieldOverride.Damage set value {Slash1:300,Slash2:450,Slash3:625}
