...
# 効果の付与とParticle
#
# @within function asset:artifact/0017.harmful_books/attack_melee/
...
execute if predicate lib:random_pass_per/20 run function asset:artifact/0017.harmful_books/attack_melee/debuff/levitation
