...
# Effect 386の残り効果時間が5tick以内なら成功
    ...
    execute if score $Duration Temporary matches ..5 run function asset:artifact/1584.pk_insight/damage_from_entity/3.1.success
# 失敗したらEffectも剝奪
    execute unless score $Duration Temporary matches ..5 run function asset:artifact/1584.pk_insight/damage_from_entity/3.2.failure
