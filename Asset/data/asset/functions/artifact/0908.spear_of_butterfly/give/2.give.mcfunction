...
# 神器の説明文 (TextComponentString[])
    data modify storage asset:artifact Lore set value ['[{"text":"自身の最大体力の","color":"white"},{"text":"60%","color":"dark_aqua"},{"text":"分ダメージがアップする","color":"white"}]','{"text":"自身の体力が50%未満の時","color":"white"}','[{"text":"ダメージが更に最大体力の","color":"white"},{"text":"100%","color":"dark_aqua"},{"text":"分アップする(最大200)","color":"white"}]']
