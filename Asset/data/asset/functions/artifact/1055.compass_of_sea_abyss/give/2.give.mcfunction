...
# 神器の説明文 (TextComponentString[])
    data modify storage asset:artifact Lore set value ['[{"text":"物理攻撃+10% ","color":"dark_green"},{"text":"水攻撃+10% ","color":"aqua"}]','[{"text":"ノックバック耐性+3 ","color":"white"},{"text":"最大体力-15%","color":"dark_red"}]','{"text":"遥か海底の彼方を指す羅針盤。","color":"gray"}','{"text":"その針は光無き深淵を指し示す。","color":"gray"}']
