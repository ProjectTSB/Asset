...
# api:damage/にif dataをつけているのはデバッグ中に引数Damageが足りませんと出たため
    ...
    execute if data storage api: Argument.Damage positioned ~-0.8 ~ ~-0.8 as @e[type=#lib:living,tag=Enemy,dx=0.6,dy=0.6,dz=0.6,sort=nearest,limit=1] run function api:damage/
