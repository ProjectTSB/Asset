...
# 一度200の10倍を取得し、200より大きいなら200にする
    execute store result score $Damage Temporary run attribute @s generic.max_health get 10
...
# 召喚
    ...
    execute store result storage api: Argument.FieldOverride.SwordCount int 1 run attribute @s generic.max_health get 0.05
