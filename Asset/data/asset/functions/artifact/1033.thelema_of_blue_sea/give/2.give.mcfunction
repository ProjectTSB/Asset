...
# 神器の説明文 (TextComponentString[])
    data modify storage asset:artifact Lore set value ['{"text":"自身の現在体力の100%分斬撃ダメージがアップする。"}','[{"text":"3段目の攻撃後、"},{"text":"蒼波の剣","color":"#3DFFF9"},{"text":"による追撃を行う。"}]','[{"text":"蒼波の剣","color":"#3DFFF9"},{"text":"は自身の最大体力の160%分のダメージを与え、","color":"white"}]','[{"text":"最大体力1列ごとに1本増加する。(最大10本)","color":"white"}]','{"text":"神の意志宿せし蒼海の剣。","color":"gray"}','{"text":"海の息吹に導かれ、祝福の光を灯す。","color":"gray"}']
