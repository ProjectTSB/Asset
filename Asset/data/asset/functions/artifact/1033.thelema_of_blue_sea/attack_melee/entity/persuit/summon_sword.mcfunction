#> asset:artifact/1033.thelema_of_blue_sea/attack_melee/entity/persuit/summon_sword
#
# 剣を召喚する
#
# @within function asset:artifact/1033.thelema_of_blue_sea/attack_melee/entity/persuit/main
