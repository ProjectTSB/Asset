...
# entityのinit処理
    execute as @e[type=area_effect_cloud,tag=SP.Init,distance=..6,limit=2] at @s run function asset:artifact/1033.thelema_of_blue_sea/attack_melee/entity/init
...
# スケジュールループを起動
    schedule function asset:artifact/1033.thelema_of_blue_sea/attack_melee/entity/loop 1t replace
    schedule function asset:artifact/1033.thelema_of_blue_sea/attack_melee/loop 1t replace
