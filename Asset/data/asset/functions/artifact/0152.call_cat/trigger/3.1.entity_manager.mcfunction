...
# 近くにプレイヤーが居たら回復
    execute at @e[type=cat,tag=48.CalledCat] if entity @a[gamemode=!spectator,scores={48.CatTime=20},distance=..2.5,limit=1] as @a[gamemode=!spectator,scores={48.CatTime=20},distance=..2.5] run function asset:artifact/0152.call_cat/trigger/3.1.1.heal
