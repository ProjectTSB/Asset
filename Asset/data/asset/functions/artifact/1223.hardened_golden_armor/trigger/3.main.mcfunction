#> asset:artifact/1223.hardened_golden_armor/trigger/3.main
#
# 神器のメイン処理部
#
# @within function asset:artifact/1223.hardened_golden_armor/trigger/2.check_condition
...
# 頭
    data modify storage api: Argument.ID set value 1239
...
# 胴
    data modify storage api: Argument.ID set value 1240
...
# 脚
    data modify storage api: Argument.ID set value 1241
...
# 足
    data modify storage api: Argument.ID set value 1242
