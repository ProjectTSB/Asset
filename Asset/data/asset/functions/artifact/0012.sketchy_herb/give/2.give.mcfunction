...
# 神器の説明文 (TextComponentString[])
    data modify storage asset:artifact Lore set value ['{"text":"攻撃+10%、耐性+10%、MP回復量+10%を30秒間得るが","color":"white"}','{"text":"使用し続けないとデバフを得てしまう","color":"white"}','{"text":"不思議な草だ。とても怪しい匂いがする","color":"gray"}','{"text":"「キマってきた？」","color":"#333333"}']
