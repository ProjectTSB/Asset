...
# 神器の説明文 (TextComponentString[])
    data modify storage asset:artifact Lore set value ['{"text":"オーロラの天使の持っていた刀。","color":"gray"}','{"text":"その刃は常闇を照らす蒼翠の軌跡を描く。","color":"gray"}','{"text":"現在MPの120%をダメージに加算する。","color":"white"}']
