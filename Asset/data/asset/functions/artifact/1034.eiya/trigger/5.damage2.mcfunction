...
# ターゲット設定
    ...
    execute positioned ^2 ^ ^0.5 run tag @e[type=#lib:living,type=!player,distance=..2.5] add Target
    execute positioned ^ ^ ^2.5 run tag @e[type=#lib:living,type=!player,distance=..3.5] add Target
    execute positioned ^-2 ^ ^0.5 run tag @e[type=#lib:living,type=!player,distance=..2.5] add Target
