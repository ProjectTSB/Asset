...
# 神器の生成処理
#
# @within function asset:artifact/alias/375/register
...
# 神器の説明文 (TextComponentString[])
    data modify storage asset:artifact Lore set value ['{"text":"電気の術式を宿した杖。"}','{"text":"敵にやや強力な魔法雷属性ダメージを与える"}']
...
# MP回復量
    data modify storage asset:artifact MPHealWhenHit set value 11.5
# 神器のクールダウン (int) (オプション)
