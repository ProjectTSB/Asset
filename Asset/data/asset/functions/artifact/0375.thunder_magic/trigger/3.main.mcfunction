...
# 前方に敵が居た場合
    execute positioned ^ ^ ^7 if entity @e[type=#lib:living,tag=Target,distance=..7] at @s at @e[type=#lib:living,tag=Target,distance=..7,sort=nearest,limit=1] run function asset:artifact/0375.thunder_magic/trigger/damage
