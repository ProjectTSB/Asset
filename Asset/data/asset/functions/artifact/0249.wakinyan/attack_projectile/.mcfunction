#> asset:artifact/0249.wakinyan/attack_projectile/
#
# 神器のトリガー処理
#
...
# ダメージ
    ...
    execute as @e[type=#lib:living,type=!player,tag=Victim,distance=..100,limit=1] at @s run function asset:artifact/0249.wakinyan/attack_projectile/4.damage
