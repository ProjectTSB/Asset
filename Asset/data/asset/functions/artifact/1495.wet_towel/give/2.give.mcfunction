#> asset:artifact/1495.wet_towel/give/2.give
#
# 神器の作成部 ここでID等を定義する
#
# @user
# @within function asset:artifact/1495.wet_towel/give/1.trigger

# 神器の説明や消費MPなどをここで設定する。
# 最後にasset:artifact/common/giveを実行することで入手可能。

# 神器のID (int) スプレッドシートの値を入れる
    data modify storage asset:artifact ID set value 1495
# 神器のベースアイテム
    data modify storage asset:artifact Item set value "minecraft:stick"
# 神器の名前 (TextComponentString)
    data modify storage asset:artifact Name set value '{"text":"べちょべちょタオル","color":"#3E53FF"}'
# 神器の説明文 (TextComponentString[])
    data modify storage asset:artifact Lore set value ['[{"text":"装備すると火耐性が15%上昇する"}]','[{"text":"火属性攻撃を25回受けるとふかふかタオルに変化する"}]','[{"text":"...雑巾？","color":"gray","italic":true}]']
