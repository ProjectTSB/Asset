#> asset:artifact/1058.great_demon_chest/register
#
# 神器の生成処理
#
# @within function asset:artifact/alias/1058/register
...
# 装備時補正 (Compound[]) (オプション)
    ...
    data modify storage asset:artifact Modifiers append value {Type:"attack/physical",Amount:0.5d,Operation:"multiply_base"}
