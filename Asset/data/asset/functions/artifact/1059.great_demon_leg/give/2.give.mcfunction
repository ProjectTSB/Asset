...
# 神器の説明文 (TextComponentString[])
    data modify storage asset:artifact Lore set value ['[{"text":"物理攻撃+10% 物理耐性+5%","color":"dark_green"}]','[{"text":"魔法攻撃-5% 魔法耐性-5%","color":"dark_red"}]','[{"text":"人々に倒された鬼は地下に幽閉された","color":"#A6A6A6","italic":true}]']
