...
# 珊瑚の演出
    execute rotated ~ 0 positioned ^-1.5 ^0.4 ^1.5 rotated ~45 -60 run function asset:artifact/0711.deep_sea_coral_crown/equip/fullset/vfx/1
    execute rotated ~ 0 positioned ^-1.5 ^0.4 ^-1.5 rotated ~135 -60 run function asset:artifact/0711.deep_sea_coral_crown/equip/fullset/vfx/2
    execute rotated ~ 0 positioned ^1.5 ^0.4 ^-1.5 rotated ~225 -60 run function asset:artifact/0711.deep_sea_coral_crown/equip/fullset/vfx/3
    execute rotated ~ 0 positioned ^1.5 ^0.4 ^1.5 rotated ~315 -60 run function asset:artifact/0711.deep_sea_coral_crown/equip/fullset/vfx/4
...
# スケジュールループ開始
    schedule function asset:artifact/0711.deep_sea_coral_crown/equip/fullset/loop 1t replace