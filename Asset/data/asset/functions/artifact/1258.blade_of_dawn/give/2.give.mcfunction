...
# 神器の名前 (TextComponentString)
    data modify storage asset:artifact Name set value '{"text":"黎明の刃","color":"#FF9C45"}'
# 神器の説明文 (TextComponentString[])
    data modify storage asset:artifact Lore set value ['{"text":"炎の天使の持っていた対の一刃","color":"gray"}','{"text":"夜明けの如く宵闇を裂く光を宿している","color":"gray"}']
...
# 攻撃に関する情報 -Damage量 (literal[]/literal) Wikiを参照 (オプション)
    data modify storage asset:artifact AttackInfo.Damage set value [135,235]
...
# MP回復量 (int)
    data modify storage asset:artifact MPHealWhenHit set value 7.1
# 神器のクールダウン (int) (オプション)
