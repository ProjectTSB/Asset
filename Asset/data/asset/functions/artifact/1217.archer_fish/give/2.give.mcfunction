...
# 神器の説明文 (TextComponentString[])
    data modify storage asset:artifact Lore set value ['{"text":"矢の代わりに敵に誘導する魚を発射する","color":"white"}','{"text":"フルチャージ時は魚群を発射する","color":"white"}','{"text":"えーっと...これについて知ってる人いない？","color":"dark_gray"}']
