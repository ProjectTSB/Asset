...
# 装備時効果 (int) (オプション)
    data modify storage asset:artifact Equip.SetID set value 233
# 装備時ステータス補正 (Compound[]) (オプション)
    data modify storage asset:artifact Equip.Modifiers set value []
    data modify storage asset:artifact Equip.Modifiers append value {Type:"attack/fire",Amount:0.01d,Operation:"multiply_base"}
    data modify storage asset:artifact Equip.Modifiers append value {Type:"defense/fire",Amount:0.02d,Operation:"multiply_base"}
# 扱える神 (string[]) Wikiを参照
