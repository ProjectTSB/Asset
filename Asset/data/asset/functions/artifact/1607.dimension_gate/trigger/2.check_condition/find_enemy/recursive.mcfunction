#> asset:artifact/1607.dimension_gate/trigger/2.check_condition/find_enemy/recursive
#
#
#
# @within function
#   asset:artifact/1607.dimension_gate/trigger/2.check_condition/find_enemy/
#   asset:artifact/1607.dimension_gate/trigger/2.check_condition/find_enemy/recursive
...
# 再帰
    execute at @s run function asset:artifact/1607.dimension_gate/trigger/2.check_condition/find_enemy/recursive
