...
# 視線先から再帰
    execute as @e[type=marker,tag=RecursiveMarker,distance=..5] at @s positioned ^ ^ ^-0.5 run function asset:artifact/1607.dimension_gate/trigger/2.check_condition/find_enemy/recursive
