...
# 神器の説明文 (TextComponentString[])
    data modify storage asset:artifact Lore set value ['{"text":"体力が全回復する","color":"white"}','{"text":"先祖を思い出せ","color":"gray","italic":true}']
...
# 神器の発動条件 (TextComponentString) (オプション)
    data modify storage asset:artifact Condition set value '{"text":"アイテムを何一つ所持していない"}'
