#> asset:artifact/0537.all_night_boots/register
#
# 神器の生成処理
#
# @within function asset:artifact/alias/537/register
...
# カスタムNBT (NBTCompound) 追加で指定したいNBT (オプション)
    data modify storage asset:artifact CustomNBT set value {HideFlags:196,Trim:{material:"gold",pattern:"tsb_armor:534"},Unbreakable:1b,display:{color:1050959},Enchantments:[{id:"minecraft:protection",lvl:1s}],AttributeModifiers:[{AttributeName:"generic.armor",Name:"generic.armor",Amount:2,Operation:0,UUID:[I;1,1,537,3],Slot:"feet"}]}
