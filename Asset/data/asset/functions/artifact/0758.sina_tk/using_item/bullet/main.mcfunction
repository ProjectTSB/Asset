...
#
#
# @within function asset:artifact/0758.sina_tk/using_item/bullet/loop
...
# 再帰処理で前方に進む
    function asset:artifact/0758.sina_tk/using_item/bullet/recursive
...
# スケジュールループ
    schedule function asset:artifact/0758.sina_tk/using_item/bullet/loop 1t replace
