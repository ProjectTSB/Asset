...
# 神器の生成処理
#
# @within function asset:artifact/alias/648/register
...
# 装備時補正 (Compound[]) (オプション)
    ...
    data modify storage asset:artifact Modifiers append value {Type:"defense/water",Amount:0.04d,Operation:"multiply_base"}
