#> asset:artifact/1453.frost_flake_bow/trigger/2.check_condition
#
# 神器の発動条件をチェックします
#
# @within function asset:artifact/1453.frost_flake_bow/trigger/1.trigger
...
# CanUsedタグをチェックして3.main.mcfunctionを実行する
    execute if entity @s[tag=CanUsed] run function asset:artifact/1453.frost_flake_bow/trigger/3.main
