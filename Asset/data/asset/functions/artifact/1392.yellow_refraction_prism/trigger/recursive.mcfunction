#> asset:artifact/1392.yellow_refraction_prism/trigger/recursive
#
#
#
# @within function
...
# 要素がある && 一致してないなら再帰
    execute if data storage asset:temp Temp.To[0] unless score @s MobUUID = $TempID Temporary run function asset:artifact/1392.yellow_refraction_prism/trigger/recursive
