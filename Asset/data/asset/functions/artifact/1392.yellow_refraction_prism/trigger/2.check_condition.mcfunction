#> asset:artifact/1392.yellow_refraction_prism/trigger/2.check_condition
#
# 神器の発動条件をチェックします
#
# @within function asset:artifact/1392.yellow_refraction_prism/trigger/1.trigger

# ID指定する
    data modify storage asset:artifact TargetID set value 1392
...
# 3.main.mcfunctionを実行する
    function asset:artifact/1392.yellow_refraction_prism/trigger/3.main

# リセット
    function asset:artifact/1392.yellow_refraction_prism/trigger/2.check_condition/reset
