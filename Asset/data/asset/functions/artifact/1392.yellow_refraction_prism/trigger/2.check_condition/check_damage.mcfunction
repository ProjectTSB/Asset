...
# 対象選定
    execute as @e[type=#lib:living_without_player,tag=Victim,tag=Enemy,distance=..64,sort=nearest,limit=3] run function asset:artifact/1392.yellow_refraction_prism/trigger/2.check_condition/get_damage/pre
