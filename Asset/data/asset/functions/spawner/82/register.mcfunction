...
execute unless loaded 182 38 -38 run return 1
...
# SpawnPotentials(int | int[] | ({ Weight: int, Id: int })[]) MobAssetのIDを指定する
    data modify storage asset:spawner SpawnPotentials set value [{Id:26,Weight:10},{Id:64,Weight:10},{Id:21,Weight:1}]
# 一度に召喚する数 (int)
