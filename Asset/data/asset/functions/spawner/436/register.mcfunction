...
execute unless loaded -64 173 186 run return 1
...
# SpawnPotentials(int | int[] | ({ Weight: int, Id: int })[]) MobAssetのIDを指定する
    data modify storage asset:spawner SpawnPotentials set value [{Id:74,Weight:8},{Id:235,Weight:8},{Id:280,Weight:4}]
# 一度に召喚する数 (int)
