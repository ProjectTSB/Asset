...
execute unless loaded -31 42 -128 run return 1
...
# SpawnPotentials(int | int[] | ({ Weight: int, Id: int })[]) MobAssetのIDを指定する
    data modify storage asset:spawner SpawnPotentials set value [{Id:115,Weight:8},{Id:191,Weight:8},{Id:188,Weight:4}]
# 一度に召喚する数 (int)
