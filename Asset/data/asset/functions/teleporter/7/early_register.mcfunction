#> asset:teleporter/7/early_register
#
#
#
...
# ID (int)
    data modify storage asset:teleporter Teleporters[-1].ID set value 7
...
# Pos ([int] @ 3)
    data modify storage asset:teleporter Teleporters[-1].Data.Pos set value [94, 15, 83]
# GroupIDs ([string])
