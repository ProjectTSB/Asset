#> asset:teleporter/58/register
#
# テレポーターの定義データ
#
# @within function asset:teleporter/58/


execute unless loaded 100 107 2922 run return 1

# ID (int)
    data modify storage asset:teleporter ID set value 58
# Dimension (string[minecraft:dimension])
    data modify storage asset:teleporter Dimension set value "minecraft:the_end"
# Pos ([int] @ 3)
    data modify storage asset:teleporter Pos set value [100, 107, 2922]
# GroupIDs ([string])
