...
# テレポーターの定義データ
#
# @within function asset:teleporter/55/


execute unless loaded -203 145 393 run return 1
...
# Pos ([int] @ 3)
    data modify storage asset:teleporter Pos set value [-203, 145, 393]
# GroupIDs ([string])
    data modify storage asset:teleporter GroupIDs set value ["arena-55"]
