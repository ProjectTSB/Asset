#> asset:teleporter/43/early_register
#
#
#
...
# ID (int)
    data modify storage asset:teleporter Teleporters[-1].ID set value 43
...
# Pos ([int] @ 3)
    data modify storage asset:teleporter Teleporters[-1].Data.Pos set value [250, 138, 126]
# GroupIDs ([string])
