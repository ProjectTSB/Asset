#> asset:teleporter/21/early_register
#
#
#
...
# ID (int)
    data modify storage asset:teleporter Teleporters[-1].ID set value 21
...
# Pos ([int] @ 3)
    data modify storage asset:teleporter Teleporters[-1].Data.Pos set value [180, 81, 41]
# GroupIDs ([string])
