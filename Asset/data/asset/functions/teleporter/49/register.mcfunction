#> asset:teleporter/49/register
#
# テレポーターの定義データ
#
# @within function asset:teleporter/49/


execute unless loaded 462 232 -151 run return 1

# ID (int)
    data modify storage asset:teleporter ID set value 49
# Dimension (string[minecraft:dimension])
    data modify storage asset:teleporter Dimension set value "minecraft:overworld"
# Pos ([int] @ 3)
    data modify storage asset:teleporter Pos set value [462, 232, -151]
# GroupIDs ([string])
