#> asset:mob/0412.tiamat/tick/event/offering/effect
#
# ソウルオファリング
#
# @within
#    function asset:mob/0412.tiamat/tick/event/offering/
#    function asset:mob/0412.tiamat/tick/event/offering_end/
