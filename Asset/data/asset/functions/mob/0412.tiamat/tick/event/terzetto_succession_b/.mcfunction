...
# アイシクルダイブ
    ...
    # 攻撃
        execute if score @s BG.EventTimer matches 154 if predicate api:global_vars/difficulty/max/2_hard at @s positioned ~ ~0.5 ~ run function asset:mob/0412.tiamat/tick/event/terzetto_succession_b/dive_prediction_long
