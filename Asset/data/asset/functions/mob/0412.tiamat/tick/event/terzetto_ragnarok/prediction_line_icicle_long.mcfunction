#> asset:mob/0412.tiamat/tick/event/terzetto_ragnarok/prediction_line_icicle_long
#
# テルツェット・ラグナレク
#
# @within asset:mob/0412.tiamat/tick/event/terzetto_ragnarok/prediction_0_icicle_long
