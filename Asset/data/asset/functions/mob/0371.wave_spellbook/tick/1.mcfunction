#> asset:mob/0371.wave_spellbook/tick/1
#
# Mobのtick時の処理
#
# @within function asset:mob/0371.wave_spellbook/_/tick
...
# 攻撃
    execute if entity @s[scores={AB.Tick=0..}] run function asset:mob/0371.wave_spellbook/tick/2.ready
