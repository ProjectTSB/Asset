...
#
# @within function asset:mob/0353.rubiel_knife/tick/
...
# ブロックへの着弾時、消去
    execute unless block ^ ^ ^0.5 #lib:no_collision run playsound item.trident.hit_ground hostile @a ~ ~ ~ 1 1.5
    execute unless block ^ ^ ^0.5 #lib:no_collision run tag @s add 9T.Hit
