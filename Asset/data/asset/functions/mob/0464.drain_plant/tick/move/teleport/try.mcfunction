...
# マーカーをワープさせて、そこが安全地帯かどうか判定する
    ...
    execute positioned as @e[type=marker,tag=SpreadMarker,distance=..10,limit=1] align xz positioned ~0.5 ~ ~0.5 run function asset:mob/0464.drain_plant/tick/move/teleport/check_y/
