...
# ズル対策
    ...
    execute if score $IntervalTime Temporary matches 0 positioned ~-15 ~3.75 ~-15 at @a[tag=!PlayerShouldInvulnerable,dx=29,dy=25,dz=29] positioned ~ ~1 ~ run function asset:mob/0390.triple_rabbits/ai/general/summon_bullet
