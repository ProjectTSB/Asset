...
# 一定範囲内にいたらスコア増加
    execute positioned ~-25 ~3.75 ~-25 if entity @s[dx=50,dy=25,dz=50] run scoreboard players add @s AU.PenaltyTick 1

# 一定範囲内にいなければスコアをリセット
    execute positioned ~-25 ~3.75 ~-25 unless entity @s[dx=50,dy=25,dz=50] run scoreboard players reset @s AU.PenaltyTick
