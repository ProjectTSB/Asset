...
# 付近にプレイヤーがいるなら
#
# @within function asset:mob/0321.mini_guardian/tick/
...
# 攻撃終了後、ちょっと泳ぐ
    execute at @s if score @s 8X.Tick matches 160..240 run function asset:mob/call.m {method:"rotate"}
    execute at @s if score @s 8X.Tick matches 160..240 run function asset:mob/call.m {method:"move"}
