#> asset:mob/0374.gray_coffin/register
#
# Mobのデータを指定
#
# @within function asset:mob/alias/374/register
...
# ID (int)
    data modify storage asset:mob ID set value 374
# Type (string) Wikiを参照
    data modify storage asset:mob Type set value "Enemy"
# 干渉可能か否か (boolean)
    data modify storage asset:mob Interferable set value true
# 名前 (TextComponentString) (オプション)
    data modify storage asset:mob Name set value '{"text":"灰の棺","color":"gold"}'
...
# 体力 (double) (オプション)
    data modify storage asset:mob Health set value 2400d
# 攻撃力 (double) (オプション)
