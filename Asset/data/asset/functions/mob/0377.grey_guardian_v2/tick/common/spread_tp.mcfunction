#> asset:mob/0377.grey_guardian_v2/tick/common/spread_tp
#
#
#
# @within function asset:mob/0377.grey_guardian_v2/tick/common/tp
...
# ディスプレイもってくる用
    execute at @s run function asset:mob/0377.grey_guardian_v2/tick/common/tp
