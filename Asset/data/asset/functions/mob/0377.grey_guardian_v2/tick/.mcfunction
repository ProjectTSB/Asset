...
# その後発動するスキル
# プレイヤーが周囲にいたらスキル選択
    execute if score @s AH.Tick matches 0 if entity @s[tag=!AH.Opening] if entity @p[gamemode=!spectator,distance=..100] run function asset:mob/0377.grey_guardian_v2/tick/skill_select
