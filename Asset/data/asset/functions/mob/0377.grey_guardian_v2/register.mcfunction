#> asset:mob/0377.grey_guardian_v2/register
#
# Mobのデータを指定
#
# @within function asset:mob/alias/377/register
...
# ID (int)
    data modify storage asset:mob ID set value 377
# Type (string) Wikiを参照
...
# 体力 (double) (オプション)
    data modify storage asset:mob Health set value 300000
# 攻撃力 (double) (オプション)
