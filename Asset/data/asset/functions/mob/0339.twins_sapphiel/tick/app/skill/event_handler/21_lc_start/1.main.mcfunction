...
# 演出
    execute if score @s 9F.AnimationTimer matches 1 run playsound item.armor.equip_iron hostile @a ~ ~ ~ 2 1
    execute if score @s 9F.AnimationTimer matches 5 run playsound item.armor.equip_iron hostile @a ~ ~ ~ 2 1
    execute if score @s 9F.AnimationTimer matches 10 run playsound item.armor.equip_iron hostile @a ~ ~ ~ 2 1
