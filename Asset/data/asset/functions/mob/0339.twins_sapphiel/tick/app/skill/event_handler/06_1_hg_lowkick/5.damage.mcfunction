...
# 転倒
    execute as @a[tag=9F.Temp.Target.Attack] at @s align xyz positioned ~0.5 ~0.5 ~0.5 run function asset:mob/0339.twins_sapphiel/tick/app/skill/event_handler/06_1_hg_lowkick/5.1.damage_down
