...
# 攻撃
    execute if score @s 9F.AnimationTimer matches 30 at @s positioned ^-0.1 ^1 ^1 facing entity @p eyes run function asset:mob/0339.twins_sapphiel/app/attack/1.shot_weak
    execute if score @s 9F.AnimationTimer matches 34 at @s positioned ^-0.1 ^1 ^1 facing entity @p eyes run function asset:mob/0339.twins_sapphiel/app/attack/1.shot
