...
# 終了
    execute if score @s 9F.AnimationTimer matches 65 run function asset:mob/0339.twins_sapphiel/tick/app/skill/event_handler/06_hg_punch/4.change_to_lowkick
