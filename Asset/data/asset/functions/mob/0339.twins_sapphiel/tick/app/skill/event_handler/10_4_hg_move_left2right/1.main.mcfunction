#> asset:mob/0339.twins_sapphiel/tick/app/skill/event_handler/10_4_hg_move_left2right/1.main
#
# アニメーションのイベントハンドラ Hgステップ・左右
# サフィから見て左→右の順に素早く移動する
#
# @within function asset:mob/0339.twins_sapphiel/tick/app/skill/event_handler/1.switch

# アニメーション再生 (長さ：10tick)
    execute if score @s 9F.AnimationTimer matches 1 run function asset:mob/0339.twins_sapphiel/tick/app/skill/event_handler/10_4_hg_move_left2right/3.1.play_animation
...
# アニメーション再生 (長さ：15tick)
    execute if score @s 9F.AnimationTimer matches 9 run function asset:mob/0339.twins_sapphiel/tick/app/skill/event_handler/10_4_hg_move_left2right/3.2.play_animation
...
# 終了
    execute if score @s 9F.AnimationTimer matches 25.. run function asset:mob/0339.twins_sapphiel/tick/app/skill/event_handler/10_4_hg_move_left2right/2.end
