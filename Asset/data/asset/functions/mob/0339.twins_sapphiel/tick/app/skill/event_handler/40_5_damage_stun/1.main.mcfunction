#> asset:mob/0339.twins_sapphiel/tick/app/skill/event_handler/40_5_damage_stun/1.main
#
...
# 演出
    ...
    execute if score @s 9F.AnimationTimer matches 15 run particle crit ^ ^1.6 ^-0.1 0.2 0 0.2 0.1 3
    execute if score @s 9F.AnimationTimer matches 25 run particle crit ^ ^1.6 ^-0.1 0.2 0 0.2 0.1 3

# 終了
    execute if score @s 9F.AnimationTimer matches 31.. run function asset:mob/0339.twins_sapphiel/tick/app/skill/event_handler/40_5_damage_stun/2.end
