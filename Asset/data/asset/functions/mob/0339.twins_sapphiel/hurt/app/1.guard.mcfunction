...
# カウンター一定以上の場合、強制反撃
    ...
    execute if predicate api:global_vars/difficulty/min/hard if score @s 9F.GuardCount matches 3.. run function asset:mob/0339.twins_sapphiel/hurt/app/3.counter
