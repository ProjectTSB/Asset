...
# ハード限定、偏差する可能性がある
    execute if predicate api:global_vars/difficulty/min/3_blessless if predicate lib:random_pass_per/10 run function asset:mob/0123.lexiel_v3/tick/common/thunder/predict
