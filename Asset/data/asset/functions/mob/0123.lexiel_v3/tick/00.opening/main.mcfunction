...
# 演出
    execute if score @s General.Mob.Tick matches 22 run playsound minecraft:item.trident.return hostile @p ~ ~ ~ 3 0.6
    execute if score @s General.Mob.Tick matches 22 run playsound minecraft:entity.evoker.cast_spell hostile @p ~ ~ ~ 3 1.5
