...
# 演出
    execute if score @s 3F.Tick matches 20 run playsound minecraft:entity.warden.sonic_charge hostile @a ~ ~ ~ 1 1.3
    execute if score @s 3F.Tick matches 20 run playsound minecraft:block.respawn_anchor.charge hostile @a ~ ~ ~ 1 0
