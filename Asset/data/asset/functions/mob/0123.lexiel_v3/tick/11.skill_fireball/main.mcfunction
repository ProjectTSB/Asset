...
# ハードだともうちょっと出る
    execute if score @s General.Mob.Tick matches 24..26 positioned ~ ~1 ~ positioned ^ ^ ^1 if predicate api:global_vars/difficulty/min/hard run function asset:mob/0123.lexiel_v3/tick/common/fireball
