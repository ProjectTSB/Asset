...
# 怯み受け付け
    execute if score @s 9G.AnimationTimer matches 1 run tag @s add 9G.State.Damage.Accept
    execute if score @s 9G.AnimationTimer matches 47 run tag @s remove 9G.State.Damage.Accept
