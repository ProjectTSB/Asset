...
# 移動
    execute if score @s 9G.AnimationTimer matches 1..44 run function asset:mob/0340.twins_rubiel/app/general/2.rotate
    execute if score @s 9G.AnimationTimer matches 1..6 at @s positioned ^0.8 ^ ^-0.2 run function asset:mob/0340.twins_rubiel/app/general/3.teleport
    execute if score @s 9G.AnimationTimer matches 7..23 at @s positioned ^0.8 ^ ^ run function asset:mob/0340.twins_rubiel/app/general/3.teleport
