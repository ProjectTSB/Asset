...
# 着地点
    execute if entity @a[tag=!PlayerShouldInvulnerable,distance=..30] positioned as @a[tag=!PlayerShouldInvulnerable,distance=..30,sort=nearest,limit=1] as @e[type=area_effect_cloud,tag=9G.Temp.Target.Aec.0,sort=nearest,limit=1] run tp @s ^ ^0.5 ^-3
