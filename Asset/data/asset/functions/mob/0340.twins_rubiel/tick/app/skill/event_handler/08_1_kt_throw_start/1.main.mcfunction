...
# 怯み受け付け
    execute if score @s 9G.AnimationTimer matches 60 run tag @s add 9G.State.Damage.Accept
    execute if score @s 9G.AnimationTimer matches 100 run tag @s remove 9G.State.Damage.Accept
