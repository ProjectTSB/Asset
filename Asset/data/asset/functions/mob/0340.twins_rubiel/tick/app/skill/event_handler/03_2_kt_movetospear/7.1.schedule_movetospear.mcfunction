...
# 着地したプレイヤーにて実行
    execute as @a[tag=9G.Temp.Target.JumpAvoid] at @s unless block ~ ~-0.2 ~ #lib:no_collision run function asset:mob/0340.twins_rubiel/tick/app/skill/event_handler/03_2_kt_movetospear/7.2.schedule_player_land
