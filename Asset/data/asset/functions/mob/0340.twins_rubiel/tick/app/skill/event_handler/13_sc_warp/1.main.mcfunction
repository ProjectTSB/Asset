...
## 攻撃
# 移動
    execute if score @s 9G.AnimationTimer matches 60 positioned as @e[type=area_effect_cloud,tag=9G.Temp.Target.Warp.2,sort=random,limit=1] facing entity @p feet run tp @s ~ ~ ~ ~ 0
...
## 斬り上げ
# 移動
    execute if score @s 9G.AnimationTimer matches 80 positioned as @e[type=area_effect_cloud,tag=9G.Temp.Target.Warp.1,sort=random,limit=1] facing entity @p feet run tp @s ~ ~ ~ ~ 0
...
## 投げ
# 移動
    execute if score @s 9G.AnimationTimer matches 100 positioned as @e[type=area_effect_cloud,tag=9G.Temp.Target.Warp.0,sort=random,limit=1] facing entity @p feet run tp @s ~ ~ ~ ~ 0
...
# 攻撃
    execute if score @s 9G.AnimationTimer matches 110 positioned ^ ^1 ^1 run function asset:mob/0340.twins_rubiel/tick/app/skill/event_handler/13_sc_warp/5.1.damage_slash

## 斬り上げ
# 移動
    execute if score @s 9G.AnimationTimer matches 120 positioned as @e[type=area_effect_cloud,tag=9G.Temp.Target.Warp.2,sort=random,limit=1] facing entity @p feet run tp @s ~ ~ ~ ~ 0
...
## 終了
# 移動
    execute if score @s 9G.AnimationTimer matches 140 positioned as @e[type=area_effect_cloud,tag=9G.Temp.Target.Warp.1,sort=random,limit=1] facing entity @p feet run tp @s ~ ~ ~ ~ 0
