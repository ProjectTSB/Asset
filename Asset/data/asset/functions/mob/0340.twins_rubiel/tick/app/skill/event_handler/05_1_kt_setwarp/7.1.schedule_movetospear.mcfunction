...
# 再帰
    execute if entity @a[tag=9G.Temp.Target.JumpAvoid,limit=1] run schedule function asset:mob/0340.twins_rubiel/tick/app/skill/event_handler/05_1_kt_setwarp/7.1.schedule_movetospear 1t replace
