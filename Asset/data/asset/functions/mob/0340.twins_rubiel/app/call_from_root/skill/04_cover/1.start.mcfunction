#> asset:mob/0340.twins_rubiel/app/call_from_root/skill/04_cover/1.start
#
# root側から呼び出される処理 スキル開始・怯みかばい
#
# @within
#    function asset:mob/0338.corundum_twins/tick/app/skill/event_handler/04_1_rubiel_cover/1.main
