#> asset:mob/0219.aorta/register
#
# Mobのデータを指定
#
# @within function asset:mob/alias/219/register
...
# Mobの説明文 (TextComponentString[]) (オプション)
    data modify storage asset:mob Lore set value ['{"text":"大動脈の力を宿したモンスター。","color":"white"}','{"text":"体力が減ってくると自爆し、周囲の敵を回復することがある。","color":"white"}']
# 武器
