#> asset:mob/0337.shower_of_cherry_blossoms/summon/2.summon
#
# Mobの召喚時の処理
#
# @within function asset:mob/0337.shower_of_cherry_blossoms/summon/1.trigger

# 元となるMobを召喚する
    summon marker ~ ~ ~ {Tags:["MobInit","9D.Cherry"]}
# ID (int)
