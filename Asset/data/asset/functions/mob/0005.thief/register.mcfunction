#> asset:mob/0005.thief/register
# @within asset:mob/alias/5/register
...
# 体力 (double) (オプション)
    data modify storage asset:mob Health set value 15.0
# 攻撃力 (double) (オプション)
    data modify storage asset:mob AttackDamage set value 1.5
