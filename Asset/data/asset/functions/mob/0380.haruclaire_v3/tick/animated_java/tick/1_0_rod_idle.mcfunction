...
# 演出
    ...
    # execute if score @s aj.1_0_rod_idle.frame matches 38 if score @s BE.Idle.Count matches ..0 as @e[type=slime,tag=BE.EntityRoot,sort=nearest,limit=1] run function asset:mob/0380.haruclaire_v3/tick/act/
