#> asset:mob/0380.haruclaire_v3/tick/util/remove_animation_tag
#
# イベント処理用タグを全て消去する
#
# @within
#    function asset:mob/0380.haruclaire_v3/tick/**
#    function asset:mob/0380.haruclaire_v3/hurt/latter_start
