...
# 接地
    ...
    execute as @e[type=area_effect_cloud,tag=AK.Temp.Ground,distance=..80] at @s run function asset:mob/0380.haruclaire_v3/tick/util/move_to_roof_loop
    execute positioned as @e[type=area_effect_cloud,tag=AK.Temp.Ground,distance=..80] align y run tp @s ~ ~0.9 ~
