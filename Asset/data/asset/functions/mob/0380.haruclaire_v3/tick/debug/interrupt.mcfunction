...
#     execute at @e[type=marker,tag=AK.CenterPosition] run summon area_effect_cloud ^ ^0.3 ^-8 {Tags:["AK.Temp.AttackPosition"],Duration:3}

# イベント実行
    scoreboard players set @s AK.EventTimer 0
    tag @s add AK.Skill.IceCremation.Cross
