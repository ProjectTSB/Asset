...
# 攻撃位置決定
    ...
    execute as @e[type=area_effect_cloud,tag=AK.IceWall.B,tag=AK.Temp.Start] at @s run tp @s ~ ~ ~ ~120 0
    execute as @e[type=area_effect_cloud,tag=AK.IceWall.C,tag=AK.Temp.Start] at @s run tp @s ~ ~ ~ ~240 0
