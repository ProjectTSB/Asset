...
# 難易度に応じて数を増やす
    ...
    execute if predicate api:global_vars/difficulty/min/3_blessless at @s positioned ^ ^1 ^4 run function asset:mob/0380.haruclaire_v3/tick/event/ice_spinner/attack.m {IsLong:"false"}
    execute at @s run tp @s ~ ~ ~ ~120 ~
    execute if predicate api:global_vars/difficulty/min/3_blessless at @s positioned ^ ^1 ^4 run function asset:mob/0380.haruclaire_v3/tick/event/ice_spinner/attack.m {IsLong:"false"}
    execute at @s run tp @s ~ ~ ~ ~-60 ~
    execute if predicate api:global_vars/difficulty/2_hard at @s positioned ^ ^1 ^4 run function asset:mob/0380.haruclaire_v3/tick/event/ice_spinner/attack.m {IsLong:"false"}
