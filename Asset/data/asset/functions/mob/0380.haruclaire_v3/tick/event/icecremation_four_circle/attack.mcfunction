#> asset:mob/0380.haruclaire_v3/tick/event/icecremation_four_circle/attack
#
# アイスクリメーション・円範囲4体
#
...
# 弾召喚
    execute if entity @s[tag=AK.IceCrepation.Pos.A] run data modify storage api: Argument.ID set value 2160
    execute if entity @s[tag=AK.IceCrepation.Pos.B] run data modify storage api: Argument.ID set value 2161
