...
# 演出
    ...
    execute if score @s AK.EventTimer matches 30 at @s run playsound disabled_sounds:item.armor.equip_leather hostile @a ~ ~ ~ 1 1.3
    execute if score @s AK.EventTimer matches 71 at @s run playsound entity.experience_orb.pickup hostile @a ~ ~ ~ 1 1.3
    execute if score @s AK.EventTimer matches 87 at @s run playsound disabled_sounds:item.armor.equip_iron hostile @a ~ ~ ~ 1 1.3
    execute if score @s AK.EventTimer matches 99 at @s run playsound disabled_sounds:item.armor.equip_leather hostile @a ~ ~ ~ 1 1.3
    execute if score @s AK.EventTimer matches 105 at @s run playsound disabled_sounds:item.armor.equip_iron hostile @a ~ ~ ~ 1 1.3
