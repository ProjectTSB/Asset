...
# 攻撃位置決定
    execute if predicate api:global_vars/difficulty/min/hard rotated ~45 ~ run summon area_effect_cloud ^ ^-0.5 ^15 {Tags:["AK.Temp.AttackPosition"],Duration:200}
    execute if predicate api:global_vars/difficulty/min/hard rotated ~135 ~ run summon area_effect_cloud ^ ^-0.5 ^15 {Tags:["AK.Temp.AttackPosition"],Duration:200}
    execute if predicate api:global_vars/difficulty/min/hard rotated ~225 ~ run summon area_effect_cloud ^ ^-0.5 ^15 {Tags:["AK.Temp.AttackPosition"],Duration:200}
    execute if predicate api:global_vars/difficulty/min/hard rotated ~315 ~ run summon area_effect_cloud ^ ^-0.5 ^15 {Tags:["AK.Temp.AttackPosition"],Duration:200}
