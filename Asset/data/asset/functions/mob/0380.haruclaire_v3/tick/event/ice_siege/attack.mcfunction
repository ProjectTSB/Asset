#> asset:mob/0380.haruclaire_v3/tick/event/ice_siege/attack
#
# アイスシージ
#
...
# 弾召喚
    ...
    data modify storage api: Argument.FieldOverride.Damage set from storage asset:context this.Damage.IceSpear
