#> asset:mob/0380.haruclaire_v3/tick/event/ice_pillar/summon_attack_position
#
# アイスピラー
#
...
# プレイヤー人数に応じて数を減らす
    execute store result score @s AK.Dummy if entity @a[distance=..60]
    ...
    execute if score @s AK.Dummy matches 1.. run function asset:mob/0380.haruclaire_v3/tick/event/ice_pillar/kill_attack_position.m with storage asset:temp AK
