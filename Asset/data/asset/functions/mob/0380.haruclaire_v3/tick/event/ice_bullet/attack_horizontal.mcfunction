...
# 弾召喚
    ...
    execute as @e[type=area_effect_cloud,tag=AK.Temp.AttackRotation,sort=nearest,limit=1] at @s run function asset:mob/0380.haruclaire_v3/tick/event/ice_bullet/attack_horizontal_summon
