#> asset:mob/0380.haruclaire_v3/tick/event/icecremation_circle_line/attack
#
# アイスクリメーション・円+直線
#
...
# 弾召喚
    execute if entity @s[tag=AK.IceCrepation.Pos.A] run data modify storage api: Argument.ID set value 2161
    execute if entity @s[tag=AK.IceCrepation.Pos.B] run data modify storage api: Argument.ID set value 2159
