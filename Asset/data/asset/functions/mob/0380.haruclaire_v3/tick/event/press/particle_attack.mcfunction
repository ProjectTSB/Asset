#> asset:mob/0380.haruclaire_v3/tick/event/press/particle_attack
#
# 押しつぶし
#
# @within
#    function asset:mob/0380.haruclaire_v3/tick/event/press/attack_0
#    function asset:mob/0380.haruclaire_v3/tick/event/press/attack_1
...
# 演出
    ...
    particle explosion ~ ~0.2 ~ 3 0 3 0 5
    # 円 1
