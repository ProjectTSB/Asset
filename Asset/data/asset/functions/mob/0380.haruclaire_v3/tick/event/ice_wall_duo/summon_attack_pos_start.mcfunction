...
# 攻撃位置決定
    ...
    execute if predicate api:global_vars/difficulty/min/hard rotated ~-15 0 positioned ^ ^ ^9 run function asset:mob/0380.haruclaire_v3/tick/event/ice_wall_duo/summon_attack_pos
    ...
    execute if predicate api:global_vars/difficulty/min/hard rotated ~120 0 positioned ^ ^ ^9 rotated ~30 ~ run function asset:mob/0380.haruclaire_v3/tick/event/ice_wall_duo/summon_attack_pos
