...
# プレイヤーに向けてターンする
    execute if entity @e[type=marker,tag=7B.Target,distance=..0.05,limit=1] unless data storage asset:context this{TurnLimit:0} run return run function asset:mob/0263.shulker_bullet/tick/turn/
