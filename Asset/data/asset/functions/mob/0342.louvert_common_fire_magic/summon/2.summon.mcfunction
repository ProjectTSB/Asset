...
# 元となるMobを召喚する
    summon marker ~ ~ ~ {Tags:["MobInit","9I.Init"]}
# ID (int)
...
# 初期化処理
    execute as @e[type=marker,tag=9I.Init,distance=..0.01] at @s run function asset:mob/0342.louvert_common_fire_magic/summon/init