#> asset:mob/0232.honey_leader/tick/skill/beam/recursive
#
# 再帰ビームを打つよ
#
# @within function
...
# 再帰
    execute if entity @s[distance=..32] positioned ^ ^ ^1 if block ~ ~ ~ #lib:no_collision/ run function asset:mob/0232.honey_leader/tick/skill/beam/recursive
