...
# 雷攻撃
    execute if score @s General.Mob.Tick matches 0 at @p[distance=..100] run function asset:mob/1005.illusion_of_loyalty/tick/moveset/skill/thunder/random_thunder/thunder/place_marker
    execute if score @s General.Mob.Tick matches 0 at @p[distance=..100] run function asset:mob/1005.illusion_of_loyalty/tick/moveset/skill/thunder/random_thunder/thunder/place_marker
