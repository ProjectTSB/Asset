#> asset:mob/1005.illusion_of_loyalty/tick/moveset/skill/thunder/aiming_laser/aim/
#
#
#
...
# マクロで偏差撃ちする
    execute at @p[tag=Target] run function asset:mob/1005.illusion_of_loyalty/tick/moveset/skill/thunder/aiming_laser/aim/macro.m with storage asset:temp Predict
