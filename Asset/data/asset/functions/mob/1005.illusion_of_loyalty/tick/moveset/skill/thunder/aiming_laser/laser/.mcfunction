...
# パーティクル
    # 内側
        particle minecraft:dust_color_transition 1 1 1 0.7 1 1 0 ^ ^ ^ 0 0 0 0 1 force @a[distance=..30]
        particle minecraft:dust_color_transition 1 1 1 0.7 1 1 0 ^ ^ ^0.5 0 0 0 0 1 force @a[distance=..30]
        particle minecraft:dust_color_transition 1 1 1 0.7 1 1 0 ^ ^ ^-0.5 0 0 0 0 1 force @a[distance=..30]
    # 外側
        particle minecraft:dust 1 1 0.3 0.4 ^ ^ ^ 0.07 0.07 0.07 0 1 force @a[distance=..30]
        particle minecraft:dust 1 1 0.3 0.4 ^ ^ ^0.5 0.07 0.07 0.07 0 1 force @a[distance=..30]
        particle minecraft:dust 1 1 0.3 0.4 ^ ^ ^-0.5 0.07 0.07 0.07 0 1 force @a[distance=..30]
