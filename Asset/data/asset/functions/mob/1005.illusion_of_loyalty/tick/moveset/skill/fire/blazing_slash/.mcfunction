...
# 警告
    execute if score @s General.Mob.Tick matches 0 at @s positioned ~ ~-0.3 ~ run function asset:mob/1005.illusion_of_loyalty/tick/moveset/skill/fire/blazing_slash/explosion/alert
