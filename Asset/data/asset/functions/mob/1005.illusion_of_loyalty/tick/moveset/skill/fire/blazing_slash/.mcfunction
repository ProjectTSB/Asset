...
# 警告
    execute if score @s General.Mob.Tick matches 0 positioned ~ ~-1 ~ run function asset:mob/1005.illusion_of_loyalty/tick/moveset/skill/fire/blazing_slash/explosion/alert
    execute if score @s General.Mob.Tick matches 10 positioned ^5 ^-1 ^ run function asset:mob/1005.illusion_of_loyalty/tick/moveset/skill/fire/blazing_slash/explosion/alert
    execute if score @s General.Mob.Tick matches 10 positioned ^-5 ^-1 ^ run function asset:mob/1005.illusion_of_loyalty/tick/moveset/skill/fire/blazing_slash/explosion/alert
...
# 爆発
    # 1
        execute if score @s General.Mob.Tick matches 30 positioned ~ ~-1 ~ run function asset:mob/1005.illusion_of_loyalty/tick/moveset/skill/fire/blazing_slash/explosion/
    # 2
        execute if score @s General.Mob.Tick matches 40 positioned ^5 ^-1 ^ run function asset:mob/1005.illusion_of_loyalty/tick/moveset/skill/fire/blazing_slash/explosion/
        execute if score @s General.Mob.Tick matches 40 positioned ^-5 ^-1 ^ run function asset:mob/1005.illusion_of_loyalty/tick/moveset/skill/fire/blazing_slash/explosion/
