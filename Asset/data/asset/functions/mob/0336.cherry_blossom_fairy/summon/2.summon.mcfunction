#> asset:mob/0336.cherry_blossom_fairy/summon/2.summon
#
# Mobの召喚時の処理
#
# @within function asset:mob/0336.cherry_blossom_fairy/summon/1.trigger

# 元となるMobを召喚する
    summon skeleton ~ ~ ~ {Silent:1b,Tags:["MobInit","AlwaysInvisible"],DeathLootTable:"asset:mob/death/0336.cherry_blossom_fairy"}
# ID (int)
...
# 体力 (double) (オプション)
    data modify storage asset:mob Health set value 1050
# 攻撃力 (double) (オプション)
...
# ノックバック耐性 (double) (オプション)
    data modify storage asset:mob KnockBackResist set value 0.25
