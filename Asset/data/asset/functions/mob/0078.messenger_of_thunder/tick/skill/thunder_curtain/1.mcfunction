...
# 予備動作
    ...
    execute if entity @s[scores={26.Tick=0..19}] facing entity @p eyes rotated ~ 0 positioned ^ ^0.2 ^0.8 run function asset:mob/0078.messenger_of_thunder/tick/skill/thunder_curtain/2.ready
