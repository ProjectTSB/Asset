...
# ハードかつ体力半分以下で追加で2本召喚する
    ...
    execute if entity @s[tag=26.HPLess50Per] if predicate api:global_vars/difficulty/min/hard run function asset:mob/0078.messenger_of_thunder/tick/skill/thunder/thunder_point2
