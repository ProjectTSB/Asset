...
# 強化状態なら追加で2本表示する
    ...
    execute if score $Interval Temporary matches 0 if entity @s[tag=26.HealthLess50Per] rotated ~30 ~ run function asset:mob/0078.messenger_of_thunder/tick/skill/vfx/line
    execute if score $Interval Temporary matches 0 if entity @s[tag=26.HealthLess50Per] rotated ~-30 ~ run function asset:mob/0078.messenger_of_thunder/tick/skill/vfx/line
