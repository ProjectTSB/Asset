...
# 強化状態なら追加で2本表示する
    ...
    execute if score $Interval Temporary matches 0 facing entity @p feet positioned ~ ~0.2 ~ rotated ~ 0 run function asset:mob/0078.messenger_of_thunder/tick/skill/return_thunder/3.display_vfx
