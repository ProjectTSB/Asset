...
# ノーマル以上でのみチェック
# イージーでは強化状態に移行しないため
    execute if predicate api:global_vars/difficulty/min/normal if entity @s[tag=!26.HealthLess50Per] run function asset:mob/0078.messenger_of_thunder/hurt/check_health
