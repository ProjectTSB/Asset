#> asset:mob/0436.landmine/register
#
# Mobのデータを指定
#
# @within function asset:mob/alias/436/register
...
# ID (int)
    data modify storage asset:mob ID set value 436
# Type (string) Wikiを参照
...
# フィールド
    data modify storage asset:mob Field.MobUUID set value 0
