...
# 見た目召喚
    summon item_display ~ ~ ~ {Tags:["C4.DisplayInit","ProcessCommonTag","AutoKillWhenDieVehicle"],item_display:"thirdperson_righthand",transformation:{left_rotation:[0f,0f,0f,1f],right_rotation:[0f,0f,0f,1f],translation:[0f,-0.5f,0f],scale:[1f,1f,1f]},item:{id:"minecraft:stick",Count:1b,tag:{CustomModelData:20511}}}
