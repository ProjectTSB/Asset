...
# クールタイム中じゃないなら突進時に攻撃
    execute if entity @s[scores={4W.MoveTime=70..}] unless entity @s[scores={4W.AttackCT=1..}] positioned ~-0.5 ~0.5 ~-0.5 if entity @p[tag=!PlayerShouldInvulnerable,dx=0] run function asset:mob/0176.killer_bee/tick/damage
