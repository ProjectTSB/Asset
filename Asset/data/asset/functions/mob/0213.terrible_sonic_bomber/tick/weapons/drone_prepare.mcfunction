...
# 攻撃箇所表示
   execute at @e[tag=5X.Centre,limit=1] positioned ~ ~0.01 ~-5 run function asset:mob/0213.terrible_sonic_bomber/tick/weapons/set_attack_position_display.m {Color:14234401,Tick:280,Scale:"[10f,10f,10f]",RotationX:0} 
