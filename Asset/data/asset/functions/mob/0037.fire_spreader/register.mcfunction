#> asset:mob/0037.fire_spreader/register
# @within asset:mob/alias/37/register
...
# Mobの説明文 (TextComponentString[]) (オプション)
    data modify storage asset:mob Lore set value ['{"text":"炎を撒き散らす魔物。","color":"white"}','{"text":"攻撃時、周囲に火をつける","color":"white"}','{"text":"早いうちに消火をしよう。","color":"white"}']
# 武器
