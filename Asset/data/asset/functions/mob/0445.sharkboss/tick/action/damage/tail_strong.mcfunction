#> asset:mob/0445.sharkboss/tick/action/damage/tail_strong
#
# 
#
# @within function asset:mob/0445.sharkboss/tick/action/tail_strong
...
# ダメージ
    ...
    data modify storage api: Argument.Damage set from storage asset:context this.Damage.TailStrong
