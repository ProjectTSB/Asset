...
# 吹っ飛ばしタグ
    tag @a[tag=!PlayerShouldInvulnerable,distance=..7] add CD.Player.Launch.First
    tag @a[tag=!PlayerShouldInvulnerable,distance=..7] add CD.Player.Launch.HorizontalStrong
