#> asset:mob/0445.sharkboss/tick/action/damage/sharknado_multi
#
# 
#
...
# ダメージ
    data modify storage api: Argument.Damage set from storage asset:context this.Damage.SharknadoMulti
