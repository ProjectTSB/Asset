...
#演出
    ...
    execute if score @s CD.AnimationTimer matches 2 run playsound ogg:mob.breeze.charge1 hostile @a ~ ~ ~ 1.5 0.2
    execute if score @s CD.AnimationTimer matches 8 run playsound ogg:mob.breeze.charge1 hostile @a ~ ~ ~ 1.5 0.8
    execute if score @s CD.AnimationTimer matches 8 run playsound ogg:mob.breeze.charge1 hostile @a ~ ~ ~ 1.5 0.8
    execute if score @s CD.AnimationTimer matches 13 run playsound ogg:mob.breeze.charge1 hostile @a ~ ~ ~ 1.5 1.2
    execute if score @s CD.AnimationTimer matches 13 run playsound ogg:mob.breeze.charge1 hostile @a ~ ~ ~ 1.5 1.2
...
#emp
    execute if score @s CD.AnimationTimer matches 23 positioned ~ ~2 ~ run function asset:mob/0445.sharkboss/vfx/emp
