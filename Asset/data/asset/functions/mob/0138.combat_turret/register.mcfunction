#> asset:mob/0138.combat_turret/register
# @within asset:mob/alias/138/register
...
# Mobの説明文 (TextComponentString[]) (オプション)
    data modify storage asset:mob Lore set value ['{"text":"軍用に開発されたであろうロボット。","color":"white"}','{"text":"あなたに風穴を開けるには十分な三点バーストの銃を装備している。","color":"white"}','{"text":"その銃はテーザー銃と呼ばれる非殺傷の武器らしいが、絶対嘘である。","color":"white"}']
# 武器
