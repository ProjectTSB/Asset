#> asset:mob/0179.trindicator/register
# @within asset:mob/alias/179/register
...
data modify storage asset:mob Lore set value ['{"text":"トライデントをもったヴィンティケーター。","color":"white"}','{"text":"本人はこの名前を良く思っていないらしい。","color":"white"}']
# 武器
