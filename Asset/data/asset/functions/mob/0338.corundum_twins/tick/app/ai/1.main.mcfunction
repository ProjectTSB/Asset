...
# ルビィに指示
    execute if entity @s[tag=9E.State.Phase.Rubiel,tag=9E.State.GetAwait.Sapphiel] if entity @e[type=wither_skeleton,tag=9G.Root,tag=9G.Target,tag=!9G.Skill.Damage.Down,tag=!9G.Skill.Damage.End] run function asset:mob/0338.corundum_twins/tick/app/ai/2.2.phase_rubiel
