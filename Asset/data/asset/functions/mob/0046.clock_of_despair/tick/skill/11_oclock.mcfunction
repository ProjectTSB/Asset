...
# + + -> - -
    ...
    execute if score @s 1A.LifeTime matches 2205 if entity @s[tag=1A.LazerDirection1] if predicate api:global_vars/difficulty/min/hard positioned ~016 ~6 ~007 rotated 090 0 run function asset:mob/0046.clock_of_despair/tick/skill/common/wall_lazer_clock/summon
    ...
    execute if score @s 1A.LifeTime matches 2230 if entity @s[tag=1A.LazerDirection1] if predicate api:global_vars/difficulty/min/hard positioned ~-16 ~6 ~-07 rotated 270 0 run function asset:mob/0046.clock_of_despair/tick/skill/common/wall_lazer_clock/summon
# + - -> - +
    execute if score @s 1A.LifeTime matches 2205 if entity @s[tag=1A.LazerDirection2] if predicate api:global_vars/difficulty/min/hard positioned ~007 ~6 ~-16 rotated 000 0 run function asset:mob/0046.clock_of_despair/tick/skill/common/wall_lazer_clock/summon
    ...
    execute if score @s 1A.LifeTime matches 2230 if entity @s[tag=1A.LazerDirection2] if predicate api:global_vars/difficulty/min/hard positioned ~-07 ~6 ~016 rotated 180 0 run function asset:mob/0046.clock_of_despair/tick/skill/common/wall_lazer_clock/summon
...
# - + -> + -
    ...
    execute if score @s 1A.LifeTime matches 2205 if entity @s[tag=1A.LazerDirection3] if predicate api:global_vars/difficulty/min/hard positioned ~016 ~6 ~007 rotated 090 0 run function asset:mob/0046.clock_of_despair/tick/skill/common/wall_lazer_clock/summon
    ...
    execute if score @s 1A.LifeTime matches 2230 if entity @s[tag=1A.LazerDirection3] if predicate api:global_vars/difficulty/min/hard positioned ~-16 ~6 ~-07 rotated 270 0 run function asset:mob/0046.clock_of_despair/tick/skill/common/wall_lazer_clock/summon
# - - -> + +
    execute if score @s 1A.LifeTime matches 2205 if entity @s[tag=1A.LazerDirection4] if predicate api:global_vars/difficulty/min/hard positioned ~-07 ~6 ~-16 rotated 000 0 run function asset:mob/0046.clock_of_despair/tick/skill/common/wall_lazer_clock/summon
    ...
    execute if score @s 1A.LifeTime matches 2230 if entity @s[tag=1A.LazerDirection4] if predicate api:global_vars/difficulty/min/hard positioned ~007 ~6 ~016 rotated 180 0 run function asset:mob/0046.clock_of_despair/tick/skill/common/wall_lazer_clock/summon
