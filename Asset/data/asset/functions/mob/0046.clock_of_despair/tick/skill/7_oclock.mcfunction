...
# RE: 歯車の恐怖
    ...
    execute if score @s 1A.LifeTime matches 1430 if predicate api:global_vars/difficulty/min/hard run function asset:mob/0046.clock_of_despair/tick/skill/common/summon_gears/8-0
