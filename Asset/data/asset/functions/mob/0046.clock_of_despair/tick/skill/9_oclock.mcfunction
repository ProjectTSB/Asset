...
execute if score @s 1A.LifeTime matches 1854 as @e[type=marker,tag=1A.SkillFF1,distance=..6.1] at @s run function asset:mob/0046.clock_of_despair/tick/skill/common/falling_fire/summon_aoe.m {VisibleTime:28,InterpolationTime:25}
