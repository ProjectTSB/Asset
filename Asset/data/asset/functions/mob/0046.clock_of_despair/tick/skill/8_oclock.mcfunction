...
# # 時計レーザーの恐怖
#     execute if score @s 1A.LifeTime matches 1610 store result score $laserDirection Temporary run function lib:random/
#     execute if score @s 1A.LifeTime matches 1610 run scoreboard players operation $laserDirection Temporary %= $4 Const
#     execute if score @s 1A.LifeTime matches 1610 if score $laserDirection Temporary matches 0 positioned ~007 ~6 ~-16 rotated 000 0 run function asset:mob/0046.clock_of_despair/tick/skill/common/wall_laser_clock/summon
#     execute if score @s 1A.LifeTime matches 1610 if score $laserDirection Temporary matches 1 positioned ~016 ~6 ~007 rotated 090 0 run function asset:mob/0046.clock_of_despair/tick/skill/common/wall_laser_clock/summon
#     execute if score @s 1A.LifeTime matches 1610 if score $laserDirection Temporary matches 2 positioned ~-07 ~6 ~016 rotated 180 0 run function asset:mob/0046.clock_of_despair/tick/skill/common/wall_laser_clock/summon
#     execute if score @s 1A.LifeTime matches 1610 if score $laserDirection Temporary matches 3 positioned ~-16 ~6 ~-07 rotated 270 0 run function asset:mob/0046.clock_of_despair/tick/skill/common/wall_laser_clock/summon
#     execute if score @s 1A.LifeTime matches 1610 run scoreboard players reset $laserDirection Temporary
