...
# ビーム追尾
    ...
    execute if score @s 1A.LifeTime matches 421..590 if predicate api:global_vars/difficulty/min/hard as @e[type=marker,tag=1A.SkillBeam,scores={1A.Cooldown=0},distance=..100] at @s facing entity @p[tag=!PlayerShouldInvulnerable] feet rotated ~ 0 run tp @s ^ ^ ^0.25 0 90
