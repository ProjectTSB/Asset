...
# サンダー召喚
    execute if score @s 1A.LifeTime matches 2080 if predicate api:global_vars/difficulty/min/normal at @a[distance=..100] run function asset:mob/0046.clock_of_despair/tick/skill/common/thunder/summon
# サンダー攻撃
