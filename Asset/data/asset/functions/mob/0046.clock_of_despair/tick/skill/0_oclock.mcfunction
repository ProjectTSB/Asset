...
# サンダー召喚
    ...
    execute if score @s 1A.LifeTime matches 170 at @a[tag=1A.Target,distance=..100] rotated 045 0 positioned ^ ^ ^2.5 run function asset:mob/0046.clock_of_despair/tick/skill/common/thunder/summon
    execute if score @s 1A.LifeTime matches 170 at @a[tag=1A.Target,distance=..100] rotated 135 0 positioned ^ ^ ^2.5 run function asset:mob/0046.clock_of_despair/tick/skill/common/thunder/summon
    execute if score @s 1A.LifeTime matches 170 at @a[tag=1A.Target,distance=..100] rotated 225 0 positioned ^ ^ ^2.5 run function asset:mob/0046.clock_of_despair/tick/skill/common/thunder/summon
    execute if score @s 1A.LifeTime matches 170 at @a[tag=1A.Target,distance=..100] rotated 315 0 positioned ^ ^ ^2.5 run function asset:mob/0046.clock_of_despair/tick/skill/common/thunder/summon
# サンダー攻撃
