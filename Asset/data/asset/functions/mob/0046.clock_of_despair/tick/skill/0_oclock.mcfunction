...
# サンダー召喚(190Tickに攻撃)
    ...
    execute if score @s 1A.LifeTime matches 170 if predicate api:global_vars/difficulty/min/hard at @a[tag=1A.Target,distance=..100] rotated 045 0 positioned ^ ^ ^2.5 run function asset:mob/0046.clock_of_despair/tick/skill/common/thunder/summon.m {Delay:20}
    execute if score @s 1A.LifeTime matches 170 if predicate api:global_vars/difficulty/min/hard at @a[tag=1A.Target,distance=..100] rotated 135 0 positioned ^ ^ ^2.5 run function asset:mob/0046.clock_of_despair/tick/skill/common/thunder/summon.m {Delay:20}
    execute if score @s 1A.LifeTime matches 170 if predicate api:global_vars/difficulty/min/hard at @a[tag=1A.Target,distance=..100] rotated 225 0 positioned ^ ^ ^2.5 run function asset:mob/0046.clock_of_despair/tick/skill/common/thunder/summon.m {Delay:20}
    execute if score @s 1A.LifeTime matches 170 if predicate api:global_vars/difficulty/min/hard at @a[tag=1A.Target,distance=..100] rotated 315 0 positioned ^ ^ ^2.5 run function asset:mob/0046.clock_of_despair/tick/skill/common/thunder/summon.m {Delay:20}
# tag削除
