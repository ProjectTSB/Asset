...
# 予測位置マーカーが存在しない場合、直接プレイヤーに投げる
    execute if entity @e[type=marker,tag=PredictionMarker,distance=..30,limit=1] positioned ~ ~1000 ~ as @e[type=block_display,scores={MobID=77},distance=..5,limit=1] at @s positioned ~ ~-1000 ~ facing entity @e[type=marker,tag=PredictionMarker,distance=..30,limit=1] eyes run tp @s ~ ~ ~ ~ ~-2
    execute unless entity @e[type=marker,tag=PredictionMarker,distance=..30,limit=1] positioned ~ ~1000 ~ as @e[type=block_display,scores={MobID=77},distance=..5,limit=1] at @s positioned ~ ~-1000 ~ facing entity @p eyes run tp @s ~ ~ ~ ~ ~-2
