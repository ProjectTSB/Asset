...
# Mobの説明文 (TextComponentString[]) (オプション)
    data modify storage asset:mob Lore set value ['{"text":"既存のルールに縛られない、丈夫な人形。","color":"white"}','{"text":"広範囲に強烈な攻撃を放つが、","color":"white"}','{"text":"一部の攻撃は飛び越えることでも回避ができそうだ。","color":"white"}']
# 体力 (double) (オプション)
