#> asset:mob/0437.lawless_iron_doll/tick/base_move/skill/select/get.m
#
# @input args:
#    Roll : int
# @within function asset:mob/0437.lawless_iron_doll/tick/base_move/skill/select/roll.m

# Skill.Listの要素を番号で指定
    $data modify storage asset:context this.Skill.Get set from storage asset:context this.Skill.List[-$(Roll)]

# 技を選択
    function asset:mob/0437.lawless_iron_doll/tick/base_move/skill/select/tags
