#> asset:mob/0437.lawless_iron_doll/tick/base_move/skill/random_teleport_slash/teleport/
#
#
#
# @within function
...
# 適当なプレイヤー狙いでワープ
    function asset:mob/0437.lawless_iron_doll/tick/base_move/skill/random_teleport_slash/teleport/spread
