#> asset:mob/0437.lawless_iron_doll/tick/base_move/skill/random_teleport_slash/phase2/windup_2
#
#
#
...
# アニメーション
    execute as @e[type=item_display,tag=C5.ModelRoot.Target,sort=nearest,limit=1] run function animated_java:frestchika/animations/attack_slash_2_windup/tween {to_frame: 0, duration: 1}
