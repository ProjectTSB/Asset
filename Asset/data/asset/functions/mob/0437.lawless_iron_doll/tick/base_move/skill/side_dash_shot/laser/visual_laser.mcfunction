#> asset:mob/0437.lawless_iron_doll/tick/base_move/skill/side_dash_shot/laser/visual_laser
#
#
#
# @within function asset:mob/0437.lawless_iron_doll/tick/base_move/skill/side_dash_shot/laser/shoot
