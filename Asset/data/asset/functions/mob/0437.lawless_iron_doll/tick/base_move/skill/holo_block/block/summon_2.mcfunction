#> asset:mob/0437.lawless_iron_doll/tick/base_move/skill/holo_block/block/summon_2
#
# ２つ積む
#
# @within function asset:mob/0437.lawless_iron_doll/tick/base_move/skill/holo_block/pattern/**
