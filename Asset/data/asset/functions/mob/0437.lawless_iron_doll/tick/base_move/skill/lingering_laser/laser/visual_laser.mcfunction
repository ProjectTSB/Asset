#> asset:mob/0437.lawless_iron_doll/tick/base_move/skill/lingering_laser/laser/visual_laser
#
#
#
...
# オブジェクト召喚
    ...
    data modify storage api: Argument.FieldOverride set value {Scale:[1.0f,0f,1.0f],Color:7536895,DisappearInterpolation:3,LifeTime:10}
