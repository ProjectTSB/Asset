#> asset:mob/0437.lawless_iron_doll/tick/base_move/skill/charge_slash/teleport/visual_laser
#
# レーザーというよりかは移動の軌跡みたいに
#
# @within function asset:mob/0437.lawless_iron_doll/tick/base_move/skill/charge_slash/teleport/active
