#> asset:mob/0437.lawless_iron_doll/tick/base_move/skill/side_dash_shot/laser/hit
#
#
#
# @within function asset:mob/0437.lawless_iron_doll/tick/base_move/skill/side_dash_shot/laser/recursive
