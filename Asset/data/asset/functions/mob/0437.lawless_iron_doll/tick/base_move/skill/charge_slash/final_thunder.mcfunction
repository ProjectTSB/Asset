#> asset:mob/0437.lawless_iron_doll/tick/base_move/skill/charge_slash/final_thunder
#
# 居合サンダー
#
# @within function asset:mob/0437.lawless_iron_doll/tick/base_move/skill/charge_slash/phase2
