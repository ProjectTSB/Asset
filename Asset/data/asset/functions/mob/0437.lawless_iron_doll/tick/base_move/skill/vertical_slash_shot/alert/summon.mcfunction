#> asset:mob/0437.lawless_iron_doll/tick/base_move/skill/vertical_slash_shot/alert/summon
#
#
#
# @within function asset:mob/0437.lawless_iron_doll/tick/base_move/skill/vertical_slash_shot/alert/start
