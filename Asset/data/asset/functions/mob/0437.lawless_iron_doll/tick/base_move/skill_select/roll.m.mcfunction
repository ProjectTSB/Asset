#> asset:mob/0437.lawless_iron_doll/tick/base_move/skill_select/roll.m
#
#
#
...
# 取得する
    function asset:mob/0437.lawless_iron_doll/tick/base_move/skill_select/get.m with storage asset:context this.Skill
