...
# 技が一周していたら、確定で動作を選択
    execute if score @s[tag=C5.CycleReset,tag=!C5.InAction] General.Mob.Tick matches 20.. run function asset:mob/0437.lawless_iron_doll/tick/base_move/skill/select/cycle_reset/
