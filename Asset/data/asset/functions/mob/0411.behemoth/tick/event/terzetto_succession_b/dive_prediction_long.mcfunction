#> asset:mob/0411.behemoth/tick/event/terzetto_succession_b/dive_prediction_long
#
# テルツェット・サクセッション
#
...
# 攻撃判定用AEC召喚
    summon area_effect_cloud ~ ~ ~ {Duration:108,Tags:["BF.Temp.AttackPosition"]}
...
# 予告
    ...
    data modify storage api: Argument.FieldOverride.Tick set value 98
