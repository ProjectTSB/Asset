#> asset:mob/0411.behemoth/tick/event/blazing_end/effect_ring
#
# ブレイジングエンド
#
# @within
#   function asset:mob/0411.behemoth/tick/event/blazing_end/

# 一定間隔
    scoreboard players operation $Interval Temporary = @s BF.EventTimer
