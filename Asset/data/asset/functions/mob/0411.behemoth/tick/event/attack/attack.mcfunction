...
# ダメージ
    execute if predicate api:global_vars/difficulty/max/2_hard run data modify storage api: Argument.Damage set from storage asset:context this.Damage.Attack
