#> asset:mob/0411.behemoth/tick/event/terzetto_ragnarok/dive_prediction
#
# テルツェット・ラグナレク
#
...
# 攻撃判定用AEC召喚
    summon area_effect_cloud ~ ~ ~ {Duration:72,Tags:["BF.Temp.AttackPosition"]}
...
# 予告
    ...
    data modify storage api: Argument.FieldOverride.Scale set value [14f,60f]
    data modify storage api: Argument.FieldOverride.Interpolation set value 10
    data modify storage api: Argument.FieldOverride.Tick set value 62
