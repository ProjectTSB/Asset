...
# 演出
    ...
    execute if score @s aj.0_start.frame matches 58..73 run playsound entity.polar_bear.warning hostile @a[distance=..60] ~ ~ ~ 0.1 0.7 1
    execute if score @s aj.0_start.frame matches 58..73 run playsound entity.phantom.death hostile @a[distance=..60] ~ ~ ~ 0.1 0.5 0.4
