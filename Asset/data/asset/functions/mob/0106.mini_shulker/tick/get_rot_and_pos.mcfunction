#> asset:mob/0106.mini_shulker/tick/get_rot_and_pos
...
data modify storage asset:context this.Pos set from entity @e[type=marker,tag=2Y.Rotation,distance=..0.01,limit=1] Pos
