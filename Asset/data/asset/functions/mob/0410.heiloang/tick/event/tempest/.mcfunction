...
# 詠唱：3回
    ...
    # 攻撃範囲予告
        execute if score @s BE.EventTimer matches 10..140 at @a[tag=BE.AttackTarget] rotated ~ 0 positioned ~ ~0.1 ~ run function asset:mob/0410.heiloang/tick/event/tempest/particle_attack_area
# 発動
    # アニメーション再生
