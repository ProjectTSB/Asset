#> asset:mob/0410.heiloang/tick/event/heil_disaster/attack_ice_burst
#
# ヘイルディザスター・水
#
...
# 攻撃用AEC召喚
    ...
    data modify storage api: Argument.FieldOverride.Damage set from storage asset:context this.Damage.IceBurst
