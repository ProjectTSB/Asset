#> asset:mob/0410.heiloang/tick/event/terzetto_succession_dive/dive_prediction_1_long
#
# テルツェット・サクセッション
#
...
# 攻撃判定用AEC召喚
    summon area_effect_cloud ~ ~ ~ {Duration:120,Tags:["BE.Temp.AttackPosition"]}
...
# 予告
    ...
    data modify storage api: Argument.FieldOverride.Color set value 16772963
    ...
    data modify storage api: Argument.FieldOverride.Tick set value 90
