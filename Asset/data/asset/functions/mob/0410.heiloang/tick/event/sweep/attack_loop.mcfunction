...
# 演出 + ヒット判定
    ...
    execute positioned ^ ^ ^ run tag @a[tag=!PlayerShouldInvulnerable,distance=..4] add BE.Temp.Hit
    execute positioned ^-3 ^ ^ run tag @a[tag=!PlayerShouldInvulnerable,distance=..4] add BE.Temp.Hit
    execute positioned ^3 ^ ^ run tag @a[tag=!PlayerShouldInvulnerable,distance=..4] add BE.Temp.Hit
