...
# 演出 + ヒット判定
    ...
    execute positioned ^ ^-1 ^ run tag @a[tag=!PlayerShouldInvulnerable,distance=..2.4] add BE.Temp.Hit
    execute positioned ^-2 ^-1 ^ run tag @a[tag=!PlayerShouldInvulnerable,distance=..2.4] add BE.Temp.Hit
    execute positioned ^2 ^-1 ^ run tag @a[tag=!PlayerShouldInvulnerable,distance=..2.4] add BE.Temp.Hit
