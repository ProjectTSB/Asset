...
# 詠唱：3回
    ...
    # テンペスト配置
        execute if score @s BE.EventTimer matches 43 if predicate api:global_vars/difficulty/min/2_hard as @a[distance=..80,sort=random,limit=3] run tag @s add BE.AttackTarget
