#> asset:mob/0410.heiloang/tick/event/terzetto_ragnarok_start/
#
# テルツェット・ラグナレク
#
...
# 終了
    execute if score @s BE.EventTimer matches 189.. run function asset:mob/0410.heiloang/tick/event/terzetto_ragnarok_start/end
