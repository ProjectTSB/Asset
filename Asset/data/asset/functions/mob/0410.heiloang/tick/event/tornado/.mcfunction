...
# 発動
    ...
    # ハード以上：終了後、風弾落下
        # execute if score @s BE.EventTimer matches 105 at @p[tag=BE.MainTarget] positioned ~ ~0.2 ~ run function asset:mob/0410.heiloang/tick/event/tornado/summon_heavenly
        # execute if score @s BE.EventTimer matches 137 at @p[tag=BE.MainTarget] positioned ~ ~0.2 ~ run function asset:mob/0410.heiloang/tick/event/tornado/summon_heavenly
        # execute if score @s BE.EventTimer matches 169 at @p[tag=BE.MainTarget] positioned ~ ~0.2 ~ run function asset:mob/0410.heiloang/tick/event/tornado/summon_heavenly
        # execute if score @s BE.EventTimer matches 201 at @p[tag=BE.MainTarget] positioned ~ ~0.2 ~ run function asset:mob/0410.heiloang/tick/event/tornado/summon_heavenly
        # execute if score @s BE.EventTimer matches 233 at @p[tag=BE.MainTarget] positioned ~ ~0.2 ~ run function asset:mob/0410.heiloang/tick/event/tornado/summon_heavenly
        # execute if score @s BE.EventTimer matches 265 at @p[tag=BE.MainTarget] positioned ~ ~0.2 ~ run function asset:mob/0410.heiloang/tick/event/tornado/summon_heavenly
    # 中心点回転
