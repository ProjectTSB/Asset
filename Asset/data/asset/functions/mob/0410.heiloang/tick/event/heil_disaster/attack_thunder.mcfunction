...
# 召喚
    execute at @e[type=area_effect_cloud,tag=BE.Temp.AttackPosition,sort=random,limit=5] run function asset:mob/0410.heiloang/tick/event/heil_disaster/summon_thunder_burst
