#> asset:mob/0410.heiloang/tick/event/terzetto_aligning/attack_heavenly
#
# テルツェット・アライニング
#
...
# 攻撃用AEC召喚
    ...
    data modify storage api: Argument.FieldOverride.Damage set from storage asset:context this.Damage.TerAligIce
