...
# 火
    ...
    execute if predicate api:global_vars/difficulty/min/hard unless score $BE.Temp Temporary matches 1 run function asset:mob/0410.heiloang/tick/event/enhanced_disaster/give_debuff_fire
...
# 水
    ...
    execute if predicate api:global_vars/difficulty/min/hard unless score $BE.Temp Temporary matches 2 run function asset:mob/0410.heiloang/tick/event/enhanced_disaster/give_debuff_water
...
# 雷
    ...
    execute if predicate api:global_vars/difficulty/min/hard unless score $BE.Temp Temporary matches 3 run function asset:mob/0410.heiloang/tick/event/enhanced_disaster/give_debuff_thunder
