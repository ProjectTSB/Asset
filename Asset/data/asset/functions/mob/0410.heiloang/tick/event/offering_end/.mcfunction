...
# 終了
    execute if score @s BE.EventTimer matches 499.. if predicate api:global_vars/difficulty/1_normal run function asset:mob/0410.heiloang/tick/event/offering_end/end
