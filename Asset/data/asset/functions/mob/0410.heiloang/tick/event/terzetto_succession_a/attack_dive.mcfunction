#> asset:mob/0410.heiloang/tick/event/terzetto_succession_a/attack_dive
#
# テルツェット・サクセッション
#
...
# ダメージ
    data modify storage api: Argument.Damage set from storage asset:context this.Damage.TerSuccStart
