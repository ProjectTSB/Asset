#> asset:mob/0410.heiloang/tick/event/terzetto_disaster_start/
#
# テルツェット・ディザスター
#
...
# 終了
    execute if score @s BE.EventTimer matches 189.. run function asset:mob/0410.heiloang/tick/event/terzetto_disaster_start/end
