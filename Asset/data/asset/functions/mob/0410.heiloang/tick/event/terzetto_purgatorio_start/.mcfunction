#> asset:mob/0410.heiloang/tick/event/terzetto_purgatorio_start/
#
# テルツェット・プルガトリオ
#
...
# 終了
    execute if score @s BE.EventTimer matches 189.. run function asset:mob/0410.heiloang/tick/event/terzetto_purgatorio_start/end
