...
# テンペスト
    ...
    # 攻撃範囲予告
        execute if score @s BE.EventTimer matches 200 at @a[tag=BE.AttackTarget] rotated ~ 0 run function asset:mob/0410.heiloang/tick/event/tempest/summon_attack_pos
