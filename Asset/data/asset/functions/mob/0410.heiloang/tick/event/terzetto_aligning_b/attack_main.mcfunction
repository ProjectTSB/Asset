...
# 攻撃位置設置
    ...
    execute if score @s BE.EventTimer matches 120 as @e[type=marker,tag=BE.CenterPosition] at @s run function asset:mob/0410.heiloang/tick/event/terzetto_aligning_b/prediction_line
