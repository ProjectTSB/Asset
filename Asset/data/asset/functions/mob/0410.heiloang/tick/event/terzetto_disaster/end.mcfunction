...
# イージー：ソウルオファリング開始
    execute if predicate api:global_vars/difficulty/easy run scoreboard players set @s BE.EventTimer 0
    execute if predicate api:global_vars/difficulty/easy run return run tag @s add BE.Skill.OfferingEnd
