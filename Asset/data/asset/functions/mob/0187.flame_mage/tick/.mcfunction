...
# 予備動作演出
    execute if entity @s[scores={57.Tick=1..2}] facing entity @p eyes anchored eyes positioned ^-0.25 ^ ^1 run function asset:mob/0187.flame_mage/tick/vfx/1
    execute if entity @s[scores={57.Tick=4..5}] facing entity @p eyes anchored eyes positioned ^-0.25 ^ ^1 run function asset:mob/0187.flame_mage/tick/vfx/2
    execute if entity @s[scores={57.Tick=7..8}] facing entity @p eyes anchored eyes positioned ^-0.25 ^ ^1 run function asset:mob/0187.flame_mage/tick/vfx/3
