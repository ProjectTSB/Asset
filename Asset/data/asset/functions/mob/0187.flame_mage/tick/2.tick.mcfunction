...
# 予備動作演出
    execute if entity @s[scores={57.Attack=71..72}] facing entity @p[gamemode=!spectator] eyes anchored eyes positioned ^ ^ ^1 run function asset:mob/0187.flame_mage/tick/vfx/1
    execute if entity @s[scores={57.Attack=74..75}] facing entity @p[gamemode=!spectator] eyes anchored eyes positioned ^ ^ ^1 run function asset:mob/0187.flame_mage/tick/vfx/2
    execute if entity @s[scores={57.Attack=77..78}] facing entity @p[gamemode=!spectator] eyes anchored eyes positioned ^ ^ ^1 run function asset:mob/0187.flame_mage/tick/vfx/3
