...
# テキストディスプレイ召喚
    ...
    ride @e[type=text_display,tag=9L.TextInit,distance=..0.01,limit=1] mount @s
    tag @e[type=text_display,tag=9L.TextInit,distance=..0.01,limit=1] remove 9L.TextInit
