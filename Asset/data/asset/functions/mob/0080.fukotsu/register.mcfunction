#> asset:mob/0080.fukotsu/register
# @within asset:mob/alias/80/register
...
data modify storage asset:mob Lore set value ['{"text":"全身が黄金で染まったスケルトン。","color":"white"}','{"text":"しかし実は金メッキとの噂がある。","color":"white"}']
# 武器
