#> asset:mob/0047.the_heretic/register
# @within asset:mob/alias/47/register
...
# Mobの説明文 (TextComponentString[]) (オプション)
    data modify storage asset:mob Lore set value ['{"text":"異形そのものとしか言い得ないなにか。","color":"white"}','{"text":"こいつの矢には注意が必要だ。","color":"white"}','{"text":"瞬時にテレポートで飛びかかり、その後は剣で戦いを挑む。","color":"white"}']
# 武器
