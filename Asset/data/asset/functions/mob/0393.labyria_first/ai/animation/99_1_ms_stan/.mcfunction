#> asset:mob/0393.labyria_first/ai/animation/99_1_ms_stan/
#
# スタン
#
...
# アニメーション再生
    execute if score @s AX.AnimationTick matches 1 as @e[type=item_display,tag=AX.Root.This,distance=..100] run function animated_java:labyria/animations/15_1_ms_stan/play
