...
# ノーマル仕様 ワープ
    execute if predicate api:global_vars/difficulty/max/normal at @r[tag=!PlayerShouldInvulnerable,distance=..100] rotated ~ 0 positioned ^ ^ ^5 rotated ~180 0 run function asset:mob/0393.labyria_first/ai/general/1.teleport
