#> asset:mob/0029.skeleton_archer/register
# @within asset:mob/alias/29/register
...
# Mobの説明文 (TextComponentString[]) (オプション)
    data modify storage asset:mob Lore set value ['{"text":"ただのスケルトンのように見えるが、","color":"white"}','{"text":"普通のスケルトンより体力が多く","color":"white"}','{"text":"そして矢に当たると大きく吹き飛ばされる。","color":"white"}']
# 武器
...
# 体力 (double) (オプション)
    data modify storage asset:mob Health set value 130.0
# 攻撃力 (double) (オプション)
