...
# エフェクトを付与
    ...
    execute if predicate api:global_vars/difficulty/1_normal run data modify storage api: Argument.Stack set value 2
    execute if predicate api:global_vars/difficulty/2_hard run data modify storage api: Argument.Stack set value 5
