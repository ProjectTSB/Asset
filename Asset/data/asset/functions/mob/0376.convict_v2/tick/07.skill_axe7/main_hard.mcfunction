...
# プレイヤーを見る
    ...
    execute if score @s AG.Tick matches 9 run playsound item.trident.riptide_1 hostile @a ~ ~ ~ 1 2
    execute if score @s AG.Tick matches 9 run playsound item.trident.riptide_1 hostile @a ~ ~ ~ 1 0
...
# リセット
    ...
    execute if score @s AG.Tick matches 77 positioned ^ ^ ^3 run function asset:mob/0376.convict_v2/tick/07.skill_axe7/hard_explode

    execute if score @s AG.Tick matches 79 positioned ^ ^ ^9 run function asset:mob/0376.convict_v2/tick/07.skill_axe7/hard_explode

    execute if score @s AG.Tick matches 81 positioned ^ ^ ^12 run function asset:mob/0376.convict_v2/tick/07.skill_axe7/hard_explode
