...
# アニメーション変える
    execute if score @s AG.Tick matches 1 as @e[type=item_display,tag=AG.AJ,tag=AG.AJLink,sort=nearest,limit=1] run function animated_java:convict/animations/summon/play
