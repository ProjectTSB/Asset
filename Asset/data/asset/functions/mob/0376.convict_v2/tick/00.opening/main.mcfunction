...
# 演出
    execute if score @s AG.Tick matches 17 run playsound minecraft:item.trident.return hostile @a ~ ~ ~ 1 1
    execute if score @s AG.Tick matches 47 run playsound minecraft:item.trident.return hostile @a ~ ~ ~ 1 1
# リセット
