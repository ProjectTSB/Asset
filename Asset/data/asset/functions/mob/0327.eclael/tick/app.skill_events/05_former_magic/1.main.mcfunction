...
# 予兆
    ...
    # execute if score @s 93.AnimationTimer matches 8 run function asset:mob/0327.eclael/tick/app.skill_events/05_former_magic/4.2.2.particle_1
    # execute if score @s 93.AnimationTimer matches 8 run function asset:mob/0327.eclael/tick/app.skill_events/05_former_magic/4.2.3.particle_2
# 攻撃
    execute if score @s 93.AnimationTimer matches 15 run function asset:mob/0327.eclael/tick/app.skill_events/05_former_magic/4.3.1.attack_0
    execute if score @s 93.AnimationTimer matches 35 run function asset:mob/0327.eclael/tick/app.skill_events/05_former_magic/4.4.1.attack_1
    execute if score @s 93.AnimationTimer matches 55 run function asset:mob/0327.eclael/tick/app.skill_events/05_former_magic/4.5.1.attack_2
# 演出
    execute if score @s 93.AnimationTimer matches 45 run playsound entity.lightning_bolt.thunder hostile @a ~ ~ ~ 2 1
    execute if score @s 93.AnimationTimer matches 65 run playsound entity.lightning_bolt.thunder hostile @a ~ ~ ~ 2 1
    execute if score @s 93.AnimationTimer matches 85 run playsound entity.lightning_bolt.thunder hostile @a ~ ~ ~ 2 1
