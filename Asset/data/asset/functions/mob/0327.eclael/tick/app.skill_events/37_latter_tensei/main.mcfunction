...
# 中心点に移動
    ...
    # 移動
        execute if score @s 93.AnimationTimer matches 6 positioned as @e[type=marker,tag=93.Marker.SpawnPoint,sort=nearest,limit=1] facing entity @p feet run tp @s ~ ~-2 ~ ~ 0
    # 演出
