...
# ライン斬撃
    ...
    execute positioned ^9 ^ ^-1 run function api:object/summon
    data modify storage api: Argument.ID set value 2207
    execute store result storage api: Argument.FieldOverride.MobUUID int 1 run scoreboard players get @s MobUUID
...
# 演出
    ...
    data modify storage api: Argument.FieldOverride set value {Item:{id:"stick"},Color:16777088,Frames:[20502,20503,20504],Scale:[18f,1f,20f],Transformation:{left_rotation:{axis:[0,0,1],angle:-1.74533f},right_rotation:[0f,0f,0f,1f],translation:[0f,0f,0f]}}
