...
# # 演出
#     data modify storage api: Argument.FieldOverride set value {Color:65518,Frames:[20335,20336,20337],Scale:[10f,10f,0.1f],Transformation:{left_rotation:[0f,0f,0f,1f],right_rotation:[0f,0f,0f,1f],translation:[0f,0f,0f]}}
