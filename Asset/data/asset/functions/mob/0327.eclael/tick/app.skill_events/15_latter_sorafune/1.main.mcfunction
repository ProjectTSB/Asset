...
# 表情
    ...
    execute if score @s 93.AnimationTimer matches 15 as @e[type=item_display,tag=93.ModelRoot.Target,sort=nearest,limit=1] run function animated_java:eclael/variants/default/apply
