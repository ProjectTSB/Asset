...
# 攻撃
    ...
    # 移動
        ...
        execute if score @s 93.AnimationTimer matches 10 at @p[gamemode=!spectator,distance=..30] facing entity @s feet rotated ~ 0 run function asset:mob/0327.eclael/tick/app.skill_events/36_latter_iai/set_move_position
...
# 攻撃
    # 折り返し前の攻撃判定
        execute if score @s 93.AnimationTimer matches 5 at @a[gamemode=!spectator,tag=93.Skill.IaiMove.Hit,distance=..80] run function asset:mob/0327.eclael/tick/app.skill_events/36_latter_iai/attack_0
        execute if score @s 93.AnimationTimer matches 8 at @a[gamemode=!spectator,tag=93.Skill.IaiMove.Hit,distance=..80] run function asset:mob/0327.eclael/tick/app.skill_events/36_latter_iai/attack_1
        execute if score @s 93.AnimationTimer matches 11 at @a[gamemode=!spectator,tag=93.Skill.IaiMove.Hit,distance=..80] run function asset:mob/0327.eclael/tick/app.skill_events/36_latter_iai/attack_2
        execute if score @s 93.AnimationTimer matches 14 at @a[gamemode=!spectator,tag=93.Skill.IaiMove.Hit,distance=..80] rotated ~180 ~ run function asset:mob/0327.eclael/tick/app.skill_events/36_latter_iai/attack_0
        execute if score @s 93.AnimationTimer matches 14 run tag @a[tag=93.Skill.IaiMove.Hit] remove 93.Skill.IaiMove.Hit
