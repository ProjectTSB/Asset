...
# 移動
    execute if score @s 93.AnimationTimer matches 1 facing entity @p[gamemode=!spectator,distance=..80] feet rotated ~ 0 positioned ^ ^ ^-0.5 run function asset:mob/0327.eclael/tick/app.general/2.teleport
