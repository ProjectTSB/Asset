...
# プレイヤーの方を向く
    execute if score @s 93.AnimationTimer matches 1 facing entity @p[gamemode=!spectator,distance=..80] feet rotated ~ 0 run tp @s ~ ~ ~ ~ ~
    execute if score @s 93.AnimationTimer matches 2..31 run tag @s add 93.Temp.Me
    execute if score @s 93.AnimationTimer matches 2..31 as @p[gamemode=!spectator,distance=..80] run function asset:mob/0327.eclael/tick/app.general/1.rotate
# 移動
    execute if score @s 93.AnimationTimer matches 5 run playsound item.axe.scrape hostile @a ~ ~ ~ 1 2
    execute if score @s 93.AnimationTimer matches 2..10 at @s unless entity @a[gamemode=!spectator,distance=..3] positioned ^ ^ ^0.5 run function asset:mob/0327.eclael/tick/app.general/2.teleport
    execute if score @s 93.AnimationTimer matches 11..13 at @s unless entity @a[gamemode=!spectator,distance=..3] positioned ^ ^ ^0.1 run function asset:mob/0327.eclael/tick/app.general/2.teleport
    execute if score @s 93.AnimationTimer matches 20..28 at @s unless entity @a[gamemode=!spectator,distance=..3] positioned ^ ^ ^0.05 run function asset:mob/0327.eclael/tick/app.general/2.teleport
...
# プレイヤーの方を向く
    ...
    execute if score @s 93.AnimationTimer matches 45..51 as @p[gamemode=!spectator,distance=..80] run function asset:mob/0327.eclael/tick/app.general/1.rotate
# 移動
...
# プレイヤーの方を向く
    ...
    execute if score @s 93.AnimationTimer matches 63..83 as @p[gamemode=!spectator,distance=..80] run function asset:mob/0327.eclael/tick/app.general/1.rotate
# 移動
    execute if score @s 93.AnimationTimer matches 63..73 at @s unless entity @a[gamemode=!spectator,distance=..3] positioned ^ ^ ^0.5 run function asset:mob/0327.eclael/tick/app.general/2.teleport
