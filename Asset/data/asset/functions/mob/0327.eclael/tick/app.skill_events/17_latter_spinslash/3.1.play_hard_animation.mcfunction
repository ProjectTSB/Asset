...
# 再生
    execute as @e[type=item_display,tag=93.ModelRoot.Target,sort=nearest,limit=1] run function animated_java:eclael/animations/17_1_latter_spinslash_to_momiji/tween {duration:1, to_frame: 1}
