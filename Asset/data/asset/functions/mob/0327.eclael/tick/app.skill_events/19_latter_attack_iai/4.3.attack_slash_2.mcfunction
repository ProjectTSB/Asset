...
#
# @within
#   function asset:mob/0327.eclael/tick/app.skill_events/19_latter_attack_iai/**
...
# 対象に
    execute positioned ^ ^ ^3 as @a[tag=!PlayerShouldInvulnerable,distance=..3] run function api:damage/
# リセット
