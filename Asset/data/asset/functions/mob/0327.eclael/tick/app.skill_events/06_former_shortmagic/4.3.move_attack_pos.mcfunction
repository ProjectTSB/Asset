...
# プレイヤーが歩いていそうな場合
    ...
    execute if entity @a[distance=..4] facing entity @a[tag=!PlayerShouldInvulnerable,sort=nearest,limit=1] feet rotated ~ 0 run tp @s ^ ^ ^8 ~ 0
# プレイヤーが走っていそうな場合
    execute if entity @s[tag=!93.Temp.GeneralTarget] unless entity @a[distance=..4] facing entity @a[tag=!PlayerShouldInvulnerable,sort=nearest,limit=1] feet rotated ~ 0 run tp @s ^ ^ ^14 ~ 0
