...
#
# @within
#   function asset:mob/0327.eclael/tick/app.skill_events/03_former_shot/1.main
#   function asset:mob/0327.eclael/tick/app.skill_events/03_former_shot/1.1.main_short
