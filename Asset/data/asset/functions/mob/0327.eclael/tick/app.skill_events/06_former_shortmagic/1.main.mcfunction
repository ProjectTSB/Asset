...
# 攻撃地点決定
    execute if score @s 93.AnimationTimer matches 4 at @a[tag=!PlayerShouldInvulnerable,sort=nearest,limit=1] run summon area_effect_cloud ~ ~0.5 ~ {CustomNameVisible:0b,Particle:"block air",Duration:52,Tags:["Object","93.Aec.AttackPos"]}
    execute if score @s 93.AnimationTimer matches 24 as @e[type=area_effect_cloud,tag=93.Aec.AttackPos,sort=nearest,limit=1] at @s run function asset:mob/0327.eclael/tick/app.skill_events/06_former_shortmagic/4.3.move_attack_pos
# 予兆
...
# 攻撃
    execute if score @s 93.AnimationTimer matches 5 at @e[type=area_effect_cloud,tag=93.Aec.AttackPos,sort=nearest,limit=1] run function asset:mob/0327.eclael/tick/app.skill_events/06_former_shortmagic/4.1.1.attack_0
    execute if score @s 93.AnimationTimer matches 25 at @e[type=area_effect_cloud,tag=93.Aec.AttackPos,sort=nearest,limit=1] positioned ^-5 ^ ^ run function asset:mob/0327.eclael/tick/app.skill_events/06_former_shortmagic/4.1.2.attack_1
    execute if score @s 93.AnimationTimer matches 28 at @e[type=area_effect_cloud,tag=93.Aec.AttackPos,sort=nearest,limit=1] positioned ^ ^ ^ run function asset:mob/0327.eclael/tick/app.skill_events/06_former_shortmagic/4.1.2.attack_1
    execute if score @s 93.AnimationTimer matches 31 at @e[type=area_effect_cloud,tag=93.Aec.AttackPos,sort=nearest,limit=1] positioned ^5 ^ ^ run function asset:mob/0327.eclael/tick/app.skill_events/06_former_shortmagic/4.1.2.attack_1
# 演出
