...
#
# @within
#   function asset:mob/0327.eclael/tick/app.skill_events/20_latter_shot/1.main
...
# 対象に
    execute positioned ^ ^ ^ as @a[tag=!PlayerShouldInvulnerable,distance=..2.5] run function api:damage/
# リセット
