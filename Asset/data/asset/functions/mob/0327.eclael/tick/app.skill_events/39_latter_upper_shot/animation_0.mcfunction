...
# 再生
    execute if predicate api:global_vars/difficulty/max/2_hard as @e[type=item_display,tag=93.ModelRoot.Target,distance=..80,sort=nearest,limit=1] run function animated_java:eclael/animations/38_upper_shot_combo/tween {duration:1, to_frame: 1}
