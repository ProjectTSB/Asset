...
# 再生
    execute as @e[type=item_display,tag=93.ModelRoot.Target,sort=nearest,limit=1] run function animated_java:eclael/animations/18_2_latter_attack_moveslash_near_hard_0/tween {duration:1, to_frame: 1}
