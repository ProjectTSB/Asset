...
# 難易度に応じて後半戦に移行
    execute if predicate api:global_vars/difficulty/1_normal if score $HealthPer Temporary matches ..40 run function asset:mob/0327.eclael/tick/app.general/7.start_change_animation
