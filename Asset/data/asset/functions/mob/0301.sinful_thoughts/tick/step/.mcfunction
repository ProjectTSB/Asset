#> asset:mob/0301.sinful_thoughts/tick/step/
#
#
#
...
# 姿を消す
    execute if score @s 8D.Tick matches 0 run function asset:mob/0301.sinful_thoughts/tick/step/first
# どこかへ移動して
...
# 姿現して
    execute if score @s 8D.Tick matches 20 run function asset:mob/0301.sinful_thoughts/tick/step/show_body
# プレイヤーを見る
...
# 回転斬り
    ...
    execute if score @s 8D.Tick matches 35 run function asset:mob/0301.sinful_thoughts/tick/step/rotate_slash
