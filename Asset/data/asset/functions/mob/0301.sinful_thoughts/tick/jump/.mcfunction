#> asset:mob/0301.sinful_thoughts/tick/jump/
#
#
#
...
# 最初に実行
    execute if score @s 8D.Tick matches 0 run function asset:mob/0301.sinful_thoughts/tick/jump/first
...
# 飛びかかる
    ...
    execute if score @s 8D.Tick matches 15..19 at @s run function asset:mob/0301.sinful_thoughts/tick/jump/pounce
# 斬りつけ
    execute if score @s 8D.Tick matches 20 at @s run function asset:mob/0301.sinful_thoughts/tick/jump/slash
...
# ダメージ
    execute if score @s 8D.Tick matches 1010 rotated ~-90 0 positioned ^ ^ ^1 run function asset:mob/0301.sinful_thoughts/tick/jump/gun
