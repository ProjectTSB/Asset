...
#
# @within function
#   asset:mob/0301.sinful_thoughts/death/
#   asset:mob/0301.sinful_thoughts/death/schedule
#   asset:mob/0301.sinful_thoughts/rejoin_process

# ファンクション
    execute as @e[type=armor_stand,tag=8D.ArmorStandDeath] at @s run function asset:mob/0301.sinful_thoughts/death/death_animation
