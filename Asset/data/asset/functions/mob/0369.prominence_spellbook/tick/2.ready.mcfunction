...
# execute summonを使って実行する
    execute if entity @s[scores={A9.Tick=10..}] anchored eyes positioned ^ ^ ^0.2 summon marker run function asset:mob/0369.prominence_spellbook/tick/3.summon

# リセット
    execute if entity @s[scores={A9.Tick=10..}] run function asset:mob/0369.prominence_spellbook/tick/4.reset
