...
# フェーズ処理
    ...
    # フェーズ移行
        execute unless entity @s[tag=CO.IsLatter] if score $HealthPer Temporary matches ..60 run function asset:mob/0456.gargo_ex_machina/tick/event/change_head/start
    # 終了
