#> asset:mob/0456.gargo_ex_machina/tick/event/shot/summon_laser.m
#
# 射撃
#
...
# 演出
    ...
    execute as @e[type=area_effect_cloud,tag=CO.Temp.Rotation,distance=..30,limit=1] positioned as @s facing entity @e[type=area_effect_cloud,tag=CO.Aec.AttackPosition,distance=..80,limit=1] feet run tp @s ~ ~ ~ ~ ~
