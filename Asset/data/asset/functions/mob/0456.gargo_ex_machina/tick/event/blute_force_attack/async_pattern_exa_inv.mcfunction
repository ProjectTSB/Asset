#> asset:mob/0456.gargo_ex_machina/tick/event/blute_force_attack/async_pattern_exa_inv
#
# ブルートフォースアタック
#
...
# 回転パターン
    ...
    # Yeeter
        ...
        execute if score @s CO.EventTimer.BluteForce matches 161 if predicate api:global_vars/difficulty/min/2_hard rotated ~-180 ~ positioned ^ ^ ^29 rotated ~180 ~ run function asset:mob/0456.gargo_ex_machina/tick/event/blute_force_attack/summon_yeeter_drone.m {IsRotate:"false",IsRotateInverse:"false"}
        execute if score @s CO.EventTimer.BluteForce matches 201 if predicate api:global_vars/difficulty/min/3_blessless rotated ~-225 ~ positioned ^ ^ ^32 rotated ~180 ~ run function asset:mob/0456.gargo_ex_machina/tick/event/blute_force_attack/summon_yeeter_drone.m {IsRotate:"false",IsRotateInverse:"false"}
        execute if score @s CO.EventTimer.BluteForce matches 241 if predicate api:global_vars/difficulty/min/3_blessless rotated ~-270 ~ positioned ^ ^ ^29 rotated ~180 ~ run function asset:mob/0456.gargo_ex_machina/tick/event/blute_force_attack/summon_yeeter_drone.m {IsRotate:"false",IsRotateInverse:"false"}
        execute if score @s CO.EventTimer.BluteForce matches 281 if predicate api:global_vars/difficulty/min/3_blessless rotated ~-315 ~ positioned ^ ^ ^32 rotated ~180 ~ run function asset:mob/0456.gargo_ex_machina/tick/event/blute_force_attack/summon_yeeter_drone.m {IsRotate:"false",IsRotateInverse:"false"}
