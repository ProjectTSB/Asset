#> asset:mob/0456.gargo_ex_machina/tick/event/half_beam_sword/summon_laser
#
# 半面焼きビーム
#
# @within asset:mob/0456.gargo_ex_machina/tick/event/half_beam_sword/summon_laser_start
