...
# 構え
    ...
    # 召喚
        ...
        execute if score @s CO.EventTimer matches 22 positioned as @e[type=marker,tag=CO.CenterPosition,sort=nearest,limit=1] positioned ~ ~-0.499 ~ rotated 0 0 run function asset:mob/0456.gargo_ex_machina/tick/event/field_modify/summon_field_start
