...
# 構え
    ...
    # 召喚開始
        execute if score @s CO.EventTimer matches 24 run tag @s add CO.Skill.BluteForce.Async
        execute if score @s CO.EventTimer matches 24 run scoreboard players set @s CO.EventTimer.BluteForce 0
        # 全員お披露目パターン
