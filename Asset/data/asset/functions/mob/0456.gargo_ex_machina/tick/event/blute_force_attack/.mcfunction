...
# 構え
    ...
    # 召喚
        ...
        execute if score @s CO.EventTimer matches 28 positioned ^-16 ^ ^6 run function asset:mob/0456.gargo_ex_machina/tick/event/blute_force_attack/summon_panjan_drone.m
        execute if score @s CO.EventTimer matches 29 positioned ^16 ^ ^6 run function asset:mob/0456.gargo_ex_machina/tick/event/blute_force_attack/summon_panjan_drone.m
