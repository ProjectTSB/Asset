...
# メモ
    # execute as @e[type=slime,tag=BE.EntityRoot] at @s run function asset:mob/0456.gargo_ex_machina/tick/debug/interrupt

# テスト
    # execute at @e[type=marker,tag=BE.CenterPosition] positioned ~-0.3 ~ ~0.2 run return run function asset:mob/0456.gargo_ex_machina/tick/event/final_flare/particle_floor
