...
# 回復
    execute if predicate api:global_vars/difficulty/max/normal if entity @s[tag=!2C.AttackSkill] run function asset:mob/0084.falcios_priest/tick/2.heal

# 弾を発射
    execute if predicate api:global_vars/difficulty/max/normal if entity @s[tag=2C.AttackSkill] run function asset:mob/0084.falcios_priest/tick/3.shoot
