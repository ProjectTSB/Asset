...
# ノーマル限定でフードを取る
    execute if predicate api:global_vars/difficulty/1_normal as @e[type=item_display,tag=8D.AJ,sort=nearest,limit=1] run function animated_java:karmic/variants/girl/apply
# tpさせる
