...
# CDいれる
    ...
    execute if predicate api:global_vars/difficulty/2_hard run scoreboard players set @s General.Mob.Tick -5
    execute if predicate api:global_vars/difficulty/1_normal run scoreboard players set @s General.Mob.Tick -10
