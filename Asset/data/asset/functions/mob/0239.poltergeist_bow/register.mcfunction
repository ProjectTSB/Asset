#> asset:mob/0239.poltergeist_bow/register
# @within asset:mob/alias/239/register
...
# Mobの説明文 (TextComponentString[]) (オプション)
    data modify storage asset:mob Lore set value ['{"text":"武器が宙を浮いて攻撃してくる？","color":"white"}','{"text":"きっとそれはポルターガイストの仕業だ。","color":"white"}']
# 武器
...
# 属性倍率 // 1.0fで100% 最低でも25%は軽減されずに入る
    ...
    # 魔法倍率 (float) (オプション)
        data modify storage asset:mob Resist.Magic set value 0.70
    # 火倍率 (float) (オプション)
