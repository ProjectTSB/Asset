...
# 攻撃
    ...
    # 攻撃を実行
        execute if score @s General.Mob.Tick matches 20 at @e[type=marker,tag=8N.ModelLocator.RightHand] facing entity @p[gamemode=!spectator,distance=..64] eyes run function asset:mob/0311.blazing_inferno/tick/skill/triple_fireball/shoot/single
    ...
    # 攻撃を実行
        execute if score @s General.Mob.Tick matches 25 at @e[type=marker,tag=8N.ModelLocator.RightHand] facing entity @p[gamemode=!spectator,distance=..64] eyes run function asset:mob/0311.blazing_inferno/tick/skill/triple_fireball/shoot/single
    ...
    # 攻撃を実行
        execute if score @s General.Mob.Tick matches 30 at @e[type=marker,tag=8N.ModelLocator.RightHand] facing entity @p[gamemode=!spectator,distance=..64] eyes run function asset:mob/0311.blazing_inferno/tick/skill/triple_fireball/shoot/single
    ...
    # 攻撃を実行
        execute if score @s General.Mob.Tick matches 35 at @e[type=marker,tag=8N.ModelLocator.RightHand] facing entity @p[gamemode=!spectator,distance=..64] eyes run function asset:mob/0311.blazing_inferno/tick/skill/triple_fireball/shoot/single
    ...
    # フィニッシュ、拡散弾
        ...
        # 攻撃を実行
            ...
            execute if score @s General.Mob.Tick matches 50 at @e[type=marker,tag=8N.ModelLocator.RightHand] facing entity @p[gamemode=!spectator,distance=..64] eyes run function asset:mob/0311.blazing_inferno/tick/skill/triple_fireball/shoot/any
