#> asset:mob/0311.blazing_inferno/tick/skill/ground_slam/falling/knuckle_vfx
#
# イントロのやつと一緒
#
# @within function asset:mob/0311.blazing_inferno/tick/skill/ground_slam/falling/explosion
