...
# 攻撃 1
    ...
    # 攻撃を実行
        execute if score @s General.Mob.Tick matches 10 at @e[type=marker,tag=8N.ModelLocator.RightHand] facing entity @p[gamemode=!spectator,distance=..64] feet rotated ~90 ~-45 run function asset:mob/0311.blazing_inferno/tick/skill/firebomb/shoot
...
# 攻撃 2
    ...
    # 攻撃を実行
        execute if score @s General.Mob.Tick matches 30 at @e[type=marker,tag=8N.ModelLocator.LeftHand] facing entity @p[gamemode=!spectator,distance=..64] feet rotated ~-90 ~-45 run function asset:mob/0311.blazing_inferno/tick/skill/firebomb/shoot
...
# 攻撃 3
    ...
    # 攻撃を実行
        execute if score @s General.Mob.Tick matches 50 at @e[type=marker,tag=8N.ModelLocator.RightHand] facing entity @p[gamemode=!spectator,distance=..64] feet rotated ~ ~-75 run function asset:mob/0311.blazing_inferno/tick/skill/firebomb/shoot
