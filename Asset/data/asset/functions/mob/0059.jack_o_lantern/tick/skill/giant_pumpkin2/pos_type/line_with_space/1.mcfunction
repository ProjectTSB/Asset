...
# 内側の4つのうちランダムな1つを実行しない
    ...
    execute unless score $Random Temporary matches 0 run data modify storage api: Argument.FieldOverride.RotationX set value 0.0
    ...
    execute unless score $Random Temporary matches 1 run data modify storage api: Argument.FieldOverride.RotationX set value 0.0
    ...
    execute unless score $Random Temporary matches 2 run data modify storage api: Argument.FieldOverride.RotationX set value 0.0
    ...
    execute unless score $Random Temporary matches 3 run data modify storage api: Argument.FieldOverride.RotationX set value 0.0
