...
# リセット
    execute if entity @s[scores={General.Mob.Tick=40..}] if predicate api:global_vars/difficulty/easy run function asset:mob/0059.jack_o_lantern/tick/skill/reset
