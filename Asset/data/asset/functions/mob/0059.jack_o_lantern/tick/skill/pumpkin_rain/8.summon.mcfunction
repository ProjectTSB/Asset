#> asset:mob/0059.jack_o_lantern/tick/skill/pumpkin_rain/8.summon
#
# 召喚処理
#
...
# 低確率で他の顔を混ぜる
    execute if predicate lib:random_pass_per/10 store result storage api: Argument.FieldOverride.FaceID int 1 run function asset:mob/0059.jack_o_lantern/tick/skill/pumpkin_rain/9.random_face
