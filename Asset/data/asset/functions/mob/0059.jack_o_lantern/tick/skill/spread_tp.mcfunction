...
# マーカーをワープさせて、そこが安全地帯ならワープする
    ...
    execute at @e[type=marker,tag=SpreadMarker,distance=..50,limit=1] if block ~ ~ ~ #lib:no_collision_without_fluid unless block ~ ~-1 ~ #lib:no_collision_without_fluid run tp @s ~ ~ ~
