...
# ハードで体力40%以下 または Blesslessで速度1.5倍
    execute if predicate api:global_vars/difficulty/normal if entity @e[type=zombie,tag=this,tag=1N.HealthLess40Per,distance=..30,sort=nearest,limit=1] run tag @s add FastRun
