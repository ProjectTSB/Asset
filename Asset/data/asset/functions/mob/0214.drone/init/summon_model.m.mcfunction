...
# 召喚
    $summon item_display ~ ~ ~ {Tags:["5Y.ModelInit","AllowProcessingCommonTag","AutoKillWhenDieVehicle"],transformation:{left_rotation:[0f,0f,0f,1f],right_rotation:[0f,0f,0f,1f],translation:[0f,0.2f,0f],scale:[1.25f,1.25f,1.25f]},item:{id:"minecraft:stick",Count:1b,tag:{CustomModelData:20485}},teleport_duration:1,item_display:"thirdperson_righthand",Rotation:$(Rotation)}
