...
# プレイヤーに接触したら自爆
execute if entity @p[tag=!PlayerShouldInvulnerable,distance=..1] run function asset:mob/0214.drone/tick/suicide

# エンジン音
playsound minecraft:entity.bee.loop hostile @a[distance=..30] ~ ~ ~ 0.2 0.68 0.2
