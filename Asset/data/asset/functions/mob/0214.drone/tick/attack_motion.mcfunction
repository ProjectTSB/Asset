...
# 中心座標を向く(arctan(0.05) = 2.86度/tickぐらいの速度で旋回)
    execute at @s positioned ^ ^ ^1000 facing entity @e[type=marker,tag=5X.Centre,distance=..128,limit=1] feet positioned ^ ^ ^1000 facing entity @s feet positioned as @s positioned ^ ^ ^0.05 rotated as @s positioned ^ ^ ^-1 facing entity @s feet positioned as @s run tp @s ^ ^ ^ ~ ~
