...
# 中心座標を向く(arctan(0.05) = 2.86度/tickぐらいの速度で旋回)
    execute at @s positioned ^ ^ ^1000 facing entity @e[tag=5X.Centre,limit=1] feet positioned ^ ^ ^1000 facing entity @s feet positioned as @s positioned ^ ^ ^0.05 rotated as @s positioned ^ ^ ^-1 facing entity @s feet positioned as @s run tp @s ^ ^ ^ ~ ~
...
# 中心座標の高さにくるまで下降、到達したら水平飛行
    ...
    execute at @e[tag=5X.Centre,distance=..128,limit=1] positioned ~-100 ~1 ~-100 unless entity @s[dx=199,dy=100,dz=199] at @s run tp @s ~ ~ ~ ~ 0
