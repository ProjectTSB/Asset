...
# 滑らかに回転
#    execute as @e[type=wither_skeleton,tag=9H.Temp.This,sort=nearest,limit=1] at @s rotated ~ 0 positioned ^ ^ ^-1 facing entity @a[tag=9H.Temp.Target] feet rotated ~ 0 positioned ^ ^ ^-2 facing entity @s feet positioned as @s run tp @s ^ ^ ^ ~ 0
# 終了
