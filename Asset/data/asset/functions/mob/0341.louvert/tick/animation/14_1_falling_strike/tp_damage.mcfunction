#> asset:mob/0341.louvert/tick/animation/14_1_falling_strike/tp_damage
#
# VFX
#
# @within function
...
# 円
    ...
    particle end_rod ~-0.195 ~0.1 ~0.981 ~-195090368.0 ~0.1 ~980785280.0 0.00000000050 0 force @a[distance=..32]
# 雷
    particle dust -100000000 -1 -0.75 1.2 ~ ~2 ~ 1 3 1 0 150 force @a[distance=..32]
    particle dust -100000000 -1 -0.75 1.2 ~ ~4 ~ 0.25 6 0.25 0 150 force @a[distance=..32]
...
# ダメージ
    ...
    # デスログ
        data modify storage api: Argument.DeathMessage append value '[{"translate": "%1$sは%2$sに突き刺されて燃やされた","with":[{"selector":"@s"},{"nbt":"Return.AttackerName","storage":"lib:","interpret":true}]}]'
# 補正functionを実行
