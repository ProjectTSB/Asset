...
# ソウルブラストを90度回転
    execute at 0-0-0-0-0 as @e[tag=9K.SoulBlast,distance=..0.001,limit=1] run tp @s ^ ^0.01 ^ ~90 ~
# ソウルブラスト召喚
    execute at 0-0-0-0-0 run function asset:mob/0341.louvert/tick/general/5.soul_blast
# ソウルブラストを配置
    execute at 0-0-0-0-0 as @e[tag=9K.SoulBlast,distance=..0.001,limit=1] run tp @s ^ ^ ^ ~ ~
# Makerを戻してあげる
