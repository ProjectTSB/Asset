...
# ソウルクエイク発動3
    execute if score @s 9H.AnimationTick matches 36 if predicate api:global_vars/difficulty/min/hard run function asset:mob/0341.louvert/tick/animation/14_1_falling_strike/third

# ソウルクエイク発動4
    execute if score @s 9H.AnimationTick matches 39 if predicate api:global_vars/difficulty/min/hard run function asset:mob/0341.louvert/tick/animation/14_1_falling_strike/forth
