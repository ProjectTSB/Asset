...
# アニメーション開始
    execute if score @s 9H.AnimationTick matches 1 as @e[type=item_display,tag=9H.Root.This] run function animated_java:louvert/animations/06_1_move_start/play
