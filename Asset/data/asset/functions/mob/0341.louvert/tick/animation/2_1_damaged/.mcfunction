#> asset:mob/0341.louvert/tick/animation/2_1_damaged/
#
# ダメージを受けた時のアニメーション1
#
...
# アニメーション再生
    execute if score @s 9H.AnimationTick matches 1 as @e[type=item_display,tag=9H.Root.This,distance=..100] run function animated_java:louvert/animations/02_1_damage/play
