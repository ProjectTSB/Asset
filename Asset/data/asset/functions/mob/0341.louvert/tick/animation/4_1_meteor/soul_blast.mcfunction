...
# ソウルブラストの向きランダム
    execute at 0-0-0-0-0 as @e[tag=9K.SoulBlast,distance=..0.01,limit=1] facing entity @a[tag=!PlayerShouldInvulnerable,distance=..100,sort=nearest,limit=1] eyes rotated ~90 0 run tp @s ~ ~ ~ ~ ~
