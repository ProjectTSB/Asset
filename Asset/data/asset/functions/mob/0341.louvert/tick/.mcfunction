...
# ラストスペル中プレイヤーを引き寄せる
    ...
    execute if entity @s[tag=9H.LastSpell] at @e[type=marker,tag=9H.Marker.SummonPoint,distance=..100] positioned ~-100 ~-100 ~-100 as @a[dx=199,dy=96,dz=199] at @s facing entity @e[type=marker,tag=9H.Marker.SummonPoint,distance=..100,limit=1] eyes run tp @s ^ ^ ^
