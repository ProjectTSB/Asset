#> asset:mob/0341.louvert/death/2.2.death_animation
#
# マーカーに対する処理
#
# @within function asset:mob/0341.louvert/death/2.1.schedule
...
# アニメーション終了処理
    execute if score @s 9H.AnimationTick matches 111 run function asset:mob/0341.louvert/death/2.3.kill
