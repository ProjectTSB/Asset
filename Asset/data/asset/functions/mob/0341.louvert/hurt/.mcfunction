...
# 待機時 稀に怯む
    ...
    execute if predicate api:global_vars/difficulty/min/hard if score @s 9H.AnimationNum matches 11 unless score @s 9H.FalterCount matches 1.. if predicate lib:random_pass_per/15 run function asset:mob/0341.louvert/hurt/falter_start
