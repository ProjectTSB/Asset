...
# ハード：体力10%以下の場合、ラストスペルに移行
    execute if predicate api:global_vars/difficulty/min/hard if entity @s[tag=!9H.DoLastSpell] if score @s 9H.HPPer matches ..10 run function asset:mob/0341.louvert/hurt/last_spell_start
