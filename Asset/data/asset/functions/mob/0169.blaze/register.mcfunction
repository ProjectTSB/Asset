#> asset:mob/0169.blaze/register
# @within asset:mob/alias/169/register
...
# Mobの説明文 (TextComponentString[]) (オプション)
    data modify storage asset:mob Lore set value ['{"text":"ただのブレイズ。","color":"white"}','{"text":"火が燃え広がらないようにだけ気をつけよう。","color":"white"}']
# 武器
...
# 属性倍率 // 1.0fで100% 最低でも25%は軽減されずに入る
    ...
    # 水倍率 (float) (オプション)
        data modify storage asset:mob Resist.Water set value 1.6
    # 雷倍率 (float) (オプション)
