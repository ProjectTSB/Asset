#> asset:mob/0058.divide_haze/register
# @within asset:mob/alias/58/register
...
# Mobの説明文 (TextComponentString[]) (オプション)
    data modify storage asset:mob Lore set value ['{"text":"放っておくと増殖する謎の靄。","color":"white"}','{"text":"近づくと蝕まれてしまう。","color":"white"}']
# 武器
...
# 体力 (double) (オプション)
    data modify storage asset:mob Health set value 80.0
# 攻撃力 (double) (オプション)
