#> asset:mob/0284.lexiel/tick/skill/spin/
#
#
#
# @within function asset:mob/0284.lexiel/tick/skill_active

    execute if score @s 7W.Tick matches 0 as @e[type=armor_stand,tag=7W.ModelChangeTarget,tag=7W.ModelBody,distance=..0.5,sort=nearest,limit=1] run function asset:mob/0284.lexiel/tick/skill/spin/first
...
# ダメージ
    execute if score @s 7W.Tick matches 30 run function asset:mob/0284.lexiel/tick/skill/spin/damage
