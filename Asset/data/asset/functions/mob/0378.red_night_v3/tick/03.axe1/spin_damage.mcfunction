#> asset:mob/0378.red_night_v3/tick/03.axe1/spin_damage
#
#
#
# @within function asset:mob/0378.red_night_v3/tick/03.axe1/main


# 演出
    playsound minecraft:item.trident.return hostile @a ~ ~ ~ 1 2
    function asset:mob/0378.red_night_v3/tick/03.axe1/particle
