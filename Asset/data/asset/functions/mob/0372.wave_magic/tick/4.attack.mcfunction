#> asset:mob/0372.wave_magic/tick/4.attack
#
# 攻撃
#
# @within function asset:mob/0372.wave_magic/tick/3.on_ground
...
# ノーマル以上ならデバフを付与
    execute if predicate api:global_vars/difficulty/min/normal as @a[tag=!PlayerShouldInvulnerable,distance=..1.5] run function asset:mob/0372.wave_magic/tick/5.debuff
