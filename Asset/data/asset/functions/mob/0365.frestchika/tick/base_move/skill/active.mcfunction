...
# 技リスト
    ...
    execute if entity @s[tag=A5.Skill.CordinateLaser] run function asset:mob/0365.frestchika/tick/base_move/skill/cordinate_laser/
    execute if entity @s[tag=A5.Skill.RandomTeleportSlash] run function asset:mob/0365.frestchika/tick/base_move/skill/random_teleport_slash/
