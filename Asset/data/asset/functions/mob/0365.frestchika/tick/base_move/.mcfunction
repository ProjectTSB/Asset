...
# プレイヤーが周囲にいたらスキル選択
    execute if score @s[tag=!A5.CycleReset,tag=!A5.InAction] General.Mob.Tick matches 40.. if entity @p[distance=..64] run function asset:mob/0365.frestchika/tick/base_move/skill/select/
