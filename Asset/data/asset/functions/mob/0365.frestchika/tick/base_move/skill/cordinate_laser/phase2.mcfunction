...
# レーザー攻撃！
    ...
    # 2
        execute if predicate api:global_vars/difficulty/min/normal if score @s General.Mob.Tick matches 28 at @e[type=marker,tag=A5.Marker.Aim,distance=..128,limit=1] rotated ~ ~ positioned ^ ^ ^5 run function asset:mob/0365.frestchika/tick/base_move/skill/cordinate_laser/summon
        ...
        execute if predicate api:global_vars/difficulty/min/normal if score @s General.Mob.Tick matches 30 at @e[type=marker,tag=A5.Marker.Aim,distance=..128,limit=1] rotated ~90 ~ positioned ^ ^ ^5 run function asset:mob/0365.frestchika/tick/base_move/skill/cordinate_laser/summon
        ...
        execute if predicate api:global_vars/difficulty/min/normal if score @s General.Mob.Tick matches 32 at @e[type=marker,tag=A5.Marker.Aim,distance=..128,limit=1] rotated ~180 ~ positioned ^ ^ ^5 run function asset:mob/0365.frestchika/tick/base_move/skill/cordinate_laser/summon
        ...
        execute if predicate api:global_vars/difficulty/min/normal if score @s General.Mob.Tick matches 34 at @e[type=marker,tag=A5.Marker.Aim,distance=..128,limit=1] rotated ~270 ~ positioned ^ ^ ^5 run function asset:mob/0365.frestchika/tick/base_move/skill/cordinate_laser/summon
    ...
    # 4、再び戻っていく
        ...
        execute if predicate api:global_vars/difficulty/min/normal if score @s General.Mob.Tick matches 81 at @e[type=marker,tag=A5.Marker.Aim,distance=..128,limit=1] rotated ~45 ~ positioned ^ ^ ^5 run function asset:mob/0365.frestchika/tick/base_move/skill/cordinate_laser/summon
        ...
        execute if predicate api:global_vars/difficulty/min/normal if score @s General.Mob.Tick matches 83 at @e[type=marker,tag=A5.Marker.Aim,distance=..128,limit=1] rotated ~135 ~ positioned ^ ^ ^5 run function asset:mob/0365.frestchika/tick/base_move/skill/cordinate_laser/summon
        ...
        execute if predicate api:global_vars/difficulty/min/normal if score @s General.Mob.Tick matches 85 at @e[type=marker,tag=A5.Marker.Aim,distance=..128,limit=1] rotated ~225 ~ positioned ^ ^ ^5 run function asset:mob/0365.frestchika/tick/base_move/skill/cordinate_laser/summon
        ...
        execute if predicate api:global_vars/difficulty/min/normal if score @s General.Mob.Tick matches 87 at @e[type=marker,tag=A5.Marker.Aim,distance=..128,limit=1] rotated ~315 ~ positioned ^ ^ ^5 run function asset:mob/0365.frestchika/tick/base_move/skill/cordinate_laser/summon
    # 5
        execute if predicate api:global_vars/difficulty/min/normal if score @s General.Mob.Tick matches 88 at @e[type=marker,tag=A5.Marker.Aim,distance=..128,limit=1] rotated ~ ~ positioned ^ ^ ^8 run function asset:mob/0365.frestchika/tick/base_move/skill/cordinate_laser/summon
        ...
        execute if predicate api:global_vars/difficulty/min/normal if score @s General.Mob.Tick matches 90 at @e[type=marker,tag=A5.Marker.Aim,distance=..128,limit=1] rotated ~90 ~ positioned ^ ^ ^8 run function asset:mob/0365.frestchika/tick/base_move/skill/cordinate_laser/summon
        ...
        execute if predicate api:global_vars/difficulty/min/normal if score @s General.Mob.Tick matches 92 at @e[type=marker,tag=A5.Marker.Aim,distance=..128,limit=1] rotated ~180 ~ positioned ^ ^ ^8 run function asset:mob/0365.frestchika/tick/base_move/skill/cordinate_laser/summon
        ...
        execute if predicate api:global_vars/difficulty/min/normal if score @s General.Mob.Tick matches 94 at @e[type=marker,tag=A5.Marker.Aim,distance=..128,limit=1] rotated ~270 ~ positioned ^ ^ ^8 run function asset:mob/0365.frestchika/tick/base_move/skill/cordinate_laser/summon
