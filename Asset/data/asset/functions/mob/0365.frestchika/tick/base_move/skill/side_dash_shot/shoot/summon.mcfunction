#> asset:mob/0365.frestchika/tick/base_move/skill/side_dash_shot/shoot/summon
#
#
#
# @within function asset:mob/0365.frestchika/tick/base_move/skill/side_dash_shot/shoot/
