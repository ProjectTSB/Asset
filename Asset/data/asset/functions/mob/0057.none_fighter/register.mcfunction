#> asset:mob/0057.none_fighter/register
# @within asset:mob/alias/57/register
...
# Mobの説明文 (TextComponentString[]) (オプション)
    data modify storage asset:mob Lore set value ['{"text":"虚空の戦士の異名を持つ魔物。","color":"white"}','{"text":"戦闘スタイルは剣か弓を使用する。","color":"white"}']
# 武器
