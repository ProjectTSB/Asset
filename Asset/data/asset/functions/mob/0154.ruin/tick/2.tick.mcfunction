...
# 一定のスコアに達したら1度発動
    execute if entity @s[scores={4A.Madness=170}] run function asset:mob/0154.ruin/tick/3.ready

# その後発動し続けるやつ
    execute if entity @s[scores={4A.Madness=170..}] run function asset:mob/0154.ruin/tick/4.madness