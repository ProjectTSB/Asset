...
execute anchored eyes positioned ^ ^ ^2 as @e[type=item_display,tag=AW.AnnounceInit,distance=..0.1] run function asset:mob/0392.ecual_first/ai/projectile/announce_line/1.init.m {Num:-30}
