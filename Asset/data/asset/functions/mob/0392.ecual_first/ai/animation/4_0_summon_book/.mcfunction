...
# 魔導書召喚
    execute if score @s AW.AnimationTick matches 41 if predicate api:global_vars/difficulty/max/2_hard run function asset:mob/0392.ecual_first/ai/animation/4_0_summon_book/summon/normal
    execute if score @s AW.AnimationTick matches 61 if predicate api:global_vars/difficulty/max/2_hard run function asset:mob/0392.ecual_first/ai/animation/4_0_summon_book/summon/normal
