#> asset:mob/0392.ecual_first/ai/animation/99_1_damaged_2/
#
# 被弾アニメーション2
#
...
# アニメーション再生
    execute if score @s AW.AnimationTick matches 1 as @e[type=item_display,tag=AW.Root.This,distance=..100] run function animated_java:ecual/animations/11_1_damage_2/play
