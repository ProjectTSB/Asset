...
# スコアが正かつ透明状態なら可視化
    execute if score @s AW.ProjectileTick matches 1.. unless entity @s[tag=AW.Inbisible] on passengers run data merge entity @s {teleport_duration:1,transformation:{scale:[0.1f,0.1f,40f]}}
