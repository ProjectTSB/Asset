...
# クールタイム設定
    execute if predicate api:global_vars/difficulty/1_normal run scoreboard players set @e[type=zombie,tag=this,distance=..5,sort=nearest,limit=1] 6C.AttackCT 40
