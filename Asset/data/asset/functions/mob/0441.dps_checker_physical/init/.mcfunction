...
# モデルを、自分の上に乗せる
    summon item_display ~ ~ ~ {Tags:["Init","ProcessCommonTag","AutoKillWhenDieVehicle"],transformation:{left_rotation:[0f,0f,0f,1f],right_rotation:[0f,0f,0f,1f],translation:[0f,-1.12f,0f],scale:[1f,1f,1f]},item:{id:"minecraft:leather_horse_armor",Count:1b,tag:{CustomModelData:20562,display:{color:10361884}}}}
