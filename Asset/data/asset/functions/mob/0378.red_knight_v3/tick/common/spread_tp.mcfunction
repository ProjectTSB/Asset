#> asset:mob/0378.red_knight_v3/tick/common/spread_tp
#
#
#
# @within function asset:mob/0378.red_knight_v3/tick/common/tp
...
# ディスプレイもってくる用
    execute at @s run function asset:mob/0378.red_knight_v3/tick/common/tp
