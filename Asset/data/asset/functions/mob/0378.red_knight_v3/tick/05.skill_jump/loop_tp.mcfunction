...
# マーカーが来たらTP確定
    execute if entity @e[type=marker,tag=TPMarker,distance=..1,sort=nearest,limit=1] facing entity @e[type=marker,tag=TPMarker,distance=..40,sort=nearest,limit=1] feet run function asset:mob/0378.red_knight_v3/tick/05.skill_jump/tp
# 自分から離れ過ぎたらTP確定
    execute unless entity @s[distance=..40] run function asset:mob/0378.red_knight_v3/tick/05.skill_jump/tp
