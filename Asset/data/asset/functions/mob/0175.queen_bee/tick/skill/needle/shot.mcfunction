...
# 着弾
    execute if entity @s[tag=Landing] run function asset:mob/0175.queen_bee/tick/skill/needle/landing

# 再起
    execute positioned ^ ^ ^0.5 if entity @s[tag=!Landing,distance=..30] run function asset:mob/0175.queen_bee/tick/skill/needle/shot
