...
# 発砲
    execute if score @s General.Mob.Tick matches 25..30 positioned ~ ~-1.5 ~ positioned ^ ^ ^1 run function asset:mob/0175.queen_bee/tick/skill_needle/2.skill_needle_ready
