#> asset:mob/0242.poltergeist_subspecies_bow/register
# @within asset:mob/alias/242/register
...
# Mobの説明文 (TextComponentString[]) (オプション)
    data modify storage asset:mob Lore set value ['{"text":"武器が宙を浮いて攻撃してくる？","color":"white"}','{"text":"きっとそれはポルターガイストの仕業だ。","color":"white"}','{"text":"しかも、ちょっと強い。","color":"white"}']
# 武器
...
# 体力 (double) (オプション)
    data modify storage asset:mob Health set value 340
# 攻撃力 (double) (オプション)
