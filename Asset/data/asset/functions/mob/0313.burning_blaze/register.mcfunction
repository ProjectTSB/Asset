...
# Mobのデータを指定
#
# @within function asset:mob/alias/313/register
...
# 名前 (TextComponentString) (オプション)
    data modify storage asset:mob Name set value '{"text":"バーニング・ブレイズ","color":"white","bold":false,"italic":false}'
# Mobの説明文 (TextComponentString[]) (オプション)
    data modify storage asset:mob Lore set value ['{"text":"ブレイジング・インフェルノの下っ端のブレイズ。","color":"white"}','{"text":"見た目はそこらのブレイズと全く同じだが、そこらのブレイズよりも、ちゃんと強い。","color":"white"}']
# 武器
...
# 体力 (double) (オプション)
    data modify storage asset:mob Health set value 1000d
# 攻撃力 (double) (オプション)
