#> asset:mob/0323.mini_elder_guardian/register
#
# Mobのデータを指定
#
# @within function asset:mob/alias/323/register
...
# 防具
    # 頭 (Compound(Item)) (オプション)
        data modify storage asset:mob Armor.Head set value {id:"minecraft:stick",Count:1b,tag:{CustomModelData:20619}}
...
# 移動速度 (double) (オプション)
    data modify storage asset:mob Speed set value 0.08
# 索敵範囲 (double) (オプション)
