#> asset:mob/0372.tutankhamen/tick/skill/dash/slash/
#
#
#
...
# ダッシュ開始
    execute if score @s General.Mob.Tick matches 0 run function asset:mob/0372.tutankhamen/tick/skill/dash/slash/start

# プレイヤーの方へ誘導する
    execute if score @s General.Mob.Tick matches ..99 run function asset:mob/0372.tutankhamen/tick/skill/dash/slash/move
...
# 斬撃の構え
    execute if score @s General.Mob.Tick matches 100 run function asset:mob/0372.tutankhamen/tick/skill/dash/slash/slash/windup

# 構えその2
    execute if score @s General.Mob.Tick matches 115 run function asset:mob/0372.tutankhamen/tick/skill/dash/slash/slash/windup_2

# そして斬撃のダメージ
    execute if score @s General.Mob.Tick matches 118 run function asset:mob/0372.tutankhamen/tick/skill/dash/slash/slash/damage
