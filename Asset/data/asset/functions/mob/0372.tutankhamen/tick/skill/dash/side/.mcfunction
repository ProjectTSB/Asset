...
# ウソ慣性
    ...
    execute if score @s General.Mob.Tick matches 20..25 unless function asset:mob/0372.tutankhamen/tick/skill/dash/check_collide run tp @s ^ ^ ^0.3
    execute if score @s General.Mob.Tick matches 25..30 unless function asset:mob/0372.tutankhamen/tick/skill/dash/check_collide run tp @s ^ ^ ^0.1
