#> asset:mob/0372.tutankhamen/tick/skill/hyper_laser/recursive
#
#
#
# @within function
...
# 再帰
    execute if score $Recursive Temporary matches ..60 positioned ^ ^ ^0.5 run function asset:mob/0372.tutankhamen/tick/skill/hyper_laser/recursive
