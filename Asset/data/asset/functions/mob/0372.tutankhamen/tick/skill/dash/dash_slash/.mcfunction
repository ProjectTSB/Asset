#> asset:mob/0372.tutankhamen/tick/skill/dash/charge/dash_slash/
#
#
#
...
# ダッシュ開始
    execute if score @s General.Mob.Tick matches 0 run function asset:mob/0372.tutankhamen/tick/skill/dash/charge/dash_slash/start

# プレイヤーの方へ誘導する
    execute if score @s General.Mob.Tick matches ..99 run function asset:mob/0372.tutankhamen/tick/skill/dash/charge/dash_slash/move
...
# 斬撃の構え
    execute if score @s General.Mob.Tick matches 100 run function asset:mob/0372.tutankhamen/tick/skill/dash/charge/dash_slash/slash/windup

# 構えその2
    execute if score @s General.Mob.Tick matches 115 run function asset:mob/0372.tutankhamen/tick/skill/dash/charge/dash_slash/slash/windup_2

# そして斬撃のダメージ
    execute if score @s General.Mob.Tick matches 118 run function asset:mob/0372.tutankhamen/tick/skill/dash/charge/dash_slash/slash/damage
