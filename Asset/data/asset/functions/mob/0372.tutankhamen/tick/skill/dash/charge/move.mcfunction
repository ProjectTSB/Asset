...
# 壁があったら止まる
    execute at @s if function asset:mob/0372.tutankhamen/tick/skill/dash/charge/check_collide/forward run tp @s ~ ~ ~ ~ 0
    execute at @s if function asset:mob/0372.tutankhamen/tick/skill/dash/charge/check_collide/forward run scoreboard players set @s General.Mob.Tick 30
    execute at @s if function asset:mob/0372.tutankhamen/tick/skill/dash/charge/check_collide/forward run return 0
