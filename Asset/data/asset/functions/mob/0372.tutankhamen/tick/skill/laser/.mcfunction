...
# Rotationをフィールドに入れてからdisplayを前方に召喚
    ...
    execute if entity @s[scores={General.Mob.Tick=20}] at @s anchored eyes positioned ^0.2 ^-0.5 ^18 run function asset:mob/0372.tutankhamen/tick/skill/common/summon_laser_display.m with storage asset:context this
    ...
    execute if entity @s[scores={General.Mob.Tick=55}] at @s anchored eyes positioned ^0.2 ^-0.5 ^18 run function asset:mob/0372.tutankhamen/tick/skill/common/summon_laser_display.m with storage asset:context this
    ...
    execute if entity @s[scores={General.Mob.Tick=75}] at @s anchored eyes positioned ^0.2 ^-0.5 ^18 run function asset:mob/0372.tutankhamen/tick/skill/common/summon_laser_display.m with storage asset:context this
