...
# AJアニメーション
    ...
    execute if entity @s[scores={General.Mob.Tick=11}] as @e[type=item_display,tag=AC.AJLink,distance=..0.01,sort=nearest,limit=1] run function animated_java:tutankhamen/animations/beam_shot/play
...
# Rotationをフィールドに入れてからdisplayを前方に召喚
    ...
    execute if entity @s[scores={General.Mob.Tick=20}] at @s anchored eyes positioned ^-0.35 ^-0.5 ^8 run function asset:mob/0372.tutankhamen/tick/skill/common/summon_laser_display.m with storage asset:context this
    ...
    execute if entity @s[scores={General.Mob.Tick=55}] at @s anchored eyes positioned ^-0.35 ^-0.5 ^8 run function asset:mob/0372.tutankhamen/tick/skill/common/summon_laser_display.m with storage asset:context this
    ...
    execute if entity @s[scores={General.Mob.Tick=75}] at @s anchored eyes positioned ^-0.35 ^-0.5 ^8 run function asset:mob/0372.tutankhamen/tick/skill/common/summon_laser_display.m with storage asset:context this
...
# レーザー発射
    execute if entity @s[scores={General.Mob.Tick=45}] at @s anchored eyes positioned ^-0.35 ^-0.5 ^1 run function asset:mob/0372.tutankhamen/tick/skill/laser/shoot
    execute if entity @s[scores={General.Mob.Tick=65}] at @s anchored eyes positioned ^-0.35 ^-0.5 ^1 run function asset:mob/0372.tutankhamen/tick/skill/laser/shoot
    execute if entity @s[scores={General.Mob.Tick=85}] at @s anchored eyes positioned ^-0.35 ^-0.5 ^1 run function asset:mob/0372.tutankhamen/tick/skill/laser/shoot
