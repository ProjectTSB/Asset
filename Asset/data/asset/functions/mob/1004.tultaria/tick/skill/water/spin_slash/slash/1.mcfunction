#> asset:mob/1004.tultaria/tick/skill/water/spin_slash/slash/1
#
#
#
...
#    data modify storage api: Argument.FieldOverride set value {Item:{id:"minecraft:leather_horse_armor",Count:1b},Color:8251903,Frames:[20353,20354,20355],Scale:[10f,10f,0.1f],Transformation:{left_rotation:[-0.5f,-0.5f,-0.5f,0.5f],right_rotation:[0f,0f,0f,1f],translation:[0f,0f,0f]}}
    data modify storage api: Argument.FieldOverride set value {Item:{id:"minecraft:leather_horse_armor",Count:1b},Color:8251903,Frames:[20353,20354,20355],Scale:[10f,10f,0.1f],Transformation:{left_rotation:[0.27f,-0.65f,0.27f,0.65f],right_rotation:[0f,0f,0f,1f],translation:[0f,0f,0f]}}
