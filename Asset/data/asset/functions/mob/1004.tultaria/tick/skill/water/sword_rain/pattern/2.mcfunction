...
# 設置: ノーマルモードだとスカスカになる
    ...
    execute if score @s General.Mob.Tick matches 30 positioned ~-10 ~5 ~ run function asset:mob/1004.tultaria/tick/skill/water/sword_rain/sword/summon
    execute if predicate api:global_vars/difficulty/min/2_hard if score @s General.Mob.Tick matches 35 positioned ~15 ~5 ~ run function asset:mob/1004.tultaria/tick/skill/water/sword_rain/sword/summon
    execute if predicate api:global_vars/difficulty/min/2_hard if score @s General.Mob.Tick matches 35 positioned ~-15 ~5 ~ run function asset:mob/1004.tultaria/tick/skill/water/sword_rain/sword/summon
