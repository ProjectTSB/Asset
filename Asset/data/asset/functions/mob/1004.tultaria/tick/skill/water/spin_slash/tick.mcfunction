...
# 剣を振りながら前進
    ...
    # 慣性
        execute if score @s RW.Tick matches 40..45 run tp @s ^ ^ ^0.8
        execute if score @s RW.Tick matches 45..50 run tp @s ^ ^ ^0.5
        execute if score @s RW.Tick matches 50..60 run tp @s ^ ^ ^0.3
    ...
    # 慣性
        execute if score @s RW.Tick matches 60..65 run tp @s ^ ^ ^0.8
        execute if score @s RW.Tick matches 65..70 run tp @s ^ ^ ^0.5
        execute if score @s RW.Tick matches 70..75 run tp @s ^ ^ ^0.3
        execute if score @s RW.Tick matches 75..80 run tp @s ^ ^ ^0.1

# 剣を解き放つ
    execute if score @s RW.Tick matches 97 as @e[type=item_display,tag=RW.ModelRoot,sort=nearest,limit=1] run function animated_java:tultaria/animations/attack_melee_1/stop
    execute if score @s RW.Tick matches 97 as @e[type=item_display,tag=RW.ModelRoot,sort=nearest,limit=1] run function animated_java:tultaria/animations/attack_magic_2_right/play
