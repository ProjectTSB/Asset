...
# 設置: ノーマルモードだとスカスカになる
    ...
    execute if score @s General.Mob.Tick matches 30 positioned ~ ~5 ~-10 run function asset:mob/1004.tultaria/tick/skill/water/sword_rain/sword/summon
    execute if predicate api:global_vars/difficulty/min/normal if score @s General.Mob.Tick matches 35 positioned ~ ~5 ~15 run function asset:mob/1004.tultaria/tick/skill/water/sword_rain/sword/summon
    execute if predicate api:global_vars/difficulty/min/normal if score @s General.Mob.Tick matches 35 positioned ~ ~5 ~-15 run function asset:mob/1004.tultaria/tick/skill/water/sword_rain/sword/summon
