...
# タグ付与連打
    execute if score @s RW.Tick matches 50..70 as @e[type=area_effect_cloud,tag=S2.Wait,sort=random,limit=2] at @s run function asset:mob/1004.tultaria/tick/skill/light/stellar_fury_1/tag_remove
