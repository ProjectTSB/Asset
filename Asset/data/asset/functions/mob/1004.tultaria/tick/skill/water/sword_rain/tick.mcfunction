...
# 構えて攻撃のパターンを決定
    execute if score @s RW.Tick matches 0 run function asset:mob/1004.tultaria/tick/skill/water/sword_rain/windup
...
# 攻撃
    ...
    # 4
        execute if entity @s[tag=RW.Skill.SwordRain.4] run function asset:mob/1004.tultaria/tick/skill/water/sword_rain/pattern/4
