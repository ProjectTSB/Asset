...
# 設置と同時にこっちを向く
    execute if score @s RW.Tick matches 25 as @e[type=item_display,tag=RW.ModelRoot,sort=nearest,limit=1] facing entity @p eyes run tp @s ~ ~0.5 ~ ~ 0
    execute if score @s RW.Tick matches 25 facing entity @p feet run tp @s ~ ~ ~ ~ ~
