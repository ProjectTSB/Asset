...
# サウンド
    ...
    execute if predicate api:global_vars/difficulty/min/normal if score @s General.Mob.Tick matches 60 at @a[distance=..100] run playsound minecraft:entity.ghast.shoot player @p ~ ~ ~ 3 1
    execute if predicate api:global_vars/difficulty/min/normal if score @s General.Mob.Tick matches 65 at @a[distance=..100] run playsound minecraft:entity.ghast.shoot player @p ~ ~ ~ 3 1
...
# メテオ落下
    ...
    execute if score @s General.Mob.Tick matches 50 run function asset:mob/1004.tultaria/tick/skill/fire/meteor_rain/meteor/spread
    ...
    execute if predicate api:global_vars/difficulty/min/normal if score @s General.Mob.Tick matches 60 run function asset:mob/1004.tultaria/tick/skill/fire/meteor_rain/meteor/spread
    execute if predicate api:global_vars/difficulty/min/normal if score @s General.Mob.Tick matches 65 run function asset:mob/1004.tultaria/tick/skill/fire/meteor_rain/meteor/spread
