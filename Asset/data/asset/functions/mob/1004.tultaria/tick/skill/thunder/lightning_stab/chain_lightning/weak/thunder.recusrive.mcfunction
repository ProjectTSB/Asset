...
# 再帰
    ...
    execute if entity @s[tag=RW.ChainLightning5,distance=..60] unless entity @e[type=marker,tag=RW.ChainLightning.Last,distance=..0.5] positioned ^ ^ ^1 run function asset:mob/1004.tultaria/tick/skill/thunder/lightning_stab/chain_lightning/weak/thunder.recusrive
    execute if entity @s[tag=RW.ChainLightning.Last,distance=..60] unless entity @e[type=marker,tag=RW.ChainLightning1,distance=..0.5] positioned ^ ^ ^1 run function asset:mob/1004.tultaria/tick/skill/thunder/lightning_stab/chain_lightning/weak/thunder.recusrive
