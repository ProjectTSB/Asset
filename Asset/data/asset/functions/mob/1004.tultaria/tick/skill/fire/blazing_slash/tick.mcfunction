...
# 警告
    execute if score @s General.Mob.Tick matches 0 run function asset:mob/1004.tultaria/tick/skill/fire/blazing_slash/alert
    execute if score @s[scores={RW.Phase=2..}] General.Mob.Tick matches 10 positioned ^5 ^ ^ run function asset:mob/1004.tultaria/tick/skill/fire/blazing_slash/alert
    execute if score @s[scores={RW.Phase=2..}] General.Mob.Tick matches 10 positioned ^-5 ^ ^ run function asset:mob/1004.tultaria/tick/skill/fire/blazing_slash/alert
    execute if score @s[scores={RW.Phase=3..}] General.Mob.Tick matches 20 positioned ^11 ^ ^ run function asset:mob/1004.tultaria/tick/skill/fire/blazing_slash/alert
    execute if score @s[scores={RW.Phase=3..}] General.Mob.Tick matches 20 positioned ^-11 ^ ^ run function asset:mob/1004.tultaria/tick/skill/fire/blazing_slash/alert
...
# 爆発
    # 1
        execute if score @s General.Mob.Tick matches 30 run function asset:mob/1004.tultaria/tick/skill/fire/blazing_slash/explosion/
    # 2
        execute if score @s[scores={RW.Phase=2..}] General.Mob.Tick matches 40 positioned ^5 ^ ^ run function asset:mob/1004.tultaria/tick/skill/fire/blazing_slash/explosion/
        execute if score @s[scores={RW.Phase=2..}] General.Mob.Tick matches 40 positioned ^-5 ^ ^ run function asset:mob/1004.tultaria/tick/skill/fire/blazing_slash/explosion/
    # 3
        execute if score @s[scores={RW.Phase=3..}] General.Mob.Tick matches 50 positioned ^11 ^ ^ run function asset:mob/1004.tultaria/tick/skill/fire/blazing_slash/explosion/
        execute if score @s[scores={RW.Phase=3..}] General.Mob.Tick matches 50 positioned ^-11 ^ ^ run function asset:mob/1004.tultaria/tick/skill/fire/blazing_slash/explosion/
