...
# 構え
    execute if score @s RW.Tick matches 0 run function asset:mob/1004.tultaria/tick/skill/transition/phase_2_to_3/windup
...
# センターに移動
    execute if score @s RW.Tick matches 30 run function asset:mob/1004.tultaria/tick/skill/transition/phase_2_to_3/move_to_center
...
# 攻撃スタート
    execute if score @s RW.Tick matches 130 run tag @s add RW.Transition.Phase3.Attack
