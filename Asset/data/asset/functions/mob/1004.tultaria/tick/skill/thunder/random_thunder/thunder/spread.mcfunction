...
# 雷オブジェクトがあったら再帰する
    execute at @s if entity @e[type=item_display,scores={ObjectID=2041},distance=0.1..4,limit=1] run function asset:mob/1004.tultaria/tick/skill/thunder/random_thunder/thunder/spread
