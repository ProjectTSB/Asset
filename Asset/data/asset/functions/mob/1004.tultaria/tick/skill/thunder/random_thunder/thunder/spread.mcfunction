...
# 付近に雷落とすオブジェクトがいなければ、マーカーの位置にオブジェクト召喚
    execute at @s pounless entity @e[type=marker,scores={ObjectID=2041},distance=0.1..4,limit=1] run function asset:mob/1004.tultaria/tick/skill/thunder/random_thunder/thunder/summon
