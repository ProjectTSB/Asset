...
# 射撃
    execute if score @s RW.Tick matches 10 positioned ^10 ^ ^ positioned ~ ~1.5 ~ facing entity @p eyes run function asset:mob/1004.tultaria/tick/skill/mini/spread_shot/shoot/
    execute if score @s RW.Tick matches 10 positioned ^-10 ^ ^ positioned ~ ~1.5 ~ facing entity @p eyes run function asset:mob/1004.tultaria/tick/skill/mini/spread_shot/shoot/
