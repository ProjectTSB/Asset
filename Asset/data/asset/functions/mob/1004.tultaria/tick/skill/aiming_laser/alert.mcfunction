#> asset:mob/1004.tultaria/tick/skill/aiming_laser/alert
#
#
#
...
# 壁がなければ再帰
    execute if entity @s[distance=..30] positioned ^ ^ ^1 if block ~ ~ ~ #lib:no_collision run function asset:mob/1004.tultaria/tick/skill/aiming_laser/alert