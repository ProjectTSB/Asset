...
# ハード以上かつ分身が残り一体だと増える
    execute if predicate api:global_vars/difficulty/min/3_blessless unless entity @e[type=wither_skeleton,scores={MobID=1005},distance=0.1..64,limit=1] run data modify storage api: Argument.FieldOverride set value {Rotation:5}
    ...
    execute if predicate api:global_vars/difficulty/min/3_blessless unless entity @e[type=wither_skeleton,scores={MobID=1005},distance=0.1..64,limit=1] run data modify storage api: Argument.FieldOverride set value {Rotation:6}
    execute if predicate api:global_vars/difficulty/min/3_blessless unless entity @e[type=wither_skeleton,scores={MobID=1005},distance=0.1..64,limit=1] run function asset:mob/1004.tultaria/tick/skill/water/spin_slash/summon_sword/summon
    execute if predicate api:global_vars/difficulty/min/3_blessless unless entity @e[type=wither_skeleton,scores={MobID=1005},distance=0.1..64,limit=1] run data modify storage api: Argument.FieldOverride set value {Rotation:7}
    execute if predicate api:global_vars/difficulty/min/3_blessless unless entity @e[type=wither_skeleton,scores={MobID=1005},distance=0.1..64,limit=1] run function asset:mob/1004.tultaria/tick/skill/water/spin_slash/summon_sword/summon
    execute if predicate api:global_vars/difficulty/min/3_blessless unless entity @e[type=wither_skeleton,scores={MobID=1005},distance=0.1..64,limit=1] run data modify storage api: Argument.FieldOverride set value {Rotation:8}
    execute if predicate api:global_vars/difficulty/min/3_blessless unless entity @e[type=wither_skeleton,scores={MobID=1005},distance=0.1..64,limit=1] run function asset:mob/1004.tultaria/tick/skill/water/spin_slash/summon_sword/summon
