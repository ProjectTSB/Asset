...
# 拡散設置
    ...
    execute if score @s General.Mob.Tick matches 15 at @p[gamemode=!spectator,distance=..64] run function asset:mob/1004.tultaria/tick/skill/water/sword_rain/sword/place_marker
    execute if score @s General.Mob.Tick matches 20 at @p[gamemode=!spectator,distance=..64] run function asset:mob/1004.tultaria/tick/skill/water/sword_rain/sword/place_marker
    execute if score @s General.Mob.Tick matches 25 at @p[gamemode=!spectator,distance=..64] run function asset:mob/1004.tultaria/tick/skill/water/sword_rain/sword/place_marker
    execute if score @s General.Mob.Tick matches 30 at @p[gamemode=!spectator,distance=..64] run function asset:mob/1004.tultaria/tick/skill/water/sword_rain/sword/place_marker
