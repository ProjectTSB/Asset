...
# 召喚その2: ハード以上でやる
    execute if predicate api:global_vars/difficulty/min/normal facing entity @p[gamemode=!spectator,distance=..128] feet rotated ~ 0 positioned ^-5 ^ ^ run function asset:mob/1004.tultaria/tick/skill/transition/phase_2_to_3/tick/attack/summon_illusion/summon
