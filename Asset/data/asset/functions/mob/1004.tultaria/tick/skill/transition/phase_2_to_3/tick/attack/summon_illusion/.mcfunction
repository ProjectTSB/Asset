...
# 召喚
    execute facing entity @p feet rotated ~ 0 positioned ^3 ^ ^ run function asset:mob/1004.tultaria/tick/skill/transition/phase_2_to_3/tick/attack/summon_illusion/summon
    execute facing entity @p feet rotated ~ 0 positioned ^-3 ^ ^ run function asset:mob/1004.tultaria/tick/skill/transition/phase_2_to_3/tick/attack/summon_illusion/summon
