...
# 射撃
    ...
    execute if score $Interval Temporary matches 0 if score @s General.Mob.Tick matches 15..35 at @e[type=marker,tag=RW.ModelLocator.RightHand,sort=nearest,limit=1] facing entity @p eyes run function asset:mob/1004.tultaria/tick/skill/fire/move_shot/shoot
