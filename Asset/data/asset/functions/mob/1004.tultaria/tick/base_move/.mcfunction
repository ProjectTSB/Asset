...
# リセットからの復帰時に待機アニメを再生
    execute if score @s General.Mob.Tick matches -1 as @e[type=item_display,tag=RW.ModelRoot,sort=nearest,limit=1] run function animated_java:tultaria/animations/neutral_air/play
