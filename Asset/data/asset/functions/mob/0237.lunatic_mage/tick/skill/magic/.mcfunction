...
# 1回目のみ最も最寄りのプレイヤーをターゲットとして予告線を出す
    execute if entity @s[scores={6L.Tick=20..45}] positioned ~ ~1.21 ~ positioned ^-0.5 ^ ^1.3 facing entity @p[gamemode=!spectator,distance=..50] eyes run function asset:mob/0237.lunatic_mage/tick/skill/magic/warning_line
...
# 発射
    ...
    execute if entity @s[scores={6L.Tick=51}] anchored eyes facing entity @e[type=area_effect_cloud,tag=6L.RotationMarker,distance=..2,sort=nearest,limit=1] feet positioned ~ ~1.21 ~ run function asset:mob/0237.lunatic_mage/tick/skill/magic/shoot_beam
...
# 発射
    ...
    execute if entity @s[scores={6L.Tick=77}] anchored eyes facing entity @e[type=area_effect_cloud,tag=6L.RotationMarker,distance=..2,sort=nearest,limit=1] feet positioned ~ ~1.21 ~ run function asset:mob/0237.lunatic_mage/tick/skill/magic/shoot_beam
...
# 発射
    ...
    execute if entity @s[scores={6L.Tick=103}] anchored eyes facing entity @e[type=area_effect_cloud,tag=6L.RotationMarker,distance=..2,sort=nearest,limit=1] feet positioned ~ ~1.21 ~ run function asset:mob/0237.lunatic_mage/tick/skill/magic/shoot_beam
