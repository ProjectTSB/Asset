...
# 発射
    execute anchored eyes positioned ^-0.25 ^-0.25 ^ rotated ~ 0 run function asset:mob/0237.lunatic_mage/tick/skill/magic_summon/fire

# 発射(後ろ向き)
    execute anchored eyes positioned ^0.25 ^-0.25 ^ rotated ~180 0 run function asset:mob/0237.lunatic_mage/tick/skill/magic_summon/fire
