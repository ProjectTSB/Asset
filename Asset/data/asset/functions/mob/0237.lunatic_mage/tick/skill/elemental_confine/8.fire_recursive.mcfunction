#> asset:mob/0237.lunatic_mage/tick/skill/elemental_confine/8.fire_recursive
#
# 火の弾の再帰を行う
#
# @within function
...
# 再帰
    execute if entity @s[distance=..25] positioned ^ ^ ^0.25 run function asset:mob/0237.lunatic_mage/tick/skill/elemental_confine/8.fire_recursive
