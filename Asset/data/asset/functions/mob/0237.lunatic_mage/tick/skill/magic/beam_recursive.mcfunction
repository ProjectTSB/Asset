#> asset:mob/0237.lunatic_mage/tick/skill/magic/beam_recursive
#
# ビームの再帰処理部
#
# @within function
...
# 再帰
    execute if entity @s[distance=..50] positioned ^ ^ ^1 run function asset:mob/0237.lunatic_mage/tick/skill/magic/beam_recursive
