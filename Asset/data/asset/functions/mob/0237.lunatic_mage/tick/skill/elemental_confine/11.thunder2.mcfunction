#> asset:mob/0237.lunatic_mage/tick/skill/elemental_confine/11.thunder2
#
# 雷を4箇所に落とす処理
#
# @within function asset:mob/0237.lunatic_mage/tick/skill/elemental_confine/10.thunder
