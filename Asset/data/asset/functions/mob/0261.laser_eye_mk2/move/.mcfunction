...
# プレイヤーが近い場合は後ろのブロックを気にしつつ後退
    execute if data storage asset:context this{Distance:"Near"} anchored eyes positioned ^ ^ ^ if block ^ ^ ^-1 #lib:no_collision/ if block ~ ~-0.25 ~ #lib:no_collision/ anchored feet at @s run function asset:mob/0261.laser_eye_mk2/move/m with storage asset:context this
