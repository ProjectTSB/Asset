...
# 一部の時間のみ向く処理を入れる
    ...
    execute if score @s AV.AnimationTick matches 41..50 if predicate api:global_vars/difficulty/min/3_blessless if entity @p[tag=!PlayerShouldInvulnerable,distance=..100] run function asset:mob/0391.axia_first/ai/animation/3_0_triple_slash/predict/
