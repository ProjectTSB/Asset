...
# TP
    execute as @e[type=wither_skeleton,tag=AV.Temp.This,distance=..64,sort=nearest,limit=1] at @e[type=marker,tag=AV.Predict,distance=..64,limit=1] facing entity @p[tag=AV.Temp.Target,distance=..100] feet rotated ~ 0 run tp @s ^ ^ ^ ~ 0
