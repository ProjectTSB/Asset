...
# TP
    execute as @e[type=wither_skeleton,tag=this,distance=..64,sort=nearest,limit=1] at @e[type=marker,tag=AV.Predict,distance=..64,limit=1] facing entity @p[tag=AV.Temp.Target,distance=..100] feet rotated ~ 0 run function asset:mob/0391.axia_first/ai/general/1.teleport
