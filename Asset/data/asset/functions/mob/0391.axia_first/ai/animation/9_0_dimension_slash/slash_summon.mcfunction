...
# オーバーライドを設定
    data modify storage api: Argument.FieldOverride set value {Item:{id:"minecraft:leather_horse_armor"},Color:16711731,Frames:[20353,20353,20353,20353,20354,20354,20355],Scale:[6f,6f,0.1f],Transformation:{left_rotation:[0.5f,-0.5f,0.354f,0.612f],right_rotation:[0f,0f,0f,1f],translation:[0f,0f,0f]}}
