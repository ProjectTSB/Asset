...
# スコアが正かつ透明状態なら可視化
    execute if score @s AV.ProjectileTick matches 1.. if entity @s[tag=AV.Inbisible] run data merge entity @s {teleport_duration:1,item:{id:"minecraft:red_stained_glass",Count:1b}}
