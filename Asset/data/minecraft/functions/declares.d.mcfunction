...
# @within **
    ...
    #declare objective ArrowShotTick                                                  from c%3A/DataStorage/GitHub/mcsrvctl/server/event/tsb_dev/world/tsb-core/TheSkyBlessing/data/core/functions/load_once.mcfunction#L349
    ...
    #declare objective ForwardTargetMobUUID                                           from c%3A/DataStorage/GitHub/mcsrvctl/server/event/tsb_dev/world/tsb-core/TheSkyBlessing/data/core/functions/load_once.mcfunction#L242
    #declare objective Global                                                         from c%3A/DataStorage/GitHub/mcsrvctl/server/event/tsb_dev/world/tsb-core/TheSkyBlessing/data/core/functions/load_once.mcfunction#L126
    #declare objective GraveUserID                                                    from c%3A/DataStorage/GitHub/mcsrvctl/server/event/tsb_dev/world/tsb-core/TheSkyBlessing/data/core/functions/load_once.mcfunction#L355
    #declare objective Lib                                                            from c%3A/DataStorage/GitHub/mcsrvctl/server/event/tsb_dev/world/tsb-core/TheSkyBlessing/data/core/functions/load_once.mcfunction#L241
    ...
    #declare objective Temporary                                                      from c%3A/DataStorage/GitHub/mcsrvctl/server/event/tsb_dev/world/tsb-core/TheSkyBlessing/data/core/functions/load_once.mcfunction#L122
    ...
    #declare predicate world_manager:area/02-01.shard_processor                       from c%3A/DataStorage/GitHub/mcsrvctl/server/event/tsb_dev/world/tsb-core/TheSkyBlessing/data/world_manager/predicates/area/02-01.shard_processor.json#L1
    ...
    #declare team NoCollision                                                         from c%3A/DataStorage/GitHub/mcsrvctl/server/event/tsb_dev/world/tsb-core/TheSkyBlessing/data/core/functions/load_once.mcfunction#L114
...
#declare storage asset:artifact from c%3A/DataStorage/GitHub/mcsrvctl/server/event/tsb_dev/world/tsb-core/TheSkyBlessing/data/asset_manager/functions/artifact/_index.d.mcfunction#L11
...
#   asset:mob/*/hurt/**
# from c%3A/DataStorage/GitHub/mcsrvctl/server/event/tsb_dev/world/tsb-core/TheSkyBlessing/data/asset_manager/functions/artifact/_index.d.mcfunction#L55
# from c%3A/DataStorage/GitHub/mcsrvctl/server/event/tsb_dev/world/tsb-core/TheSkyBlessing/data/asset_manager/functions/mob/_index.d.mcfunction#L68
...
# from c%3A/DataStorage/GitHub/mcsrvctl/server/event/tsb_dev/world/tsb-core/TheSkyBlessing/data/asset_manager/functions/mob/_index.d.mcfunction#L62
#declare tag Victim
...
#   asset_manager:artifact/triggers/**
#   asset:artifact/**
    #declare tag Healer    from c%3A/DataStorage/GitHub/mcsrvctl/server/event/tsb_dev/world/tsb-core/TheSkyBlessing/data/asset_manager/functions/artifact/_index.d.mcfunction#L57
    #declare tag Receiver  from c%3A/DataStorage/GitHub/mcsrvctl/server/event/tsb_dev/world/tsb-core/TheSkyBlessing/data/asset_manager/functions/artifact/_index.d.mcfunction#L58
    #declare tag ShotArrow from c%3A/DataStorage/GitHub/mcsrvctl/server/event/tsb_dev/world/tsb-core/TheSkyBlessing/data/asset_manager/functions/artifact/_index.d.mcfunction#L59
...
#declare tag CanUsed from c%3A/DataStorage/GitHub/mcsrvctl/server/event/tsb_dev/world/tsb-core/TheSkyBlessing/data/asset_manager/functions/artifact/_index.d.mcfunction#L95
...
#   function asset_manager:artifact/triggers/vanilla/damage
#   function api:damage/core/health_subtract/non-player/
#   function api:mob/core/kill
#declare tag AssetMob from c%3A/DataStorage/GitHub/mcsrvctl/server/event/tsb_dev/world/tsb-core/TheSkyBlessing/data/asset_manager/functions/mob/_index.d.mcfunction#L35

#> declare
# @within
#   function core:tick/
#   function asset:**
#declare tag AllowProcessingCommonTag from c%3A/DataStorage/GitHub/mcsrvctl/server/event/tsb_dev/world/tsb-core/TheSkyBlessing/data/asset_manager/functions/mob/_index.d.mcfunction#L41
...
#   asset:mob/*/death/**
#declare tag Killer from c%3A/DataStorage/GitHub/mcsrvctl/server/event/tsb_dev/world/tsb-core/TheSkyBlessing/data/asset_manager/functions/mob/_index.d.mcfunction#L55

#> declare
# @within
#   function asset_manager:mob/common_tag/*
#   function asset:**
    #declare tag AllowRideBannedVehicle   from c%3A/DataStorage/GitHub/mcsrvctl/server/event/tsb_dev/world/tsb-core/TheSkyBlessing/data/asset_manager/functions/mob/_index.d.mcfunction#L80
    #declare tag AlwaysBurn               from c%3A/DataStorage/GitHub/mcsrvctl/server/event/tsb_dev/world/tsb-core/TheSkyBlessing/data/asset_manager/functions/mob/_index.d.mcfunction#L84
    #declare tag AlwaysInvisible          from c%3A/DataStorage/GitHub/mcsrvctl/server/event/tsb_dev/world/tsb-core/TheSkyBlessing/data/asset_manager/functions/mob/_index.d.mcfunction#L85
    #declare tag AlwaysSlowFall           from c%3A/DataStorage/GitHub/mcsrvctl/server/event/tsb_dev/world/tsb-core/TheSkyBlessing/data/asset_manager/functions/mob/_index.d.mcfunction#L86
    #declare tag AntiBurn                 from c%3A/DataStorage/GitHub/mcsrvctl/server/event/tsb_dev/world/tsb-core/TheSkyBlessing/data/asset_manager/functions/mob/_index.d.mcfunction#L83
    #declare tag AntiFallDamage           from c%3A/DataStorage/GitHub/mcsrvctl/server/event/tsb_dev/world/tsb-core/TheSkyBlessing/data/asset_manager/functions/mob/_index.d.mcfunction#L81
    #declare tag AntiVoid                 from c%3A/DataStorage/GitHub/mcsrvctl/server/event/tsb_dev/world/tsb-core/TheSkyBlessing/data/asset_manager/functions/mob/_index.d.mcfunction#L82
    #declare tag AutoKillWhenDiePassenger from c%3A/DataStorage/GitHub/mcsrvctl/server/event/tsb_dev/world/tsb-core/TheSkyBlessing/data/asset_manager/functions/mob/_index.d.mcfunction#L88
    #declare tag AutoKillWhenDieVehicle   from c%3A/DataStorage/GitHub/mcsrvctl/server/event/tsb_dev/world/tsb-core/TheSkyBlessing/data/asset_manager/functions/mob/_index.d.mcfunction#L87
    #declare tag Drown                    from c%3A/DataStorage/GitHub/mcsrvctl/server/event/tsb_dev/world/tsb-core/TheSkyBlessing/data/asset_manager/functions/mob/_index.d.mcfunction#L90
    #declare tag Frozen                   from c%3A/DataStorage/GitHub/mcsrvctl/server/event/tsb_dev/world/tsb-core/TheSkyBlessing/data/asset_manager/functions/mob/_index.d.mcfunction#L89
