...
#declare function asset:island/common/register from c%3A/DataStorage/GitHub/mcsrvctl/server/event/tsb_dev/world/tsb-core/TheSkyBlessing/data/asset/functions/island/common/register.mcfunction#L1
...
#declare function asset:trader/common/register from c%3A/DataStorage/GitHub/mcsrvctl/server/event/tsb_dev/world/tsb-core/TheSkyBlessing/data/asset/functions/trader/common/register.mcfunction#L1
