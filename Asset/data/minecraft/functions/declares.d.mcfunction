...
# @within **
    ...
    #declare function api:modifier/core/defense/fall/remove                           from c%3A/DataStorage/GitHub/mcsrvctl/server/event/tsb_dev/world/tsb-core/TheSkyBlessing/data/api/functions/modifier/core/defense/fall/remove.mcfunction#L1
    ...
    #declare function asset_manager:artifact/create/set_lore/modifier/generic.m       from c%3A/DataStorage/GitHub/mcsrvctl/server/event/tsb_dev/world/tsb-core/TheSkyBlessing/data/asset_manager/functions/artifact/create/set_lore/modifier/generic.m.mcfunction#L1
    #declare function asset_manager:artifact/triggers/equipments/enum/index/.m        from c%3A/DataStorage/GitHub/mcsrvctl/server/event/tsb_dev/world/tsb-core/TheSkyBlessing/data/asset_manager/functions/artifact/triggers/equipments/enum/index/.m.mcfunction#L1
    #declare function asset_manager:artifact/triggers/equipments/enum/index/1         from c%3A/DataStorage/GitHub/mcsrvctl/server/event/tsb_dev/world/tsb-core/TheSkyBlessing/data/asset_manager/functions/artifact/triggers/equipments/enum/index/1.mcfunction#L1
    #declare function asset_manager:artifact/triggers/equipments/enum/index/10        from c%3A/DataStorage/GitHub/mcsrvctl/server/event/tsb_dev/world/tsb-core/TheSkyBlessing/data/asset_manager/functions/artifact/triggers/equipments/enum/index/10.mcfunction#L1
    #declare function asset_manager:artifact/triggers/equipments/enum/index/11        from c%3A/DataStorage/GitHub/mcsrvctl/server/event/tsb_dev/world/tsb-core/TheSkyBlessing/data/asset_manager/functions/artifact/triggers/equipments/enum/index/11.mcfunction#L1
    #declare function asset_manager:artifact/triggers/equipments/enum/index/12        from c%3A/DataStorage/GitHub/mcsrvctl/server/event/tsb_dev/world/tsb-core/TheSkyBlessing/data/asset_manager/functions/artifact/triggers/equipments/enum/index/12.mcfunction#L1
    #declare function asset_manager:artifact/triggers/equipments/enum/index/13        from c%3A/DataStorage/GitHub/mcsrvctl/server/event/tsb_dev/world/tsb-core/TheSkyBlessing/data/asset_manager/functions/artifact/triggers/equipments/enum/index/13.mcfunction#L1
    #declare function asset_manager:artifact/triggers/equipments/enum/index/14        from c%3A/DataStorage/GitHub/mcsrvctl/server/event/tsb_dev/world/tsb-core/TheSkyBlessing/data/asset_manager/functions/artifact/triggers/equipments/enum/index/14.mcfunction#L1
    #declare function asset_manager:artifact/triggers/equipments/enum/index/15        from c%3A/DataStorage/GitHub/mcsrvctl/server/event/tsb_dev/world/tsb-core/TheSkyBlessing/data/asset_manager/functions/artifact/triggers/equipments/enum/index/15.mcfunction#L1
    #declare function asset_manager:artifact/triggers/equipments/enum/index/2         from c%3A/DataStorage/GitHub/mcsrvctl/server/event/tsb_dev/world/tsb-core/TheSkyBlessing/data/asset_manager/functions/artifact/triggers/equipments/enum/index/2.mcfunction#L1
    #declare function asset_manager:artifact/triggers/equipments/enum/index/3         from c%3A/DataStorage/GitHub/mcsrvctl/server/event/tsb_dev/world/tsb-core/TheSkyBlessing/data/asset_manager/functions/artifact/triggers/equipments/enum/index/3.mcfunction#L1
    #declare function asset_manager:artifact/triggers/equipments/enum/index/4         from c%3A/DataStorage/GitHub/mcsrvctl/server/event/tsb_dev/world/tsb-core/TheSkyBlessing/data/asset_manager/functions/artifact/triggers/equipments/enum/index/4.mcfunction#L1
    #declare function asset_manager:artifact/triggers/equipments/enum/index/5         from c%3A/DataStorage/GitHub/mcsrvctl/server/event/tsb_dev/world/tsb-core/TheSkyBlessing/data/asset_manager/functions/artifact/triggers/equipments/enum/index/5.mcfunction#L1
    #declare function asset_manager:artifact/triggers/equipments/enum/index/6         from c%3A/DataStorage/GitHub/mcsrvctl/server/event/tsb_dev/world/tsb-core/TheSkyBlessing/data/asset_manager/functions/artifact/triggers/equipments/enum/index/6.mcfunction#L1
    #declare function asset_manager:artifact/triggers/equipments/enum/index/7         from c%3A/DataStorage/GitHub/mcsrvctl/server/event/tsb_dev/world/tsb-core/TheSkyBlessing/data/asset_manager/functions/artifact/triggers/equipments/enum/index/7.mcfunction#L1
    #declare function asset_manager:artifact/triggers/equipments/enum/index/8         from c%3A/DataStorage/GitHub/mcsrvctl/server/event/tsb_dev/world/tsb-core/TheSkyBlessing/data/asset_manager/functions/artifact/triggers/equipments/enum/index/8.mcfunction#L1
    #declare function asset_manager:artifact/triggers/equipments/enum/index/9         from c%3A/DataStorage/GitHub/mcsrvctl/server/event/tsb_dev/world/tsb-core/TheSkyBlessing/data/asset_manager/functions/artifact/triggers/equipments/enum/index/9.mcfunction#L1
    ...
    #declare function asset_manager:artifact/triggers/equipments/enum/slot/chest      from c%3A/DataStorage/GitHub/mcsrvctl/server/event/tsb_dev/world/tsb-core/TheSkyBlessing/data/asset_manager/functions/artifact/triggers/equipments/enum/slot/chest.mcfunction#L1
    #declare function asset_manager:artifact/triggers/equipments/enum/slot/feet       from c%3A/DataStorage/GitHub/mcsrvctl/server/event/tsb_dev/world/tsb-core/TheSkyBlessing/data/asset_manager/functions/artifact/triggers/equipments/enum/slot/feet.mcfunction#L1
    #declare function asset_manager:artifact/triggers/equipments/enum/slot/head       from c%3A/DataStorage/GitHub/mcsrvctl/server/event/tsb_dev/world/tsb-core/TheSkyBlessing/data/asset_manager/functions/artifact/triggers/equipments/enum/slot/head.mcfunction#L1
    #declare function asset_manager:artifact/triggers/equipments/enum/slot/hotbar     from c%3A/DataStorage/GitHub/mcsrvctl/server/event/tsb_dev/world/tsb-core/TheSkyBlessing/data/asset_manager/functions/artifact/triggers/equipments/enum/slot/hotbar.mcfunction#L1
    #declare function asset_manager:artifact/triggers/equipments/enum/slot/legs       from c%3A/DataStorage/GitHub/mcsrvctl/server/event/tsb_dev/world/tsb-core/TheSkyBlessing/data/asset_manager/functions/artifact/triggers/equipments/enum/slot/legs.mcfunction#L1
    #declare function asset_manager:artifact/triggers/equipments/enum/slot/mainhand   from c%3A/DataStorage/GitHub/mcsrvctl/server/event/tsb_dev/world/tsb-core/TheSkyBlessing/data/asset_manager/functions/artifact/triggers/equipments/enum/slot/mainhand.mcfunction#L1
    #declare function asset_manager:artifact/triggers/equipments/enum/slot/offhand    from c%3A/DataStorage/GitHub/mcsrvctl/server/event/tsb_dev/world/tsb-core/TheSkyBlessing/data/asset_manager/functions/artifact/triggers/equipments/enum/slot/offhand.mcfunction#L1
